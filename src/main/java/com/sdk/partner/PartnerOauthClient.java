...
import com.sdk.common.model.AccessResponse;
import com.sdk.common.model.AccessTokenDto;
import com.sdk.common.model.FDKError;
import com.sdk.common.model.FDKTokenIssueError;
...
@Setter
@Slf4j
public class PartnerOauthClient {

    private static final String URI = "/service/panel/authentication/v1.0/organization/";
    ...
    PartnerOauthClient(PartnerConfig config) {
        this.config = config;
        this.refreshToken = "";
    ...
    public String getAuthorizationURL(List<String> scope, String redirectUri, String state, boolean isOnline) {
        ...
        var queryString = config.getDomain() + URI + config.getOrganizationId() + "/oauth/authorize?" + query;
    ...
    public AccessTokenDto renewAccesstoken() throws IOException {
        ...
        String url = config.getDomain() + URI + config.getOrganizationId() + "/oauth/token";
    ...
    public AccessTokenDto getOfflineAccessToken(String scopes, String code) {
        try {
            ...
            String url = config.getDomain() + URI + config.getOrganizationId() + "/oauth/offline-token";
    ...
    private TokenApiList generateOfflineTokenApiList() {
        ...
        interceptorList.add(new PartnerHeaderInterceptor(config));
