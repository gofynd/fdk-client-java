...
interface LogisticsPartnerApiList {
    ...
    Call<LogisticsPartnerModels.CourierAccount> createCourierPartnerAccount(@Path("organization_id") String organizationId, @Path("company_id") Integer companyId, @Body LogisticsPartnerModels.CourierAccountRequestBody payload, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<LogisticsPartnerModels.CourierPartnerSchemeModel> createCourierPartnerScheme(@Path("organization_id") String organizationId, @Body LogisticsPartnerModels.CourierPartnerSchemeRequestModel payload, @HeaderMap Map<String, String> requestHeaders);
