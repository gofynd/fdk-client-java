...
public class LeadPartnerService {
    ...
    **/
    ...
    public LeadPartnerModels.GetTokenForVideoRoomResponse getTokenForVideoRoom(String uniqueName) throws FDKServerResponseError, FDKException {
        return this.getTokenForVideoRoom(uniqueName, new HashMap<>());
    }

    public LeadPartnerModels.GetTokenForVideoRoomResponse getTokenForVideoRoom(String uniqueName, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.partnerConfig.getPartnerOauthClient().isAccessTokenValid()) {
            Response<LeadPartnerModels.GetTokenForVideoRoomResponse> response = null;
            try {
                response = leadPartnerApiList.getTokenForVideoRoom(this.organizationId, uniqueName, requestHeaders).execute();
                if (!response.isSuccessful()) {
                    throw new FDKServerResponseError(response.code(),
                                            response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                            response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public LeadPartnerModels.GetParticipantsInsideVideoRoomResponse getVideoParticipants(String uniqueName) throws FDKServerResponseError, FDKException {
        return this.getVideoParticipants(uniqueName, new HashMap<>());
    }

    public LeadPartnerModels.GetParticipantsInsideVideoRoomResponse getVideoParticipants(String uniqueName, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.partnerConfig.getPartnerOauthClient().isAccessTokenValid()) {
            Response<LeadPartnerModels.GetParticipantsInsideVideoRoomResponse> response = null;
            try {
                response = leadPartnerApiList.getVideoParticipants(this.organizationId, uniqueName, requestHeaders).execute();
                if (!response.isSuccessful()) {
                    throw new FDKServerResponseError(response.code(),
                                            response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                            response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
