...
interface LeadPartnerApiList {
    ...
    Call<LeadPartnerModels.GeneralConfigResponseSchema> getGeneralConfig(@Path("organization_id") String organizationId, @HeaderMap Map<String, String> requestHeaders);
}