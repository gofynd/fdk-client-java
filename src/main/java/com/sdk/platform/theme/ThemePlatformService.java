...
public class ThemePlatformService {
    ...
    public List<ThemePlatformModels.ThemeSchema> getCompanyLevelThemes() throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<List<ThemePlatformModels.ThemeSchema>> response = null;
            try {
                response = themePlatformApiList.getCompanyLevelThemes(this.companyId ).execute();
    ...
    public ThemePlatformModels.ThemeSchema addMarketplaceThemeToCompany(ThemePlatformModels.ThemeReq body) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ThemePlatformModels.ThemeSchema> response = null;
            try {
                response = themePlatformApiList.addMarketplaceThemeToCompany(this.companyId , body).execute();
                if (!response.isSuccessful()) {
                    throw new FDKServerResponseError(response.code(),
                                            response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                            response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public ThemePlatformModels.ThemeSchema deleteCompanyTheme(String themeId ) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ThemePlatformModels.ThemeSchema> response = null;
            try {
                response = themePlatformApiList.deleteCompanyTheme(this.companyId , themeId  ).execute();
                if (!response.isSuccessful()) {
                    throw new FDKServerResponseError(response.code(),
                                            response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                            response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
...
public class ApplicationClient {
    ...
    public ThemePlatformModels.AvailablePageSchema getDefaultPageDetails(String pageValue ) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ThemePlatformModels.AvailablePageSchema> response = null;
            try {
            response = themePlatformApiList.getDefaultPageDetails(this.companyId , this.applicationId , pageValue ).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public List<ThemePlatformModels.AllThemesApplicationResponseV2> getApplicationThemesV2() throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<List<ThemePlatformModels.AllThemesApplicationResponseV2>> response = null;
            try {
            response = themePlatformApiList.getApplicationThemesV2(this.companyId , this.applicationId ).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public ThemePlatformModels.FontsSchema getFontsV2() throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ThemePlatformModels.FontsSchema> response = null;
            try {
            response = themePlatformApiList.getFontsV2(this.companyId , this.applicationId ).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public Object getApplicationThemesCountV2() throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<Object> response = null;
            try {
            response = themePlatformApiList.getApplicationThemesCountV2(this.companyId , this.applicationId ).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public ThemePlatformModels.AllThemesApplicationResponseV2 getApplicationThemeByIdV2(String themeId ) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ThemePlatformModels.AllThemesApplicationResponseV2> response = null;
            try {
            response = themePlatformApiList.getApplicationThemeByIdV2(this.companyId , this.applicationId , themeId ).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public ThemePlatformModels.AllThemesApplicationResponseV2 updateThemeV2(String themeId ,ThemePlatformModels.UpdateThemeRequestBodyV2 body) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ThemePlatformModels.AllThemesApplicationResponseV2> response = null;
            try {
            response = themePlatformApiList.updateThemeV2(this.companyId , this.applicationId , themeId , body).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public ThemePlatformModels.AllThemesApplicationResponseV2 deleteThemeV2(String themeId ) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ThemePlatformModels.AllThemesApplicationResponseV2> response = null;
            try {
            response = themePlatformApiList.deleteThemeV2(this.companyId , this.applicationId , themeId ).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public ThemePlatformModels.ApplyThemeResponseV2 addThemeToApplicationV2(ThemePlatformModels.ApplyThemeRequestV2 body) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ThemePlatformModels.ApplyThemeResponseV2> response = null;
            try {
            response = themePlatformApiList.addThemeToApplicationV2(this.companyId , this.applicationId , body).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public ThemePlatformModels.ApplyThemeResponseV2 getAppliedThemeV2() throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ThemePlatformModels.ApplyThemeResponseV2> response = null;
            try {
            response = themePlatformApiList.getAppliedThemeV2(this.companyId , this.applicationId ).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public ThemePlatformModels.AllThemesApplicationResponseV2 updateThemeNameV2(String themeId ,ThemePlatformModels.UpdateThemeNameRequestBodyV2 body) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ThemePlatformModels.AllThemesApplicationResponseV2> response = null;
            try {
            response = themePlatformApiList.updateThemeNameV2(this.companyId , this.applicationId , themeId , body).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public ThemePlatformModels.AllThemesApplicationResponseV2 applyThemeV2(String themeId ) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ThemePlatformModels.AllThemesApplicationResponseV2> response = null;
            try {
            response = themePlatformApiList.applyThemeV2(this.companyId , this.applicationId , themeId ).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public ThemePlatformModels.AllThemesApplicationResponseV2 duplicateThemeV2(String themeId ) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ThemePlatformModels.AllThemesApplicationResponseV2> response = null;
            try {
            response = themePlatformApiList.duplicateThemeV2(this.companyId , this.applicationId , themeId ).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public ThemePlatformModels.AllThemesApplicationResponseV2 getThemePreviewByIdV2(String themeId ) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ThemePlatformModels.AllThemesApplicationResponseV2> response = null;
            try {
            response = themePlatformApiList.getThemePreviewByIdV2(this.companyId , this.applicationId , themeId ).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public Object getThemeLastModifiedV2(String themeId ) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<Object> response = null;
            try {
            response = themePlatformApiList.getThemeLastModifiedV2(this.companyId , this.applicationId , themeId ).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public ThemePlatformModels.ThemeUpgradableResponseV2 checkThemeUpgradableV2(String themeId ) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ThemePlatformModels.ThemeUpgradableResponseV2> response = null;
            try {
            response = themePlatformApiList.checkThemeUpgradableV2(this.companyId , this.applicationId , themeId ).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public ThemePlatformModels.AllThemesApplicationResponseV2 upgradeApplicationV2(String themeId ) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ThemePlatformModels.AllThemesApplicationResponseV2> response = null;
            try {
            response = themePlatformApiList.upgradeApplicationV2(this.companyId , this.applicationId , themeId ).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
