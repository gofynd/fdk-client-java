...
public class CatalogPlatformService {
    ...
    public CatalogPlatformModels.InventoryUpdateResponse deleteRealtimeInventory(Integer itemId , String sellerIdentifier ) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<CatalogPlatformModels.InventoryUpdateResponse> response = null;
            try {
                response = catalogPlatformApiList.deleteRealtimeInventory(this.companyId , itemId  , sellerIdentifier  ).execute();
                if (!response.isSuccessful()) {
                    throw new FDKServerResponseError(response.code(),
                                            response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                            response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
...
public class ApplicationClient {
    ...
    public CatalogPlatformModels.ProductSizeSellersResponse getProductSizeSellers(String itemId , String size , String pincode , String strategy , Integer pageNo , Integer pageSize ) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<CatalogPlatformModels.ProductSizeSellersResponse> response = null;
            try {
            response = catalogPlatformApiList.getProductSizeSellers(itemId , this.companyId , this.applicationId , size ,pincode , strategy , pageNo , pageSize ).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    **/
    public Paginator<CatalogPlatformModels.ProductSizeSellersResponse> getProductSizeSellersPagination(
        String itemId,
        String size,
        String pincode,
        String strategy,
    ...
    Paginator<CatalogPlatformModels.ProductSizeSellersResponse> paginator = new Paginator<>(pageSize, "number");

    paginator.setCallback(()-> {
        try {
            CatalogPlatformModels.ProductSizeSellersResponse callback = this.getProductSizeSellers(
