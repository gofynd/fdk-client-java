...
interface CatalogPlatformApiList {
    ...
    Call<CatalogPlatformModels.DeleteSearchConfigurationResponse> deleteSearchConfiguration(@Path("company_id")  String companyId , @Path("application_id")  String applicationId );
    ...
    Call<CatalogPlatformModels.GetSearchConfigurationResponse> getSearchConfiguration(@Path("company_id")  String companyId , @Path("application_id")  String applicationId );
    ...
    Call<CatalogPlatformModels.CreateSearchConfigurationResponse> createSearchConfiguration(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body CatalogPlatformModels.CreateSearchConfigurationRequest payload);
    ...
    Call<CatalogPlatformModels.UpdateSearchConfigurationResponse> updateSearchConfiguration(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body CatalogPlatformModels.UpdateSearchConfigurationRequest payload);
