...
interface CatalogPlatformApiList {
    ...
    Call<CatalogPlatformModels.SuccessResponse1Schema> updateAppBrand(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("brand_uid") Integer brandUid, @Body CatalogPlatformModels.ApplicationBrandJson payload, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.SuccessResponse1Schema> updateAppCategory(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("category_uid") Integer categoryUid, @Body CatalogPlatformModels.ApplicationCategoryJson payload, @HeaderMap Map<String, String> requestHeaders);

    @POST ("/service/platform/catalog/v1.0/company/{company_id}/application/{application_id}/collections")
    Call<CatalogPlatformModels.CollectionCreateResponseSchema> createCollection(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Body CatalogPlatformModels.CreateCollection payload, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.SuccessResponse1Schema> updateAppDepartment(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("department_uid") Integer departmentUid, @Body CatalogPlatformModels.ApplicationDepartmentJson payload, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/catalog/v1.0/company/{company_id}/application/{application_id}/product-configuration/metadata/{filter}")
    Call<CatalogPlatformModels.FilterResponseSchema> getConfigurationsFilterMetadata(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("filter") String filter, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.OwnerAppItemResponseSchema> getAppProduct(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("item_id") Integer itemId, @HeaderMap Map<String, String> requestHeaders);

    @PATCH ("/service/platform/catalog/v1.0/company/{company_id}/application/{application_id}/product/{item_id}")
    Call<CatalogPlatformModels.SuccessResponse1Schema> updateAppProduct(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("item_id") Integer itemId, @Body CatalogPlatformModels.ApplicationItemMeta payload, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.SuccessResponse1Schema> createAppReturnConfiguration(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Body CatalogPlatformModels.CreateUpdateAppReturnConfig payload, @HeaderMap Map<String, String> requestHeaders);

    @PUT ("/service/platform/catalog/v1.0/company/{company_id}/application/{application_id}/return-config")
    Call<CatalogPlatformModels.SuccessResponse1Schema> updateAppReturnConfiguration(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Body CatalogPlatformModels.CreateUpdateAppReturnConfig payload, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.SuccessResponse1Schema> createAppCategoryReturnConfiguration(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Body CatalogPlatformModels.BaseAppCategoryReturnConfig payload, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.CreateSearchRerankResponseSchema> createSearchRerank(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Body CatalogPlatformModels.CreateSearchRerankRequestSchema payload, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/catalog/v1.0/company/{company_id}/application/{application_id}/search/rerank")
    Call<CatalogPlatformModels.GetSearchRerankResponseSchema> getSearchRerank(@Path("company_id") String companyId, @Path("application_id") String applicationId, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/catalog/v1.0/company/{company_id}/application/{application_id}/search/rerank/{id}")
    Call<CatalogPlatformModels.GetSearchRerankDetailResponseSchema> getSearchRerankDetail(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("id") String id, @HeaderMap Map<String, String> requestHeaders);

    @PUT ("/service/platform/catalog/v1.0/company/{company_id}/application/{application_id}/search/rerank/{id}")
    Call<CatalogPlatformModels.UpdateSearchRerankResponseSchema> updateSearchRerankConfiguration(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("id") String id, @Body CatalogPlatformModels.UpdateSearchRerankRequestSchema payload, @HeaderMap Map<String, String> requestHeaders);

    @DELETE ("/service/platform/catalog/v1.0/company/{company_id}/application/{application_id}/search/rerank/{id}")
    Call<CatalogPlatformModels.DeleteSearchRerankConfigurationResponseSchema> deleteSearchRerankConfiguration(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("id") String id, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.GetSearchWordsResponseSchema> getAllSearchKeyword(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Query("page_no") Integer pageNo, @Query("page_size") Integer pageSize, @Query("q") String q, @Query("is_active") Boolean isActive, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.SuccessResponse1Schema> updateAppLocation(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("store_uid") Integer storeUid, @Body CatalogPlatformModels.ApplicationStoreJson payload, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.InventoryBulkResponseSchema> createBulkInventoryJob(@Path("company_id") String companyId, @Body CatalogPlatformModels.InventoryBulkJob payload, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.InventoryExportJobResponseSchema> getInventoryExport(@Path("company_id") String companyId, @HeaderMap Map<String, String> requestHeaders);

    @PATCH ("/service/platform/catalog/v2.0/company/{company_id}/products/downloads/{job_id}")
    Call<CatalogPlatformModels.PatchProductDownloadsResponseSchema> patchProductExportDetail(@Path("company_id") String companyId, @Path("job_id") String jobId, @Body CatalogPlatformModels.ExportPatchRequestSchema payload, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/catalog/v2.0/company/{company_id}/products/downloads/{job_id}")
    Call<CatalogPlatformModels.GetProductDownloadsResponseSchema> getProductExportDetail(@Path("company_id") String companyId, @Path("job_id") String jobId, @HeaderMap Map<String, String> requestHeaders);

    @PUT ("/service/platform/catalog/v2.0/company/{company_id}/inventory/download/{job_id}")
    Call<CatalogPlatformModels.EditInventoryDownloadsResponseSchema> patchInventoryExportDetail(@Path("company_id") String companyId, @Path("job_id") String jobId, @Body CatalogPlatformModels.ExportPatchRequestSchema payload, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/catalog/v2.0/company/{company_id}/inventory/download/{job_id}")
    Call<CatalogPlatformModels.EditInventoryDownloadsResponseSchema> getInventoryExportDetail(@Path("company_id") String companyId, @Path("job_id") String jobId, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.InventoryValidationResponseSchema> validateProductTemplateSchema(@Path("company_id") String companyId, @Query("item_type") String itemType, @Query("bulk") Boolean bulk, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.ProductBulkRequestSchemaList> getProductBulkUploadHistory(@Path("company_id") String companyId, @Query("search") String search, @Query("page_no") Integer pageNo, @Query("page_size") Integer pageSize, @HeaderMap Map<String, String> requestHeaders);

    @POST ("/service/platform/catalog/v1.0/company/{company_id}/products/bulk")
    Call<CatalogPlatformModels.ProductBulkResponseSchema> createBulkProductUploadJob(@Path("company_id") String companyId, @Body CatalogPlatformModels.BulkProductUploadJob payload, @HeaderMap Map<String, String> requestHeaders);

    @DELETE ("/service/platform/catalog/v1.0/company/{company_id}/products/bulk/{batch_id}")
    Call<CatalogPlatformModels.SuccessResponseSchema> deleteProductBulkJob(@Path("company_id") String companyId, @Path("batch_id") String batchId, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.ApplicationInventorySellerIdentifierResponsePaginated> getInventoryBySizeIdentifier(@Path("company_id") String companyId, @Path("item_id") Integer itemId, @Path("size_identifier") String sizeIdentifier, @Query("page_no") Integer pageNo, @Query("page_size") Integer pageSize, @Query("q") String q, @Query("location_ids") List<Integer> locationIds, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/catalog/v1.0/company/{company_id}/products/{item_id}/sizes")
    Call<CatalogPlatformModels.Product> getProductSize(@Path("company_id") String companyId, @Path("item_id") Integer itemId, @Query("item_code") String itemCode, @Query("brand_uid") Integer brandUid, @Query("uid") Integer uid, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.CompanyVerificationResponseSchema> getCompanyVerification(@Path("company_id") String companyId, @Query("q") String q, @Query("page_no") Integer pageNo, @Query("page_size") Integer pageSize, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.VariantTypesResponseSchema> getVariantTypes(@Path("company_id") String companyId, @Query("template_tag") String templateTag, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.SizeGuideResponseSchema> getSizeGuide(@Path("id") String id, @Path("company_id") String companyId, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.AppConfigurationsFilterResponseSchema> createListingConfiguration(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("config_type") String configType, @Body CatalogPlatformModels.AppConfigurationsFilter payload, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/catalog/v2.0/company/{company_id}/application/{application_id}/product-configuration/{config_type}")
    Call<CatalogPlatformModels.GetListingConfigResponseSchema> getListingConfigurations(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("config_type") String configType, @Query("page_no") Integer pageNo, @Query("page_size") Integer pageSize, @Query("search") String search, @Query("uids") List<Integer> uids, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.AppConfigurationsFilterResponseSchema> updateListingConfiguration(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("config_type") String configType, @Path("config_id") String configId, @Body CatalogPlatformModels.AppConfigurationsFilterResponseSchema payload, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.GetConfigMetadataResponseSchema> getConfigurationMetadata(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("config_type") String configType, @Query("template_slug") String templateSlug, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.InventoryUpdateResponseSchema> updateInventories(@Path("company_id") String companyId, @Body CatalogPlatformModels.InventoryV2RequestSchema payload, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.CreateProductDownloadsResponseSchema> createProductExportJob(@Path("company_id") String companyId, @Body CatalogPlatformModels.ProductTemplateDownloadsExport payload, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.InventoryUpdateResponseSchema> deleteRealtimeInventory(@Path("company_id") String companyId, @Path("item_id") Integer itemId, @Path("seller_identifier") String sellerIdentifier, @Body CatalogPlatformModels.InventoryV2RequestSchema payload, @HeaderMap Map<String, String> requestHeaders);

    @POST ("/service/platform/catalog/v2.0/company/{company_id}/products/{item_id}/inventory/{seller_identifier}")
    Call<CatalogPlatformModels.InventoryUpdateResponseSchema> updateRealtimeInventory(@Path("company_id") String companyId, @Path("item_id") Integer itemId, @Path("seller_identifier") String sellerIdentifier, @Body CatalogPlatformModels.InventoryV2RequestSchema payload, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/catalog/v1.0/company/{company_id}/products/templates/{slug}")
    Call<CatalogPlatformModels.GetProductTemplateSlugResponseSchema> getProductTemplateBySlug(@Path("company_id") String companyId, @Path("slug") String slug, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.UpdateMarketplaceOptinResponseSchema> updateMarketplaceOptin(@Path("company_id") String companyId, @Path("marketplace") String marketplace, @Body CatalogPlatformModels.UpdateMarketplaceOptinRequestSchema payload, @HeaderMap Map<String, String> requestHeaders);

    @POST ("/service/platform/catalog/v1.0/company/{company_id}/channel/{marketplace}/opt-in")
    Call<CatalogPlatformModels.CreateMarketplaceOptinResponseSchema> createMarketplaceOptin(@Path("company_id") String companyId, @Path("marketplace") String marketplace, @Body CatalogPlatformModels.CreateMarketplaceOptinRequestSchema payload, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.PinResponseSchema> getMerchandisingRulePinAction(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("merchandising_rule_id") String merchandisingRuleId, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.HideResponseSchema> getMerchandisingRuleHideAction(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("merchandising_rule_id") String merchandisingRuleId, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.MerchandiseQueryResponseSchema> createMerchandisingRuleQuery(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Body CatalogPlatformModels.MerchandisingRuleQueryPost payload, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.ProductListingResponseSchema> getLivePreview(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("merchandising_rule_id") String merchandisingRuleId, @Query("search_keyword") String searchKeyword, @HeaderMap Map<String, String> requestHeaders);

    @POST ("/service/platform/catalog/v1.0/company/{company_id}/owner-application/{application_id}/price-factory")
    Call<CatalogPlatformModels.CreateAppPriceFactoryResponseSchema> createAppPriceFactory(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Body CatalogPlatformModels.CreateAppPriceFactoryRequestSchema payload, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/catalog/v1.0/company/{company_id}/owner-application/{application_id}/price-factory")
    Call<CatalogPlatformModels.GetAppPriceFactoryResponseSchema> getAppPriceFactories(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Query("is_active") Boolean isActive, @Query("factory_type_id") String factoryTypeId, @Query("code") String code, @Query("page_no") Integer pageNo, @Query("page_size") Integer pageSize, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.CreatePriceFactoryProductResponseSchema> addProductsInPriceFactoryByZoneId(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("id") String id, @Body CatalogPlatformModels.CreatePriceFactoryProductRequestSchema payload, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/catalog/v1.0/company/{company_id}/owner-application/{application_id}/price-factory/{id}/products")
    Call<CatalogPlatformModels.CreateAppPriceFactoryProductsResponseSchema> getProductsInPriceFactoryByZoneId(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("id") String id, @Query("zone_id") String zoneId, @Query("item_id") Double itemId, @Query("q") String q, @Query("page_no") Integer pageNo, @Query("page_size") Integer pageSize, @HeaderMap Map<String, String> requestHeaders);

    @POST ("/service/platform/catalog/v1.0/company/{company_id}/owner-application/{application_id}/price-factory/{id}/bulk")
    Call<CatalogPlatformModels.CreateAppPriceFactoryProductBulkJobResponseSchema> createProductPriceFactoryBulkJob(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("id") String id, @Body CatalogPlatformModels.CreateAppPriceFactoryProductBulkJobRequestSchema payload, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/catalog/v1.0/company/{company_id}/owner-application/{application_id}/price-factory/{id}/poll/{job_id}")
    Call<CatalogPlatformModels.CreateAppPriceFactoryProductBulkJobPollResponseSchema> pollProductPriceFactoryBulkJob(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("id") String id, @Path("job_id") String jobId, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.CreateAppPriceFactoryProductBulkJobValidateResponseSchema> validateProductPriceFactoryBulkJob(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("id") String id, @Path("job_id") String jobId, @Body CatalogPlatformModels.CreateAppPriceFactoryProductBulkJobRequestSchema payload, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.CreateAppPriceFactoryProductBulkJobResponseSchema> processProductPriceFactoryBulkJob(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("id") String id, @Path("job_id") String jobId, @Body CatalogPlatformModels.CreateAppPriceFactoryProductBulkJobRequestSchema payload, @HeaderMap Map<String, String> requestHeaders);

    @POST ("/service/platform/catalog/v1.0/company/{company_id}/owner-application/{application_id}/price-factory/{id}/export")
    Call<CatalogPlatformModels.CreateAppPriceFactoryProductExportJobResponseSchema> exportProductsInPriceFactory(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("id") String id, @Body CatalogPlatformModels.CreateAppPriceFactoryProductExportJobRequestSchema payload, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/catalog/v1.0/company/{company_id}/owner-application/{application_id}/price-factory/{id}/poll")
    Call<CatalogPlatformModels.CreateAppPriceFactoryProductExportJobPollResponseSchema> pollPriceFactoryJobs(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("id") String id, @Query("start_date") String startDate, @Query("end_date") String endDate, @Query("stage") List<String> stage, @Query("is_active") Boolean isActive, @Query("q") String q, @Query("type") List<String> type, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.SynonymDeleteResponseSchemaSchema> deleteSynonym(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Query("id") String id, @HeaderMap Map<String, String> requestHeaders);
