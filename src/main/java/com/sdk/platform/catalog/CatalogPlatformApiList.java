...
interface CatalogPlatformApiList {
    ...
    Call<CatalogPlatformModels.ProductSizeSellersResponse> getProductSizeSellers(@Path("item_id") String  itemId , @Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Path("size") String  size , @Query("pincode") String  pincode ,  @Query("strategy") String  strategy ,  @Query("page_no") Integer  pageNo ,  @Query("page_size") Integer  pageSize );
    ...
    Call<CatalogPlatformModels.InventoryUpdateResponse> deleteRealtimeInventory(@Path("company_id")  String companyId , @Path("item_id") Integer  itemId , @Path("seller_identifier") String  sellerIdentifier );
