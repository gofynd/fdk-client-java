...
interface CatalogPlatformApiList {
    ...
    Call<CatalogPlatformModels.SuccessResponse1> updateAppBrand(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("brand_uid") Integer brandUid, @Body CatalogPlatformModels.ApplicationBrandJson payload, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/catalog/v1.0/company/{company_id}/application/{application_id}/brands")
    Call<CatalogPlatformModels.BrandListingResponse> getApplicationBrands(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Query("department") String department, @Query("page_no") Integer pageNo, @Query("page_size") Integer pageSize, @Query("q") String q, @Query("brand_id") Integer brandId, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.SuccessResponse1> updateAppCategory(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("category_uid") Integer categoryUid, @Body CatalogPlatformModels.ApplicationCategoryJson payload, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.SuccessResponse1> updateAppDepartment(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("department_uid") Integer departmentUid, @Body CatalogPlatformModels.ApplicationDepartmentJson payload, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.SuccessResponse1> updateAppProduct(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("item_id") Integer itemId, @Body CatalogPlatformModels.ApplicationItemMeta payload, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.SuccessResponse1> updateAppLocation(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("store_uid") Integer storeUid, @Body CatalogPlatformModels.ApplicationStoreJson payload, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.UpdateHsnCode> updateHsnCode(@Path("company_id") String companyId, @Path("id") String id, @Body CatalogPlatformModels.HsnUpsert payload, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/catalog/v1.0/company/{company_id}/inventories")
    Call<CatalogPlatformModels.GetInventoriesResponse> getInventories(@Path("company_id") String companyId, @Query("item_id") Integer itemId, @Query("size") String size, @Query("page_no") Integer pageNo, @Query("page_size") Integer pageSize, @Query("q") String q, @Query("sellable") Boolean sellable, @Query("store_ids") List<Integer> storeIds, @Query("size_identifier") Integer sizeIdentifier, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.SuccessResponseMerchandising> createMerchandisingRuleBoostAction(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("merchandising_rule_id") String merchandisingRuleId, @Body CatalogPlatformModels.GetMerchandisingRuleBoostAction payload, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CatalogPlatformModels.SearchRequest> getMerchandisingQuery(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("merchandising_rule_id") String merchandisingRuleId, @HeaderMap Map<String, String> requestHeaders);
    ...
    @POST ("/service/platform/catalog/v1.0/company/{company_id}/application/{application_id}/price-factory")
    Call<CatalogPlatformModels.CreateAppPriceFactoryResponse> createAppPriceFactory(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Body CatalogPlatformModels.CreateAppPriceFactoryRequest payload, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/catalog/v1.0/company/{company_id}/application/{application_id}/price-factory")
    ...
    @GET ("/service/platform/catalog/v1.0/company/{company_id}/application/{application_id}/price-factory/{id}")
    ...
    @PUT ("/service/platform/catalog/v1.0/company/{company_id}/application/{application_id}/price-factory/{id}")
    Call<CatalogPlatformModels.AppPriceFactory> editAppPriceFactory(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("id") String id, @Body CatalogPlatformModels.EditAppPriceFactoryRequest payload, @HeaderMap Map<String, String> requestHeaders);

    @POST ("/service/platform/catalog/v1.0/company/{company_id}/application/{application_id}/price-factory/{id}/products/zone/{zone_id}")
    Call<CatalogPlatformModels.CreateAppPriceFactoryProductsResponse> addProductsInPriceFactoryByZoneId(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("id") String id, @Path("zone_id") String zoneId, @Body CatalogPlatformModels.CreateAppPriceFactoryProductRequest payload, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/catalog/v1.0/company/{company_id}/application/{application_id}/price-factory/{id}/products/zone/{zone_id}")
    Call<CatalogPlatformModels.CreateAppPriceFactoryProductsResponse> getProductsInPriceFactoryByZoneId(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("id") String id, @Path("zone_id") String zoneId, @Query("item_id") Boolean itemId, @Query("seller_identifier") String sellerIdentifier, @Query("page_no") Integer pageNo, @Query("page_size") Integer pageSize, @HeaderMap Map<String, String> requestHeaders);

    @PATCH ("/service/platform/catalog/v1.0/company/{company_id}/application/{application_id}/price-factory/{id}/product/{item_id}/zone/{zone_id}/price")
    Call<CatalogPlatformModels.UpdateAppPriceFactoryProductResponse> updateProductPriceByZoneInPriceFactory(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("id") String id, @Path("item_id") Integer itemId, @Path("zone_id") String zoneId, @Body CatalogPlatformModels.UpdateAppPriceFactoryProductRequest payload, @HeaderMap Map<String, String> requestHeaders);

    @POST ("/service/platform/catalog/v1.0/company/{company_id}/application/{application_id}/price-factory/{id}/products/bulk")
    ...
    @GET ("/service/platform/catalog/v1.0/company/{company_id}/application/{application_id}/price-factory/{id}/products/bulk/{job_id}/poll")
    ...
    @POST ("/service/platform/catalog/v1.0/company/{company_id}/application/{application_id}/price-factory/{id}/products/bulk/{job_id}/validate")
    ...
    @POST ("/service/platform/catalog/v1.0/company/{company_id}/application/{application_id}/price-factory/{id}/products/bulk/{job_id}/process")
