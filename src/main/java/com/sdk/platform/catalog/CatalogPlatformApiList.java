...
interface CatalogPlatformApiList {
    ...
    Call<CatalogPlatformModels.ProdcutTemplateCategoriesResponseSchema> listProductTemplateCategories(@Path("company_id") String companyId, @Query("departments") String departments, @Query("item_type") String itemType, @Query("page_size") Double pageSize, @Query("page_no") Double pageNo, @Query("q") String q, @Query("slug") String slug, @HeaderMap Map<String, String> requestHeaders);
