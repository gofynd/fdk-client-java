...
interface WebhookPlatformApiList {
    ...
    Call<WebhookPlatformModels.SubscriberResponse> getSubscribersByCompany(@Path("company_id")  String companyId , @Query("page_no") Integer  pageNo ,  @Query("page_size") Integer  pageSize ,  @Query("extension_id") Integer  extensionId );
    ...
    Call<WebhookPlatformModels.SubscriberConfigList> getSubscribersByExtensionId(@Path("company_id")  String companyId , @Path("extension_id") Integer  extensionId , @Query("page_no") Integer  pageNo ,  @Query("page_size") Integer  pageSize );
