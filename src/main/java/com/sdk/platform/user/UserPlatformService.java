...
public class ApplicationClient {
    ...
    public UserPlatformModels.UserGroupCategoriesResponseSchema getUserGroupCategories() throws FDKServerResponseError, FDKException {
        return this.getUserGroupCategories(new HashMap<>());
    }

    public UserPlatformModels.UserGroupCategoriesResponseSchema getUserGroupCategories(Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<UserPlatformModels.UserGroupCategoriesResponseSchema> response = null;
            try {
            response = userPlatformApiList.getUserGroupCategories(this.companyId, this.applicationId, requestHeaders).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public UserPlatformModels.UserGroupExists checkUserGroupsExists(String userId, List<Double> userGroups) throws FDKServerResponseError, FDKException {
        return this.checkUserGroupsExists(userId, userGroups, new HashMap<>());
    }

    public UserPlatformModels.UserGroupExists checkUserGroupsExists(String userId, List<Double> userGroups, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<UserPlatformModels.UserGroupExists> response = null;
            try {
            response = userPlatformApiList.checkUserGroupsExists(this.companyId, userId, this.applicationId, userGroups, requestHeaders).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
