...
public class ApplicationClient {
    ...
    public UserPlatformModels.CustomerListResponseSchema getCustomers(String q , Integer pageSize , Integer pageNo ) throws FDKException {
    ...
    public UserPlatformModels.UserSearchResponseSchema searchUsers(Object q ) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
    ...
    public UserPlatformModels.SessionDeleteResponseSchema deleteActiveSessions(String id ) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<UserPlatformModels.SessionDeleteResponseSchema> response = null;
            try {
            response = userPlatformApiList.deleteActiveSessions(this.companyId , this.applicationId ,id ).execute();
                if (!response.isSuccessful()) {
                        throw new FDKException(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
