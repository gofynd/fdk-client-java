...
interface UserPlatformApiList {
    ...
    Call<UserPlatformModels.UserAttributeDefinitionResponse> createUserAttributeDefinition(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Body UserPlatformModels.CreateUserAttributeDefinition payload, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<UserPlatformModels.SuccessMessageResponse> deleteUserAttributeDefinitionById(@Path("attribute_def_id") String attributeDefId, @Path("company_id") String companyId, @Path("application_id") String applicationId, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<UserPlatformModels.UserAttributeResponse> updateUserAttribute(@Path("attribute_def_id") String attributeDefId, @Path("user_id") String userId, @Path("application_id") String applicationId, @Path("company_id") String companyId, @Body UserPlatformModels.CreateUserAttributeRequest payload, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<UserPlatformModels.UserAttributeResponse> getUserAttribute(@Path("attribute_def_id") String attributeDefId, @Path("user_id") String userId, @Path("application_id") String applicationId, @Path("company_id") String companyId, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<UserPlatformModels.SuccessMessageResponse> deleteUserAttribute(@Path("attribute_def_id") String attributeDefId, @Path("user_id") String userId, @Path("application_id") String applicationId, @Path("company_id") String companyId, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<UserPlatformModels.UserAttributeResponse> getUserAttributeById(@Path("attribute_id") String attributeId, @Path("application_id") String applicationId, @Path("company_id") String companyId, @HeaderMap Map<String, String> requestHeaders);
}