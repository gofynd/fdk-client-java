...
public static class UserGroupExists{
    ...
    private HashMap<String,Object> userGroups;
...
public static class BulkOperationAsync{
    ...
    */
    ...
    public enum CategorySchema {
        ...
        CategorySchema(String priority) {
