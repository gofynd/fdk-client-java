...
public class ConfigurationPlatformService {
    ...
    **/
    ...
    public ConfigurationPlatformModels.Integration getIntegrationById(Integer id, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            ...
            try {
                response = configurationPlatformApiList.getIntegrationById(this.companyId, id, requestHeaders).execute();
                if (!response.isSuccessful()) {
                    throw new FDKServerResponseError(response.code(),
                                            response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                            response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public ConfigurationPlatformModels.GetIntegrationsOptInsResponse getAvailableOptIns(Integer pageNo, Integer pageSize) throws FDKServerResponseError, FDKException {
        return this.getAvailableOptIns(pageNo, pageSize, new HashMap<>());
    }

    public ConfigurationPlatformModels.GetIntegrationsOptInsResponse getAvailableOptIns(Integer pageNo, Integer pageSize, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ConfigurationPlatformModels.GetIntegrationsOptInsResponse> response = null;
            try {
                response = configurationPlatformApiList.getAvailableOptIns(this.companyId, pageNo, pageSize, requestHeaders).execute();
                if (!response.isSuccessful()) {
                    throw new FDKServerResponseError(response.code(),
                                            response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                            response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    **/
    ...
    public ConfigurationPlatformModels.GetIntegrationsOptInsResponse getSelectedOptIns(String level, Integer uid, Integer pageNo, Integer pageSize) throws FDKServerResponseError, FDKException {
        return this.getSelectedOptIns(level, uid, pageNo, pageSize, new HashMap<>());
    }

    public ConfigurationPlatformModels.GetIntegrationsOptInsResponse getSelectedOptIns(String level, Integer uid, Integer pageNo, Integer pageSize, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ConfigurationPlatformModels.GetIntegrationsOptInsResponse> response = null;
            try {
                response = configurationPlatformApiList.getSelectedOptIns(this.companyId, level, uid, pageNo, pageSize, requestHeaders).execute();
                if (!response.isSuccessful()) {
                    throw new FDKServerResponseError(response.code(),
                                            response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                            response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    **/
    ...
    public ConfigurationPlatformModels.IntegrationConfigResponse getIntegrationLevelConfig(String id, String level, Boolean opted, Boolean checkPermission) throws FDKServerResponseError, FDKException {
        return this.getIntegrationLevelConfig(id, level, opted, checkPermission, new HashMap<>());
    }

    public ConfigurationPlatformModels.IntegrationConfigResponse getIntegrationLevelConfig(String id, String level, Boolean opted, Boolean checkPermission, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ConfigurationPlatformModels.IntegrationConfigResponse> response = null;
            try {
                response = configurationPlatformApiList.getIntegrationLevelConfig(this.companyId, id, level, opted, checkPermission, requestHeaders).execute();
                if (!response.isSuccessful()) {
                    throw new FDKServerResponseError(response.code(),
                                            response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                            response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public ConfigurationPlatformModels.IntegrationLevel updateLevelIntegration(String id, String level, ConfigurationPlatformModels.UpdateIntegrationLevelRequest body) throws FDKServerResponseError, FDKException {
        return this.updateLevelIntegration(id, level, body, new HashMap<>());
    }

    public ConfigurationPlatformModels.IntegrationLevel updateLevelIntegration(String id, String level, ConfigurationPlatformModels.UpdateIntegrationLevelRequest body, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ConfigurationPlatformModels.IntegrationLevel> response = null;
            try {
                response = configurationPlatformApiList.updateLevelIntegration(this.companyId, id, level, body, requestHeaders).execute();
                if (!response.isSuccessful()) {
                    throw new FDKServerResponseError(response.code(),
                                            response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                            response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public ConfigurationPlatformModels.IntegrationLevel getIntegrationByLevelId(String id, String level, Integer uid) throws FDKServerResponseError, FDKException {
        return this.getIntegrationByLevelId(id, level, uid, new HashMap<>());
    }

    public ConfigurationPlatformModels.IntegrationLevel getIntegrationByLevelId(String id, String level, Integer uid, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ConfigurationPlatformModels.IntegrationLevel> response = null;
            try {
                response = configurationPlatformApiList.getIntegrationByLevelId(this.companyId, id, level, uid, requestHeaders).execute();
                if (!response.isSuccessful()) {
                    throw new FDKServerResponseError(response.code(),
                                            response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                            response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public ConfigurationPlatformModels.IntegrationLevel updateLevelUidIntegration(String id, String level, Integer uid, ConfigurationPlatformModels.IntegrationLevel body) throws FDKServerResponseError, FDKException {
        return this.updateLevelUidIntegration(id, level, uid, body, new HashMap<>());
    }

    public ConfigurationPlatformModels.IntegrationLevel updateLevelUidIntegration(String id, String level, Integer uid, ConfigurationPlatformModels.IntegrationLevel body, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ConfigurationPlatformModels.IntegrationLevel> response = null;
            try {
                response = configurationPlatformApiList.updateLevelUidIntegration(this.companyId, id, level, uid, body, requestHeaders).execute();
                if (!response.isSuccessful()) {
                    throw new FDKServerResponseError(response.code(),
                                            response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                            response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public ConfigurationPlatformModels.OptedStoreIntegration getLevelActiveIntegrations(String id, String level, Integer uid) throws FDKServerResponseError, FDKException {
        return this.getLevelActiveIntegrations(id, level, uid, new HashMap<>());
    }

    public ConfigurationPlatformModels.OptedStoreIntegration getLevelActiveIntegrations(String id, String level, Integer uid, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ConfigurationPlatformModels.OptedStoreIntegration> response = null;
            try {
                response = configurationPlatformApiList.getLevelActiveIntegrations(this.companyId, id, level, uid, requestHeaders).execute();
                if (!response.isSuccessful()) {
                    throw new FDKServerResponseError(response.code(),
                                            response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                            response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    **/
    ...
    public ConfigurationPlatformModels.OptedApplicationResponse getOtherSellerApplicationById(String id) throws FDKServerResponseError, FDKException {
        return this.getOtherSellerApplicationById(id, new HashMap<>());
    }

    public ConfigurationPlatformModels.OptedApplicationResponse getOtherSellerApplicationById(String id, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ConfigurationPlatformModels.OptedApplicationResponse> response = null;
            try {
                response = configurationPlatformApiList.getOtherSellerApplicationById(this.companyId, id, requestHeaders).execute();
                if (!response.isSuccessful()) {
                    throw new FDKServerResponseError(response.code(),
                                            response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                            response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public ConfigurationPlatformModels.SuccessMessageResponse optOutFromApplication(String id, ConfigurationPlatformModels.OptOutInventory body) throws FDKServerResponseError, FDKException {
        return this.optOutFromApplication(id, body, new HashMap<>());
    }

    public ConfigurationPlatformModels.SuccessMessageResponse optOutFromApplication(String id, ConfigurationPlatformModels.OptOutInventory body, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ConfigurationPlatformModels.SuccessMessageResponse> response = null;
            try {
                response = configurationPlatformApiList.optOutFromApplication(this.companyId, id, body, requestHeaders).execute();
                if (!response.isSuccessful()) {
                    throw new FDKServerResponseError(response.code(),
                                            response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                            response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
...
public class ApplicationClient {
    ...
    public ConfigurationPlatformModels.MobileAppConfiguration getBuildConfig(String platformType) throws FDKServerResponseError, FDKException {
        return this.getBuildConfig(platformType, new HashMap<>());
    }

    public ConfigurationPlatformModels.MobileAppConfiguration getBuildConfig(String platformType, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ConfigurationPlatformModels.MobileAppConfiguration> response = null;
            try {
            response = configurationPlatformApiList.getBuildConfig(this.companyId, this.applicationId, platformType, requestHeaders).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public ConfigurationPlatformModels.MobileAppConfiguration updateBuildConfig(String platformType, ConfigurationPlatformModels.MobileAppConfigRequest body) throws FDKServerResponseError, FDKException {
        return this.updateBuildConfig(platformType, body, new HashMap<>());
    }

    public ConfigurationPlatformModels.MobileAppConfiguration updateBuildConfig(String platformType, ConfigurationPlatformModels.MobileAppConfigRequest body, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ConfigurationPlatformModels.MobileAppConfiguration> response = null;
            try {
            response = configurationPlatformApiList.updateBuildConfig(this.companyId, this.applicationId, platformType, body, requestHeaders).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public ConfigurationPlatformModels.BuildVersionHistory getPreviousVersions(String platformType) throws FDKServerResponseError, FDKException {
        return this.getPreviousVersions(platformType, new HashMap<>());
    }

    public ConfigurationPlatformModels.BuildVersionHistory getPreviousVersions(String platformType, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ConfigurationPlatformModels.BuildVersionHistory> response = null;
            try {
            response = configurationPlatformApiList.getPreviousVersions(this.companyId, this.applicationId, platformType, requestHeaders).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    **/
    ...
    public ConfigurationPlatformModels.SuccessMessageResponse removeDomainById(String id) throws FDKServerResponseError, FDKException {
        return this.removeDomainById(id, new HashMap<>());
    }

    public ConfigurationPlatformModels.SuccessMessageResponse removeDomainById(String id, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ConfigurationPlatformModels.SuccessMessageResponse> response = null;
            try {
            response = configurationPlatformApiList.removeDomainById(this.companyId, this.applicationId, id, requestHeaders).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
