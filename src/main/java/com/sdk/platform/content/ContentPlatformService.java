...
public class ApplicationClient {
    ...
    public ContentPlatformModels.PageSchema createPagePreview(ContentPlatformModels.PagePayload body) throws FDKServerResponseError, FDKException {
        return this.createPagePreview(body, new HashMap<>());
    }

    public ContentPlatformModels.PageSchema createPagePreview(ContentPlatformModels.PagePayload body, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
    ...
    public ContentPlatformModels.SlideshowGetDetails getSlideshows(String devicePlatform, Integer pageNo, Integer pageSize) throws FDKServerResponseError, FDKException {
        return this.getSlideshows(devicePlatform, pageNo, pageSize, new HashMap<>());
    }

    public ContentPlatformModels.SlideshowGetDetails getSlideshows(String devicePlatform, Integer pageNo, Integer pageSize, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ContentPlatformModels.SlideshowGetDetails> response = null;
            try {
    ...
    public ContentPlatformModels.SlideshowSchema createSlideshow(ContentPlatformModels.SlideshowPayload body) throws FDKServerResponseError, FDKException {
        return this.createSlideshow(body, new HashMap<>());
    }

    public ContentPlatformModels.SlideshowSchema createSlideshow(ContentPlatformModels.SlideshowPayload body, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
    ...
    public ContentPlatformModels.SlideshowSchema updateSlideshow(String id, ContentPlatformModels.SlideshowPayload body) throws FDKServerResponseError, FDKException {
        return this.updateSlideshow(id, body, new HashMap<>());
    }

    public ContentPlatformModels.SlideshowSchema updateSlideshow(String id, ContentPlatformModels.SlideshowPayload body, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ContentPlatformModels.SlideshowSchema> response = null;
            try {
