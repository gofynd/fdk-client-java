...
public class ApplicationClient {
    ...
    public ContentPlatformModels.AppAssociationRecord getAppAssociation() throws FDKServerResponseError, FDKException {
        return this.getAppAssociation(new HashMap<>());
    }

    public ContentPlatformModels.AppAssociationRecord getAppAssociation(Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ContentPlatformModels.AppAssociationRecord> response = null;
            try {
            response = contentPlatformApiList.getAppAssociation(this.companyId, this.applicationId, requestHeaders).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public ContentPlatformModels.AppAssociationRecord createAppAssociation(ContentPlatformModels.AppAssociationWriteBody body) throws FDKServerResponseError, FDKException {
        return this.createAppAssociation(body, new HashMap<>());
    }

    public ContentPlatformModels.AppAssociationRecord createAppAssociation(ContentPlatformModels.AppAssociationWriteBody body, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ContentPlatformModels.AppAssociationRecord> response = null;
            try {
            response = contentPlatformApiList.createAppAssociation(this.companyId, this.applicationId, body, requestHeaders).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public ContentPlatformModels.AppAssociationRecord updateAppAssociation(ContentPlatformModels.AppAssociationWriteBody body) throws FDKServerResponseError, FDKException {
        return this.updateAppAssociation(body, new HashMap<>());
    }

    public ContentPlatformModels.AppAssociationRecord updateAppAssociation(ContentPlatformModels.AppAssociationWriteBody body, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ContentPlatformModels.AppAssociationRecord> response = null;
            try {
            response = contentPlatformApiList.updateAppAssociation(this.companyId, this.applicationId, body, requestHeaders).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public ContentPlatformModels.AppAssociationDeleted deleteAppAssociation() throws FDKServerResponseError, FDKException {
        return this.deleteAppAssociation(new HashMap<>());
    }

    public ContentPlatformModels.AppAssociationDeleted deleteAppAssociation(Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ContentPlatformModels.AppAssociationDeleted> response = null;
            try {
            response = contentPlatformApiList.deleteAppAssociation(this.companyId, this.applicationId, requestHeaders).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public ContentPlatformModels.DataLoaderResponseSchema getDataLoadersByService(String serviceName) throws FDKServerResponseError, FDKException {
        return this.getDataLoadersByService(serviceName, new HashMap<>());
    }

    public ContentPlatformModels.DataLoaderResponseSchema getDataLoadersByService(String serviceName, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ContentPlatformModels.DataLoaderResponseSchema> response = null;
            try {
    ...
    public ContentPlatformModels.SEOSchemaMarkupTemplate getSEOMarkupSchema(String id) throws FDKServerResponseError, FDKException {
        return this.getSEOMarkupSchema(id, new HashMap<>());
    }

    public ContentPlatformModels.SEOSchemaMarkupTemplate getSEOMarkupSchema(String id, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ContentPlatformModels.SEOSchemaMarkupTemplate> response = null;
            try {
            response = contentPlatformApiList.getSEOMarkupSchema(this.companyId, this.applicationId, id, requestHeaders).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public ContentPlatformModels.SEOSchemaMarkupTemplate editSEOMarkupSchema(String id, ContentPlatformModels.SEOSchemaMarkupTemplateRequestBody body, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ContentPlatformModels.SEOSchemaMarkupTemplate> response = null;
            try {
            response = contentPlatformApiList.editSEOMarkupSchema(this.companyId, this.applicationId, id, body, requestHeaders).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public ContentPlatformModels.SEOSchemaMarkupTemplate deleteSEOMarkupSchema(String id) throws FDKServerResponseError, FDKException {
        return this.deleteSEOMarkupSchema(id, new HashMap<>());
    }

    public ContentPlatformModels.SEOSchemaMarkupTemplate deleteSEOMarkupSchema(String id, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ContentPlatformModels.SEOSchemaMarkupTemplate> response = null;
            try {
            response = contentPlatformApiList.deleteSEOMarkupSchema(this.companyId, this.applicationId, id, requestHeaders).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public ContentPlatformModels.TagsTemplateSchema getTagsTemplate() throws FDKServerResponseError, FDKException {
        return this.getTagsTemplate(new HashMap<>());
    }

    public ContentPlatformModels.TagsTemplateSchema getTagsTemplate(Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<ContentPlatformModels.TagsTemplateSchema> response = null;
            try {
            response = contentPlatformApiList.getTagsTemplate(this.companyId, this.applicationId, requestHeaders).execute();
                if (!response.isSuccessful()) {
                        throw new FDKServerResponseError(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
