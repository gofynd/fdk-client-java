...
public class PlatformOauthClient {
    ...
    private static final String URI = "/service/panel/authentication/v1.0/company/";
    ...
    private void getAccessToken() {
        if (this.useAutoRenewTimer.equals(Boolean.FALSE) && StringUtils.isNotEmpty(this.refreshToken) && isTokenExpired(120)) {
            try {
