...
public class FinancePlatformService {
    ...
    public FinancePlatformModels.UnlockCreditNoteResponse unlockCreditNote(FinancePlatformModels.UnlockCreditNoteRequest body) throws FDKServerResponseError, FDKException {
        return this.unlockCreditNote(body, new HashMap<>());
    }

    public FinancePlatformModels.UnlockCreditNoteResponse unlockCreditNote(FinancePlatformModels.UnlockCreditNoteRequest body, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
