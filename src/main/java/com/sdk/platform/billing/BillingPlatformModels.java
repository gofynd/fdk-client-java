...
public static class Subscription{
    ...
    @JsonProperty("is_eligible_for_plan_change")
    private Boolean isEligibleForPlanChange;
...
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonInclude(JsonInclude.Include.NON_NULL)
public static class AuthorModifiedDetails{
...
public static class Author{
    ...
    private AuthorModifiedDetails modifiedByDetails;
