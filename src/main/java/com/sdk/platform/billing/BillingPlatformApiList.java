...
interface BillingPlatformApiList {
    ...
    Call<BillingPlatformModels.SubscriptionLimit> currentLimit(@Path("company_id") String companyId, @Query("product_suite") String productSuite, @Query("type") String type, @HeaderMap Map<String, String> requestHeaders);
