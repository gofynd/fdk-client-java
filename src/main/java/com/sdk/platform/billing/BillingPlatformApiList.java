...
interface BillingPlatformApiList {
    ...
    Call<BillingPlatformModels.SubscribePlanRes> paymentInitiate(@Path("company_id") String companyId, @Body BillingPlatformModels.SunscribePlan payload, @HeaderMap Map<String, String> requestHeaders);
