...
interface CompanyProfilePlatformApiList {
    ...
    Call<CompanyProfilePlatformModels.GetBrandResponseSchema> getBrand(@Path("company_id") String companyId, @Path("brand_id") Integer brandId, @HeaderMap Map<String, String> requestHeaders);

    @PUT ("/service/platform/catalog/v1.0/company/{company_id}/brand/{brand_id}")
    Call<CompanyProfilePlatformModels.ProfileSuccessResponseSchema> editBrand(@Path("company_id") String companyId, @Path("brand_id") Integer brandId, @Body CompanyProfilePlatformModels.CreateUpdateBrandRequestSchema payload, @HeaderMap Map<String, String> requestHeaders);

    @POST ("/service/platform/catalog/v1.0/company/{company_id}/brand")
    Call<CompanyProfilePlatformModels.ProfileSuccessResponseSchema> createBrand(@Path("company_id") String companyId, @Body CompanyProfilePlatformModels.CreateUpdateBrandRequestSchema payload, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<CompanyProfilePlatformModels.GetLocationSchema> getLocationDetail(@Path("company_id") String companyId, @Path("location_id") Integer locationId, @HeaderMap Map<String, String> requestHeaders);

    @PUT ("/service/platform/catalog/v2.0/company/{company_id}/location/{location_id}")
    Call<CompanyProfilePlatformModels.ProfileSuccessResponseSchema> updateLocation(@Path("company_id") String companyId, @Path("location_id") Integer locationId, @Body CompanyProfilePlatformModels.LocationSchema payload, @HeaderMap Map<String, String> requestHeaders);
