...
interface PaymentPlatformApiList {
    ...
    @GET ("/service/platform/payment/v1.0/company/{company_id}/application/{application_id}/refund/cod/configuration")
    Call<PaymentPlatformModels.CodRefundAggregatorResponseSchema> getCodRefundAggregator(@Path("company_id") String companyId, @Path("application_id") String applicationId, @HeaderMap Map<String, String> requestHeaders);

    @POST ("/service/platform/payment/v1.0/company/{company_id}/application/{application_id}/refund/cod/configuration")
    Call<PaymentPlatformModels.CodRefundAggregatorResponseSchema> updateCodRefundAggregator(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Body PaymentPlatformModels.CreateCodRefundAggregatorRequestSchema payload, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<PaymentPlatformModels.PlatformOnlineOfflinePaymentDetails> getMerchantPaymentOption(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Query("payment_option_type") String paymentOptionType, @Query("cod_refund_agg") Boolean codRefundAgg, @HeaderMap Map<String, String> requestHeaders);
