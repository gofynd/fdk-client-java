...
public class ApplicationClient {
    ...
    public PaymentPlatformModels.GetOauthUrlResponse oauthGetUrl(String aggregator , String successRedirectUrl , String failureRedirectUrl ) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
    ...
    public PaymentPlatformModels.RevokeOAuthToken revokeOauthToken(String aggregator ) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
