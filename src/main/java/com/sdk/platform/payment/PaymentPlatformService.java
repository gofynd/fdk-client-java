...
public class ApplicationClient {
    ...
    public PaymentPlatformModels.PaymentOptionsDetails getPaymentModeRoutes(Boolean refresh, String requestType, String orderId, String shipmentId) throws FDKServerResponseError, FDKException {
        return this.getPaymentModeRoutes(refresh, requestType, orderId, shipmentId, new HashMap<>());
    }

    public PaymentPlatformModels.PaymentOptionsDetails getPaymentModeRoutes(Boolean refresh, String requestType, String orderId, String shipmentId, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
