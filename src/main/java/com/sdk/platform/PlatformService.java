...
public static class PaymentService {
    ...
    public PlatformModels.PaymentStatusBulkHandlerResponse paymentStatusBulk(String applicationId ,PlatformModels.PaymentStatusBulkHandlerRequest body) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<PlatformModels.PaymentStatusBulkHandlerResponse> response = null;
            try {
                response = paymentApiList.paymentStatusBulk(this.companyId , applicationId  , body).execute();
                if (!response.isSuccessful()) {
                    throw new FDKException(response.code(),
                                            response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                            response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
