...
public class ApplicationClient {
    ...
    public PlatformModels.CustomerListResponseSchema getCustomers(String q , Integer pageSize , Integer pageNo ) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
    ...
    public PlatformModels.UserSearchResponseSchema searchUsers(Object q ) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
