...
public class ApplicationClient {
    ...
    public PlatformModels.GetUserCODLimitResponse getPosPaymentModeRoutes() throws IOException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<PlatformModels.GetUserCODLimitResponse> response = paymentApiList.getPosPaymentModeRoutes(this.companyId , this.applicationId ).execute();
            if (!response.isSuccessful()) {
                    throw new IOException(response.errorBody() != null
                            ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
                }
    ...
    public PlatformModels.SetCODOptionResponse getPosPaymentModeRoutes(PlatformModels.SetCODForUserRequest body) throws IOException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<PlatformModels.SetCODOptionResponse> response = paymentApiList.getPosPaymentModeRoutes(this.companyId , this.applicationId , body).execute();
            if (!response.isSuccessful()) {
                    throw new IOException(response.errorBody() != null
                            ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
                }
