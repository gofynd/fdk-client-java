...
public static class OrderService {
    ...
    public PlatformModels.ManualAssignDPToShipmentResponse manualAssignDPToShipment(PlatformModels.ManualAssignDPToShipment body) throws IOException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<PlatformModels.ManualAssignDPToShipmentResponse> response = orderApiList.manualAssignDPToShipment(this.companyId , body).execute();
            if (!response.isSuccessful()) {
                    throw new IOException(response.errorBody() != null
                            ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
                }
