...
public class ApplicationClient {
    ...
    public PlatformModels.UserGroupListResponseSchema getUserGroups(String pageNo , String pageSize , String name , String status , Integer groupUid ) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<PlatformModels.UserGroupListResponseSchema> response = null;
            try {
            response = userApiList.getUserGroups(this.companyId , this.applicationId ,pageNo , pageSize , name , status , groupUid ).execute();
                if (!response.isSuccessful()) {
                        throw new FDKException(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
...
public class ApplicationClient {
    ...
    public PlatformModels.RepaymentResponse repaymentDetails(PlatformModels.RepaymentDetailsSerialiserPayAll body) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<PlatformModels.RepaymentResponse> response = null;
            try {
            response = paymentApiList.repaymentDetails(this.companyId , this.applicationId , body).execute();
                if (!response.isSuccessful()) {
                        throw new FDKException(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public PlatformModels.MerchantOnBoardingResponse merchantOnBoarding(PlatformModels.MerchantOnBoardingRequest body) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<PlatformModels.MerchantOnBoardingResponse> response = null;
            try {
            response = paymentApiList.merchantOnBoarding(this.companyId , this.applicationId , body).execute();
                if (!response.isSuccessful()) {
                        throw new FDKException(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
...
public static class OrderService {
    ...
    public PlatformModels.OrderListing getOrdersByCompanyId(String pageNo , String pageSize , String fromDate , String toDate , Boolean isPrioritySort , Boolean lockStatus , String userId , String q , String stage , String salesChannels , String orderId , String stores , String deploymentStores , String status , String dp , String filterType ) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            ...
            try {
                response = orderApiList.getOrdersByCompanyId(this.companyId ,pageNo , pageSize , fromDate , toDate , isPrioritySort , lockStatus , userId , q , stage , salesChannels , orderId , stores , deploymentStores , status , dp , filterType ).execute();
                if (!response.isSuccessful()) {
                    throw new FDKException(response.code(),
                                            response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                            response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public PlatformModels.OrderPicklistListing getPicklistOrdersByCompanyId(String pageNo , String pageSize , String fromDate , String toDate , String q , String stage , String salesChannels , String orderId , String stores , String status , String filterType ) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<PlatformModels.OrderPicklistListing> response = null;
            try {
                response = orderApiList.getPicklistOrdersByCompanyId(this.companyId ,pageNo , pageSize , fromDate , toDate , q , stage , salesChannels , orderId , stores , status , filterType ).execute();
                if (!response.isSuccessful()) {
                    throw new FDKException(response.code(),
                                            response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                            response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
...
public class ApplicationClient {
    ...
    public PlatformModels.OrderDetails getApplicationOrderDetails(String orderId , String next , String previous ) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<PlatformModels.OrderDetails> response = null;
            try {
            response = orderApiList.getApplicationOrderDetails(this.companyId , this.applicationId ,orderId , next , previous ).execute();
                if (!response.isSuccessful()) {
                        throw new FDKException(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public PlatformModels.OrderListing getOrdersByApplicationId(String pageNo , String pageSize , String fromDate , String toDate , String q , String stage , String salesChannels , String orderId , String stores , String status , String dp , String userId , String shortenUrls , String filterType ) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<PlatformModels.OrderListing> response = null;
            try {
            response = orderApiList.getOrdersByApplicationId(this.companyId , this.applicationId ,pageNo , pageSize , fromDate , toDate , q , stage , salesChannels , orderId , stores , status , dp , userId , shortenUrls , filterType ).execute();
                if (!response.isSuccessful()) {
                        throw new FDKException(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
...
public static class ServiceabilityService {
    ...
    public PlatformModels.EntityRegionView_Response getEntityRegionView(PlatformModels.EntityRegionView_Request body) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            ...
            try {
                response = serviceabilityApiList.getEntityRegionView(this.companyId , body).execute();
                if (!response.isSuccessful()) {
                    throw new FDKException(response.code(),
                                            response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                            response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public PlatformModels.ListViewResponse getListView(Integer pageNumber , Integer pageSize , String name , Boolean isActive , String channelIds ) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            ...
            try {
                response = serviceabilityApiList.getListView(this.companyId ,pageNumber , pageSize , name , isActive , channelIds ).execute();
                if (!response.isSuccessful()) {
                    throw new FDKException(response.code(),
                                            response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                            response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public PlatformModels.CompanyStoreView_Response getCompanyStoreView() throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            ...
            try {
                response = serviceabilityApiList.getCompanyStoreView(this.companyId ).execute();
                if (!response.isSuccessful()) {
                    throw new FDKException(response.code(),
                                            response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                            response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public PlatformModels.ZoneSuccessResponse updateZoneControllerView(String zoneId ,PlatformModels.ZoneUpdateRequest body) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            ...
            try {
                response = serviceabilityApiList.updateZoneControllerView(zoneId  , this.companyId , body).execute();
                if (!response.isSuccessful()) {
                    throw new FDKException(response.code(),
                                            response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                            response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public PlatformModels.GetSingleZoneDataViewResponse getZoneDataView(String zoneId ) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            ...
            try {
                response = serviceabilityApiList.getZoneDataView(this.companyId , zoneId  ).execute();
                if (!response.isSuccessful()) {
                    throw new FDKException(response.code(),
                                            response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                            response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public PlatformModels.ZoneResponse createZone(PlatformModels.ZoneRequest body) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<PlatformModels.ZoneResponse> response = null;
            try {
                response = serviceabilityApiList.createZone(this.companyId , body).execute();
                if (!response.isSuccessful()) {
                    throw new FDKException(response.code(),
                                            response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                            response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public PlatformModels.GetStoresViewResponse getStore(Integer storeUid ) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            ...
            try {
                response = serviceabilityApiList.getStore(this.companyId , storeUid  ).execute();
                if (!response.isSuccessful()) {
                    throw new FDKException(response.code(),
                                            response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                            response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public PlatformModels.GetStoresViewResponse getAllStores() throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<PlatformModels.GetStoresViewResponse> response = null;
            try {
                response = serviceabilityApiList.getAllStores(this.companyId ).execute();
                if (!response.isSuccessful()) {
                    throw new FDKException(response.code(),
                                            response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                            response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
...
public class ApplicationClient {
    ...
    public PlatformModels.ApplicationServiceabilityConfigResponse getApplicationServiceability() throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            ...
            try {
            response = serviceabilityApiList.getApplicationServiceability(this.companyId , this.applicationId ).execute();
                if (!response.isSuccessful()) {
                        throw new FDKException(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public PlatformModels.GetZoneFromApplicationIdViewResponse getZonesFromApplicationIdView(Integer pageNo , Integer pageSize , List<String> zoneId , String q ) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<PlatformModels.GetZoneFromApplicationIdViewResponse> response = null;
            try {
            response = serviceabilityApiList.getZonesFromApplicationIdView(this.companyId , this.applicationId ,pageNo , pageSize , zoneId , q ).execute();
                if (!response.isSuccessful()) {
                        throw new FDKException(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public PlatformModels.GetZoneFromPincodeViewResponse getZoneFromPincodeView(PlatformModels.GetZoneFromPincodeViewRequest body) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<PlatformModels.GetZoneFromPincodeViewResponse> response = null;
            try {
            response = serviceabilityApiList.getZoneFromPincodeView(this.companyId , this.applicationId , body).execute();
                if (!response.isSuccessful()) {
                        throw new FDKException(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public PlatformModels.PincodeMOPresponse updatePincodeMopView(PlatformModels.PincodeMopData body) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<PlatformModels.PincodeMOPresponse> response = null;
            try {
            response = serviceabilityApiList.updatePincodeMopView(this.companyId , this.applicationId , body).execute();
                if (!response.isSuccessful()) {
                        throw new FDKException(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public PlatformModels.PincodeBulkViewResponse updatePincodeBulkView(PlatformModels.PincodeMopBulkData body) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<PlatformModels.PincodeBulkViewResponse> response = null;
            try {
            response = serviceabilityApiList.updatePincodeBulkView(this.companyId , this.applicationId , body).execute();
                if (!response.isSuccessful()) {
                        throw new FDKException(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public PlatformModels.PincodeCodStatusListingResponse updatePincodeCoDListing(PlatformModels.PincodeCodStatusListingRequest body) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<PlatformModels.PincodeCodStatusListingResponse> response = null;
            try {
            response = serviceabilityApiList.updatePincodeCoDListing(this.companyId , this.applicationId , body).execute();
                if (!response.isSuccessful()) {
                        throw new FDKException(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
    ...
    public PlatformModels.PincodeMopUpdateAuditHistoryResponseData updatePincodeAuditHistory(PlatformModels.PincodeMopUpdateAuditHistoryRequest body) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<PlatformModels.PincodeMopUpdateAuditHistoryResponseData> response = null;
            try {
            response = serviceabilityApiList.updatePincodeAuditHistory(this.companyId , this.applicationId , body).execute();
                if (!response.isSuccessful()) {
                        throw new FDKException(response.code(),
                                                response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                                response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
