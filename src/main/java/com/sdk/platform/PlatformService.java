...
public class ApplicationClient {
    ...
    public PlatformModels.PlatfromPaymentConfig getPlatformPaymentConfig() throws IOException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<PlatformModels.PlatfromPaymentConfig> response = paymentApiList.getPlatformPaymentConfig(this.companyId , this.applicationId ).execute();
            if (!response.isSuccessful()) {
                    throw new IOException(response.errorBody() != null
                            ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
                }
    ...
    public PlatformModels.PlatfromPaymentConfig updatePlatformPaymentConfig(PlatformModels.UpdatePlatformPaymentConfig body) throws IOException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<PlatformModels.PlatfromPaymentConfig> response = paymentApiList.updatePlatformPaymentConfig(this.companyId , this.applicationId , body).execute();
            if (!response.isSuccessful()) {
                    throw new IOException(response.errorBody() != null
                            ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
                }
...
public static class CatalogService {
    ...
    public PlatformModels.SuccessResponse patchProduct(Integer itemId ,PlatformModels.ProductCreateUpdate body) throws IOException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<PlatformModels.SuccessResponse> response = catalogApiList.patchProduct(this.companyId , itemId  , body).execute();
            if (!response.isSuccessful()) {
                    throw new IOException(response.errorBody() != null
                            ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
                }
...
public class ApplicationClient {
    ...
    **/
    ...
    public PlatformModels.CartDetailResponse getAbandonedCartDetails(String id , Boolean i , Boolean b ) throws IOException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<PlatformModels.CartDetailResponse> response = cartApiList.getAbandonedCartDetails(this.companyId , this.applicationId ,id , i , b ).execute();
            if (!response.isSuccessful()) {
                    throw new IOException(response.errorBody() != null
                            ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
                }
