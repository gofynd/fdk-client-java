...
public static class OrderService {
    ...
    public PlatformModels.BulkActionResponse bulkActionProcessXlsxFile(String url ) throws IOException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<PlatformModels.BulkActionResponse> response = orderApiList.bulkActionProcessXlsxFile(this.companyId ,url ).execute();
            if (!response.isSuccessful()) {
                    throw new IOException(response.errorBody() != null
                            ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
                }
