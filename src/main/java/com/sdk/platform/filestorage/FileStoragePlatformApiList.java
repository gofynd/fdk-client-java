...
interface FileStoragePlatformApiList {
    ...
    Call<FileStoragePlatformModels.BulkUploadSyncMode> copyFiles(@Path("company_id") String companyId, @Query("sync") Boolean sync, @Body FileStoragePlatformModels.CopyFiles payload, @HeaderMap Map<String, String> requestHeaders);

    @POST ("/service/platform/assets/v1.0/company/{company_id}/application/{application_id}/uploads/copy")
    Call<FileStoragePlatformModels.BulkUploadSyncMode> appCopyFiles(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Query("sync") Boolean sync, @Body FileStoragePlatformModels.CopyFiles payload, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/assets/v1.0/company/{company_id}/namespaces/{namespace}/browse")
    Call<FileStoragePlatformModels.BrowseResponse> browse(@Path("namespace") String namespace, @Path("company_id") String companyId, @Query("page") Integer page, @Query("limit") Integer limit, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/assets/v1.0/company/{company_id}/application/{application_id}/namespaces/{namespace}/browse")
    Call<FileStoragePlatformModels.BrowseResponse> appbrowse(@Path("namespace") String namespace, @Path("company_id") String companyId, @Path("application_id") String applicationId, @Query("page") Integer page, @Query("limit") Integer limit, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<List<FileStoragePlatformModels.InvoiceTypesResponse>> getPdfTypes(@Path("company_id") String companyId, @Path("application_id") String applicationId, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/assets/v1.0/company/{company_id}/application/{application_id}/pdf/mapper")
    Call<List<FileStoragePlatformModels.DummyTemplateDataItems>> getDefaultPdfData(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Query("pdf_type_id") Integer pdfTypeId, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/assets/v1.0/company/{company_id}/application/{application_id}/pdf/config")
    Call<List<FileStoragePlatformModels.PdfConfigSuccess>> getDefaultHtmlTemplate(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Query("pdf_type_id") Integer pdfTypeId, @Query("format") String format, @HeaderMap Map<String, String> requestHeaders);

    @PUT ("/service/platform/assets/v1.0/company/{company_id}/application/{application_id}/pdf/config")
    Call<List<FileStoragePlatformModels.PdfConfigSaveSuccess>> saveHtmlTemplate(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Body FileStoragePlatformModels.pdfConfig payload, @HeaderMap Map<String, String> requestHeaders);

    @POST ("/service/platform/assets/v1.0/company/{company_id}/application/{application_id}/pdf/render")
    Call<String> previewTemplate(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Body FileStoragePlatformModels.pdfRender payload, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/assets/v1.0/company/{company_id}/application/{application_id}/pdf/default-template")
    Call<List<FileStoragePlatformModels.PdfDefaultTemplateSuccess>> getDefaultPdfTemplate(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Query("pdf_type_id") Integer pdfTypeId, @Query("format") String format, @HeaderMap Map<String, String> requestHeaders);
}