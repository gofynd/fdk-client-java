...
interface ServiceabilityPlatformApiList {
    ...
    Call<ServiceabilityPlatformModels.BulkRegionServiceabilityTatResponseItemData> sampleFileServiceability(@Path("company_id") String companyId, @Body ServiceabilityPlatformModels.BulkRegionServiceabilityTatRequest payload, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/logistics/v1.0/company/{company_id}/localities/bulk-sample")
    Call<ServiceabilityPlatformModels.BulkRegionServiceabilityTatResponse> getSampleFileServiceabilityStatus(@Path("company_id") String companyId, @Query("page_no") Integer pageNo, @Query("page_size") Integer pageSize, @Query("batch_id") String batchId, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<ServiceabilityPlatformModels.ZoneBulkValidationResponse> validateBulkGeoarea(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Body ServiceabilityPlatformModels.ZoneBulkValidationRequestSchema payload, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/logistics/v1.0/company/{company_id}/application/{application_id}/geoareas/bulk/validation/{batch_id}")
    Call<ServiceabilityPlatformModels.ZoneBulkValidationStatusResponse> getBulkGeoareaValidation(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("batch_id") String batchId, @HeaderMap Map<String, String> requestHeaders);

    @POST ("/service/platform/logistics/v1.0/company/{company_id}/application/{application_id}/geoareas/bulk/import/{batch_id}")
    Call<ServiceabilityPlatformModels.ZoneBulkValidationStatusResponse> importBulkGeoarea(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("batch_id") String batchId, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/logistics/v1.0/company/{company_id}/application/{application_id}/geoareas/bulk/import/{batch_id}")
    Call<ServiceabilityPlatformModels.ZoneBulkImportResponse> importBulkGeoareaStatus(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("batch_id") String batchId, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<ServiceabilityPlatformModels.CourierPartnerSchemeUpdateRequest> updateCourierPartnerScheme(@Path("company_id") String companyId, @Path("scheme_id") String schemeId, @Body ServiceabilityPlatformModels.CourierPartnerSchemeUpdateRequest payload, @HeaderMap Map<String, String> requestHeaders);
