...
interface ServiceabilityPlatformApiList {
    ...
    Call<ServiceabilityPlatformModels.OperationResponseSchema> deleteFulfillmentOptions(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("slug") String slug, @HeaderMap Map<String, String> requestHeaders);

    @PUT ("/service/platform/logistics/v1.0/company/{company_id}/application/{application_id}/fulfillment-options/{slug}")
    Call<ServiceabilityPlatformModels.FulfillmentOption> putFulfillmentOption(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("slug") String slug, @Body ServiceabilityPlatformModels.FulfillmentOption payload, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/logistics/v1.0/company/{company_id}/application/{application_id}/fulfillment-options/{slug}/products")
    Call<ServiceabilityPlatformModels.FulfillmentOptionProducts> getFulfillmentOptionProducts(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("slug") String slug, @Query("q") String q, @Query("store_id") Integer storeId, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/logistics/v1.0/company/{company_id}/application/{application_id}/fulfillment-options/{slug}/stores")
    Call<ServiceabilityPlatformModels.FulfillmentOptionStores> getFulfillmentOptionStores(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("slug") String slug, @Query("q") String q, @HeaderMap Map<String, String> requestHeaders);

    @POST ("/service/platform/logistics/v1.0/company/{company_id}/application/{application_id}/fulfillment-options/bulk")
    Call<ServiceabilityPlatformModels.FulfillmentOptionBulkData> uploadBulkFulfillmentOptions(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Body ServiceabilityPlatformModels.FulfillmentOptionBulk payload, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<ServiceabilityPlatformModels.FulfillmentOptionBulkValidateData> validateBulkFulfillmentOptions(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("type") String type, @Body ServiceabilityPlatformModels.FulfillmentOptionBulkValidate payload, @HeaderMap Map<String, String> requestHeaders);
