...
public class ApplicationClient {
    ...
    public RewardsPlatformModels.GiveawayResponse getGiveaways(String pageId , Integer pageSize ) throws FDKException {
    ...
    **/
    ...
    public RewardsPlatformModels.Giveaway createGiveaway(RewardsPlatformModels.Giveaway body) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
    ...
    public List<RewardsPlatformModels.Offer> getOffers() throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
    ...
    public RewardsPlatformModels.Offer getOfferByName(String cookie , String name ) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
    ...
    public RewardsPlatformModels.UserRes getUserAvailablePoints(String userId ) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
    ...
    public RewardsPlatformModels.HistoryRes getUserPointsHistory(String userId , String pageId , Integer pageLimit , Integer pageSize ) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
