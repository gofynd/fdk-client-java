...
public class OrderPlatformService {
    ...
    public OrderPlatformModels.PostRefundStateConfigurationResponseSchema postRefundStateConfiguration(String appId, OrderPlatformModels.PostRefundStateConfiguration body) throws FDKServerResponseError, FDKException {
        return this.postRefundStateConfiguration(appId, body, new HashMap<>());
    }

    public OrderPlatformModels.PostRefundStateConfigurationResponseSchema postRefundStateConfiguration(String appId, OrderPlatformModels.PostRefundStateConfiguration body, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
    ...
    public OrderPlatformModels.GetRefundStateConfigurationResponseSchema getRefundStateConfiguration(String appId) throws FDKServerResponseError, FDKException {
        return this.getRefundStateConfiguration(appId, new HashMap<>());
    }

    public OrderPlatformModels.GetRefundStateConfigurationResponseSchema getRefundStateConfiguration(String appId, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
