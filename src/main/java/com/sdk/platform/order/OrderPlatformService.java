...
public class OrderPlatformService {
    ...
    public OrderPlatformModels.BaseResponse sendSmsNinja(OrderPlatformModels.SendSmsPayload body) throws FDKServerResponseError, FDKException {
        return this.sendSmsNinja(body, new HashMap<>());
    }

    public OrderPlatformModels.BaseResponse sendSmsNinja(OrderPlatformModels.SendSmsPayload body, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<OrderPlatformModels.BaseResponse> response = null;
            try {
    ...
    public OrderPlatformModels.ManifestResponse generateProcessManifest(OrderPlatformModels.ProcessManifestRequest body) throws FDKServerResponseError, FDKException {
        return this.generateProcessManifest(body, new HashMap<>());
    }

    public OrderPlatformModels.ManifestResponse generateProcessManifest(OrderPlatformModels.ProcessManifestRequest body, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<OrderPlatformModels.ManifestResponse> response = null;
            try {
    ...
    public OrderPlatformModels.SuccessResponse dispatchManifests(OrderPlatformModels.DispatchManifest body) throws FDKServerResponseError, FDKException {
        return this.dispatchManifests(body, new HashMap<>());
    }

    public OrderPlatformModels.SuccessResponse dispatchManifests(OrderPlatformModels.DispatchManifest body, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
    ...
    public OrderPlatformModels.SuccessResponse uploadConsents(OrderPlatformModels.UploadManifestConsent body) throws FDKServerResponseError, FDKException {
        return this.uploadConsents(body, new HashMap<>());
    }

    public OrderPlatformModels.SuccessResponse uploadConsents(OrderPlatformModels.UploadManifestConsent body, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<OrderPlatformModels.SuccessResponse> response = null;
            try {
    ...
    public OrderPlatformModels.GenerateInvoiceIDResponse generateInvoiceID(String invoiceType, OrderPlatformModels.GenerateInvoiceIDRequestSchema body) throws FDKServerResponseError, FDKException {
        return this.generateInvoiceID(invoiceType, body, new HashMap<>());
    }

    public OrderPlatformModels.GenerateInvoiceIDResponse generateInvoiceID(String invoiceType, OrderPlatformModels.GenerateInvoiceIDRequestSchema body, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
    ...
    public OrderPlatformModels.ConfigUpdatedResponse addStateManagerConfig(OrderPlatformModels.TransitionConfigPayload body) throws FDKServerResponseError, FDKException {
        return this.addStateManagerConfig(body, new HashMap<>());
    }

    public OrderPlatformModels.ConfigUpdatedResponse addStateManagerConfig(OrderPlatformModels.TransitionConfigPayload body, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<OrderPlatformModels.ConfigUpdatedResponse> response = null;
            try {
    ...
    public OrderPlatformModels.OrderListingResponse getOrders(String lane, String searchType, String bagStatus, Integer timeToDispatch, String paymentMethods, String tags, String searchValue, String fromDate, String toDate, String startDate, String endDate, String dpIds, String stores, String salesChannels, Integer pageNo, Integer pageSize, Boolean isPrioritySort, String customMeta, Boolean myOrders, Boolean showCrossCompanyData, String customerId, String orderType, Boolean allowInactive, Boolean enforceDateFilter) throws FDKServerResponseError, FDKException {
        return this.getOrders(lane, searchType, bagStatus, timeToDispatch, paymentMethods, tags, searchValue, fromDate, toDate, startDate, endDate, dpIds, stores, salesChannels, pageNo, pageSize, isPrioritySort, customMeta, myOrders, showCrossCompanyData, customerId, orderType, allowInactive, enforceDateFilter, new HashMap<>());
    }

    public OrderPlatformModels.OrderListingResponse getOrders(String lane, String searchType, String bagStatus, Integer timeToDispatch, String paymentMethods, String tags, String searchValue, String fromDate, String toDate, String startDate, String endDate, String dpIds, String stores, String salesChannels, Integer pageNo, Integer pageSize, Boolean isPrioritySort, String customMeta, Boolean myOrders, Boolean showCrossCompanyData, String customerId, String orderType, Boolean allowInactive, Boolean enforceDateFilter, Map<String, String> requestHeaders) throws FDKServerResponseError, FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<OrderPlatformModels.OrderListingResponse> response = null;
            try {
                response = orderPlatformApiList.getOrders(this.companyId, lane, searchType, bagStatus, timeToDispatch, paymentMethods, tags, searchValue, fromDate, toDate, startDate, endDate, dpIds, stores, salesChannels, pageNo, pageSize, isPrioritySort, customMeta, myOrders, showCrossCompanyData, customerId, orderType, allowInactive, enforceDateFilter, requestHeaders).execute();
                if (!response.isSuccessful()) {
                    throw new FDKServerResponseError(response.code(),
                                            response.errorBody() != null ? response.errorBody().string() : Fields.UNKNOWN_ERROR,
                                            response.headers() != null ? response.headers().toString() : Fields.UNKNOWN_ERROR,
