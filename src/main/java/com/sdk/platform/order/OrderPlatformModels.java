...
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonInclude(JsonInclude.Include.NON_NULL)
public static class CreditNoteData{
...
public static class ShipmentMeta{
    ...
    @JsonProperty("credit_note_data")
    private CreditNoteData creditNoteData;
...
public static class PDFLink{
    ...
    @JsonProperty("credit_note_a4")
    private String creditNoteA4;
