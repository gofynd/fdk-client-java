...
interface OrderPlatformApiList {
    ...
    Call<OrderPlatformModels.RoleBaseStateTransitionMapping> getAllowedStateTransition(@Path("company_id") String companyId, @Query("ordering_channel") String orderingChannel, @Query("ordering_source") OrderPlatformModels.OrderingSource orderingSource, @Query("status") String status, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<Object> getStateManagerConfig(@Path("company_id") String companyId, @Query("app_id") String appId, @Query("ordering_channel") String orderingChannel, @Query("ordering_source") OrderPlatformModels.OrderingSource orderingSource, @Query("entity") String entity, @HeaderMap Map<String, String> requestHeaders);
