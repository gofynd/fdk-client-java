...
interface OrderPlatformApiList {
    ...
    Call<OrderPlatformModels.ProcessManifestItemResponseSchema> processManifests(@Path("company_id") String companyId, @Body OrderPlatformModels.ProcessManifest payload, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<OrderPlatformModels.SuccessResponseSchema> uploadConsents(@Path("company_id") String companyId, @Path("manifest_id") String manifestId, @Body OrderPlatformModels.UploadConsent payload, @HeaderMap Map<String, String> requestHeaders);
