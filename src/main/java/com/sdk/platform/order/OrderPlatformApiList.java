...
interface OrderPlatformApiList {
    ...
    Call<OrderPlatformModels.OrderStatusResult> sendSmsNinjaPlatform(@Path("company_id")  String companyId ,@Body OrderPlatformModels.SendSmsPayload payload);
