...
interface OrderPlatformApiList {
    ...
    Call<OrderPlatformModels.PostRefundStateConfigurationResponseSchema> postRefundStateConfiguration(@Path("company_id") String companyId, @Query("app_id") String appId, @Query("payment_type") String paymentType, @Body OrderPlatformModels.PostRefundStateConfiguration payload, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/order-manage/v1.0/company/{company_id}/refund/states/config")
    Call<OrderPlatformModels.GetRefundStateConfigurationResponseSchema> getRefundStateConfiguration(@Path("company_id") String companyId, @Query("app_id") String appId, @Query("payment_type") String paymentType, @HeaderMap Map<String, String> requestHeaders);
