...
interface OrderPlatformApiList {
    ...
    @GET ("/service/platform/order-manage/v1.0/company/{company_id}/application/{application_id}/ordering-sources/{slug}")
    Call<OrderPlatformModels.OrderingSourceConfig> getOrderingSourceConfigBySlug(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("slug") String slug, @HeaderMap Map<String, String> requestHeaders);

    @PUT ("/service/platform/order-manage/v1.0/company/{company_id}/application/{application_id}/ordering-sources/{slug}")
    Call<OrderPlatformModels.OrderingSourceConfig> updateOrderingSourceConfigBySlug(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("slug") String slug, @Body OrderPlatformModels.OrderingSourceConfig payload, @HeaderMap Map<String, String> requestHeaders);

    @POST ("/service/platform/order-manage/v1.0/company/{company_id}/orders")
    Call<Object> createOrder(@Path("company_id") String companyId, @Body OrderPlatformModels.CreateOrderRequestSchema payload, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/order-manage/v1.0/company/{company_id}/application/{application_id}/ordering-sources")
    Call<OrderPlatformModels.ListOrderingSources> listOrderingSources(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Query("type") String type, @Query("page_no") Integer pageNo, @Query("page_size") Integer pageSize, @HeaderMap Map<String, String> requestHeaders);

    @POST ("/service/platform/order-manage/v1.0/company/{company_id}/account")
    Call<OrderPlatformModels.Account> createAccount(@Path("company_id") String companyId, @Body OrderPlatformModels.CreateAccount payload, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/order-manage/v1.0/company/{company_id}/account")
    Call<OrderPlatformModels.AccountsList> listAccounts(@Path("company_id") String companyId, @Query("page") Integer page, @Query("size") Integer size, @HeaderMap Map<String, String> requestHeaders);

    @GET ("/service/platform/order-manage/v1.0/company/{company_id}/account/{channel_account_id}")
    Call<OrderPlatformModels.Account> getAccountById(@Path("company_id") String companyId, @Path("channel_account_id") String channelAccountId, @HeaderMap Map<String, String> requestHeaders);
