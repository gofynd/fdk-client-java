...
interface OrderPlatformApiList {
    ...
    Call<OrderPlatformModels.RoleBaseStateTransitionMapping> getRoleBaseStateTransition(@Path("company_id")  String companyId , @Query("ordering_channel") String  orderingChannel ,  @Query("status") String  status );
