...
interface OrderPlatformApiList {
    ...
    Call<OrderPlatformModels.RoleBaseStateTransitionMapping> getAllowedStateTransition(@Path("company_id")  String companyId , @Query("ordering_channel") String  orderingChannel ,  @Query("status") String  status );
    ...
    Call<OrderPlatformModels.BulkReportsDownloadResponse> downloadLanesReport(@Path("company_id")  String companyId ,@Body OrderPlatformModels.BulkReportsDownloadRequest payload);
