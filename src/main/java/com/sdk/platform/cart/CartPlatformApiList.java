...
interface CartPlatformApiList {
    ...
    Call<CartPlatformModels.AddCartDetailResult> platformAddItems(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Query("i") Boolean i, @Query("b") Boolean b, @Query("include_cart_calculation") Boolean includeCartCalculation, @Query("buy_now") Boolean buyNow, @Query("order_type") String orderType, @Query("id") String id, @Body CartPlatformModels.PlatformAddCartDetails payload, @HeaderMap Map<String, String> requestHeaders);

    @PUT ("/service/platform/cart/v1.0/company/{company_id}/application/{application_id}/detail")
    Call<CartPlatformModels.UpdateCartDetailResult> platformUpdateCart(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Query("id") String id, @Query("i") Boolean i, @Query("order_type") String orderType, @Query("b") Boolean b, @Query("include_cart_calculation") Boolean includeCartCalculation, @Query("buy_now") Boolean buyNow, @Body CartPlatformModels.PlatformUpdateCartDetails payload, @HeaderMap Map<String, String> requestHeaders);

    @PATCH ("/service/platform/cart/v1.0/company/{company_id}/application/{application_id}/detail")
    Call<CartPlatformModels.CartDetailResult> updateCartBreakup(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Query("id") String id, @Query("i") Boolean i, @Query("b") Boolean b, @Query("include_cart_calculation") Boolean includeCartCalculation, @Query("buy_now") Boolean buyNow, @Body CartPlatformModels.UpdateCartBreakup payload, @HeaderMap Map<String, String> requestHeaders);
