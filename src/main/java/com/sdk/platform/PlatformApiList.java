...
interface OrderApiList {
    ...
    Call<PlatformModels.ManualAssignDPToShipmentResponse> manualAssignDPToShipment(@Path("company_id")  String companyId ,@Body PlatformModels.ManualAssignDPToShipment payload);
