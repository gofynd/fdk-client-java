...
interface OrderApiList {
    ...
    @POST ("/service/platform/order-manage/v1.0/company/{company_id}/orders/co-config")
    ...
    @GET ("/service/platform/order-manage/v1.0/company/{company_id}/orders/co-config")
