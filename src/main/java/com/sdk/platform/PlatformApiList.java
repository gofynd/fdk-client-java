...
interface PaymentApiList {
    ...
    Call<PlatformModels.EdcDeviceDetailsResponse> edcDevice(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.EdcDetailsRequest payload);
    ...
    Call<PlatformModels.EdcDeviceAddUpdateResponse> edcDevice(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.EdcUpdateRequest payload);
    ...
    @PUT ("/service/platform/payment/v1.0/company/{company_id}/application/{application_id}/payment/edc-device")
    Call<PlatformModels.EdcDeviceAddUpdateResponse> edcDevice(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.EdcAddRequest payload);
    ...
    Call<PlatformModels.EdcDeviceListResponse> edcDeviceList(@Path("company_id")  String companyId , @Path("application_id")  String applicationId );
