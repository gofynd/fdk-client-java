...
interface OrderManageApiList {
    ...
    @POST ("/service/platform/order-manage/v1.0/company/{company_id}/shipment/edd-update")
    Call<PlatformModels.SuccessResponse> shipmentEDDUpdate(@Path("company_id")  String companyId ,@Body PlatformModels.ShipmentEDDUpdate payload);
