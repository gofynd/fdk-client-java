...
interface PaymentApiList {
    ...
    Call<PlatformModels.PaymentStatusBulkHandlerResponse> paymentStatusBulk(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.PaymentStatusBulkHandlerRequest payload);
