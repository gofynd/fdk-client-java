...
interface PaymentApiList {
    ...
    Call<PlatformModels.PaymentOptionsResponse> getPaymentModeRoutesPos(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("refresh") Boolean  refresh ,  @Query("request_type") String  requestType );
    ...
    @POST ("/service/platform/payment/v1.0/company/{company_id}/application/{application_id}/payment/options/pos")
