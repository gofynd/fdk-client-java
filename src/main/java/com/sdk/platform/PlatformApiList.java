...
interface PaymentApiList {
    ...
    @GET ("/service/platform/payment/v1.0/company/{company_id}/application/{application_id}/payment/fetch-cod-order-limit")
    Call<PlatformModels.GetUserCODLimitResponse> getPosPaymentModeRoutes(@Path("company_id")  String companyId , @Path("application_id")  String applicationId );
    ...
    @POST ("/service/platform/payment/v1.0/company/{company_id}/application/{application_id}/payment/fetch-cod-order-limit")
    Call<PlatformModels.SetCODOptionResponse> getPosPaymentModeRoutes(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.SetCODForUserRequest payload);
