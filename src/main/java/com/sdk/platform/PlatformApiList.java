...
interface CatalogApiList {
    ...
    Call<PlatformModels.CategoryResponse> listCategories(@Path("company_id")  String companyId , @Query("level") String  level ,  @Query("department") String  department ,  @Query("q") String  q ,  @Query("page_no") Integer  pageNo ,  @Query("page_size") Integer  pageSize );
    ...
    Call<PlatformModels.Product> getProduct(@Path("company_id")  String companyId , @Path("item_id") Integer  itemId , @Query("item_code") String  itemCode ,  @Query("brand_uid") Integer  brandUid );
    ...
    Call<PlatformModels.SuccessResponse> editProduct(@Path("company_id")  String companyId , @Path("item_id") Integer  itemId ,@Body PlatformModels.ProductCreateUpdateRequest payload);
    ...
    Call<PlatformModels.SuccessResponse> patchProduct(@Path("company_id")  String companyId , @Path("item_id") Integer  itemId ,@Body PlatformModels.ProductPatch payload);
    ...
    Call<PlatformModels.SuccessResponse> updateRealtimeInventory(@Path("company_id")  String companyId , @Path("item_id") Double  itemId , @Path("seller_identifier") String  sellerIdentifier ,@Body PlatformModels.InventoryRequestSchemaV2 payload);
...
interface CartApiList {
    ...
    @HEAD ("/service/platform/cart/v1.0/company/{company_id}/application/{application_id}/detail")
    Call<Object> getCartLastModified(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("id") String  id );
    ...
    Call<PlatformModels.AddCartDetailResponse> addItems(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("i") Boolean  i ,  @Query("b") Boolean  b ,  @Query("area_code") String  areaCode ,  @Query("buy_now") Boolean  buyNow ,@Body PlatformModels.AddCartRequest payload);
    ...
    Call<PlatformModels.UpdateCartDetailResponse> updateCart(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("id") String  id ,  @Query("i") Boolean  i ,  @Query("b") Boolean  b ,  @Query("area_code") String  areaCode ,  @Query("buy_now") Boolean  buyNow ,@Body PlatformModels.UpdateCartRequest payload);
    ...
    Call<PlatformModels.SaveAddressResponse> addAddress(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.Address payload);
    ...
    Call<PlatformModels.UpdateAddressResponse> updateAddress(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Path("id") String  id ,@Body PlatformModels.Address payload);
    ...
    Call<PlatformModels.CartDetailResponse> selectAddress(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("cart_id") String  cartId ,  @Query("buy_now") Boolean  buyNow ,  @Query("i") Boolean  i ,  @Query("b") Boolean  b ,  @Query("user_id") String  userId ,@Body PlatformModels.SelectCartAddressRequest payload);
    ...
    Call<PlatformModels.CartCheckoutResponse> checkoutCart(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("id") String  id ,@Body PlatformModels.CartPosCheckoutDetailRequest payload);
...
interface RewardsApiList {
    ...
    Call<PlatformModels.ConfigurationRes> getAndroidPaths(@Path("company_id")  String companyId , @Path("application_id")  String applicationId );
    ...
    Call<PlatformModels.SetConfigurationRes> updateAndroidPaths(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.ConfigurationRequest payload);
...
interface LogisticApiList {
    ...
    Call<PlatformModels.CompanyStoreView_Response> getCompanyStoreView(@Path("company_id")  String companyId , @Query("page_number") Integer  pageNumber ,  @Query("page_size") Integer  pageSize ,  @Query("zone_id") String  zoneId ,  @Query("enabled") String  enabled ,  @Query("q") String  q );
