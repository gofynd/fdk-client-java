...
interface BillingApiList {
    ...
    Call<PlatformModels.CreateOneTimeChargeResponse> createOneTimeCharge(@Path("company_id")  String companyId , @Path("extension_id") String  extensionId ,@Body PlatformModels.CreateOneTimeCharge payload);
    ...
    Call<PlatformModels.OneTimeChargeEntity> getChargeDetails(@Path("company_id")  String companyId , @Path("extension_id") String  extensionId , @Path("charge_id") String  chargeId );
...
interface PaymentApiList {
    ...
    Call<PlatformModels.PlatfromPaymentConfig> getPlatformPaymentConfig(@Path("company_id")  String companyId , @Path("application_id")  String applicationId );
    ...
    Call<PlatformModels.PlatfromPaymentConfig> updatePlatformPaymentConfig(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.UpdatePlatformPaymentConfig payload);
    ...
    @GET ("/service/platform/payment/v1.0/company/{company_id}/application/{application_id}/payment/edc-device")
    Call<PlatformModels.EdcDeviceDetailsResponse> edcDevice(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("terminal_serial_no") String  terminalSerialNo );
    ...
    Call<PlatformModels.EdcDeviceAddResponse> edcDevice(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.EdcAddRequest payload);
    ...
    @PATCH ("/service/platform/payment/v1.0/company/{company_id}/application/{application_id}/payment/edc-device")
    Call<PlatformModels.EdcDeviceUpdateResponse> edcDevice(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.EdcUpdateRequest payload);
    ...
    Call<PlatformModels.EdcDeviceListResponse> edcDeviceList(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("page_number") Integer  pageNumber ,  @Query("is_active") Boolean  isActive ,  @Query("store_id") Integer  storeId ,  @Query("device_tag") String  deviceTag ,  @Query("page_size") Integer  pageSize );
...
interface CatalogApiList {
    ...
    Call<PlatformModels.GetAllSizes> allSizes(@Path("company_id")  String companyId , @Path("item_id") Integer  itemId );
    ...
    Call<PlatformModels.ProductSizeDeleteResponse> deleteSize(@Path("company_id")  String companyId , @Path("item_id") Integer  itemId , @Path("size") String  size );
    ...
    Call<PlatformModels.SuccessResponse> addInventory(@Path("company_id")  String companyId , @Path("item_id") Integer  itemId , @Path("size") String  size ,@Body PlatformModels.InventoryRequest payload);
    ...
    Call<PlatformModels.SuccessResponse> updateRealtimeInventory(@Path("company_id")  String companyId , @Path("item_id") Integer  itemId , @Path("seller_identifier") String  sellerIdentifier ,@Body PlatformModels.InventoryRequestSchemaV2 payload);
    ...
    Call<PlatformModels.InventoryUpdateResponse> deleteRealtimeInventory(@Path("company_id")  String companyId , @Path("item_id") Integer  itemId , @Path("seller_identifier") String  sellerIdentifier ,@Body PlatformModels.InventoryRequestSchemaV2 payload);
...
interface CompanyProfileApiList {
    ...
    Call<PlatformModels.AssignStoreResponseSerializer> getOptimalLocations(@Path("company_id")  String companyId ,@Body PlatformModels.AssignStoreRequestValidator payload);
...
interface ConfigurationApiList {
    ...
    Call<PlatformModels.OptedStoreIntegration> getLevelActiveIntegrations(@Path("company_id")  String companyId , @Path("id") String  id , @Path("level") String  level , @Path("uid") Integer  uid , @Query("permission") String  permission );
...
interface CartApiList {
    ...
    Call<PlatformModels.CartDetailResponse> getAbandonedCartDetails(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("id") String  id ,  @Query("i") Boolean  i ,  @Query("b") Boolean  b );
    ...
    Call<PlatformModels.CartShipmentsResponse> getShipmentDelivery(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("i") Boolean  i ,  @Query("p") Boolean  p ,  @Query("id") String  id ,  @Query("address_id") String  addressId ,  @Query("order_type") String  orderType );
