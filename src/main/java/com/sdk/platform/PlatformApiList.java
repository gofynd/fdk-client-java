...
interface PaymentApiList {
    ...
    Call<PlatformModels.RefundAccountResponse> addBeneficiaryDetails(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.AddBeneficiaryDetailsRequest payload);
...
interface OrderApiList {
    ...
    Call<PlatformModels.ShipmentInfoResponse> getShipmentDetails(@Path("company_id")  String companyId , @Path("shipment_id") String  shipmentId , @Query("ordering_company_id") String  orderingCompanyId ,  @Query("request_by_ext") String  requestByExt );
    ...
    @GET ("/service/platform/orders/v1.0/company/{company_id}/application/{application_id}/lane-config/")
    Call<PlatformModels.LaneConfigResponse> getLaneConfigCrossSellingData(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("super_lane") String  superLane ,  @Query("group_entity") String  groupEntity ,  @Query("from_date") String  fromDate ,  @Query("to_date") String  toDate ,  @Query("dp_ids") String  dpIds ,  @Query("stores") String  stores ,  @Query("sales_channel") String  salesChannel ,  @Query("payment_mode") String  paymentMode ,  @Query("bag_status") String  bagStatus );
    ...
    Call<PlatformModels.CreateOrderResponse> createOrder(@Path("company_id")  String companyId ,@Body PlatformModels.CreateOrderPayload payload);
    ...
    Call<PlatformModels.StatusUpdateInternalResponse> statusUpdateInternalV4(@Path("company_id")  String companyId ,@Body PlatformModels.StatusUpdateInternalRequest payload);
...
interface CatalogApiList {
    ...
    Call<PlatformModels.BrandListingResponse> getApplicationCategoryListing(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("page_no") Integer  pageNo ,  @Query("page_size") Integer  pageSize ,  @Query("q") String  q );
...
interface DocumentEngineApiList {
    ...
    Call<PlatformModels.SuccessResponseGenerateBulk> generateBulkPackageLabel(@Path("company_id")  String companyId ,@Body PlatformModels.GenerateBulkPackageLabel payload);
    ...
    Call<PlatformModels.SuccessResponseGenerateBulk> generateBulkBoxLabel(@Path("company_id")  String companyId ,@Body PlatformModels.GenerateBulkBoxLabel payload);
    ...
    Call<PlatformModels.SuccessResponseGenerateBulk> generateBulkShipmentLabel(@Path("company_id")  String companyId ,@Body PlatformModels.GenerateBulkShipmentLabel payload);
    ...
    Call<PlatformModels.SuccessResponseGenerateBulk> generateNoc(@Path("company_id")  String companyId ,@Body PlatformModels.GenerateNoc payload);
    ...
    Call<PlatformModels.StatusSuccessResponse> getLabelStatus(@Path("company_id")  String companyId , @Query("uid") String  uid );
    ...
    Call<PlatformModels.StatusSuccessResponse> getNocStatus(@Path("company_id")  String companyId , @Query("uid") String  uid );
    ...
    Call<PlatformModels.SignedSuccessResponse> getPresignedURL(@Path("company_id")  String companyId ,@Body PlatformModels.InvoiceLabelPresignedRequestBody payload);
    ...
    Call<PlatformModels.SignedSuccessResponse> getLabelPresignedURL(@Path("company_id")  String companyId , @Query("uid") String  uid );
    ...
    Call<PlatformModels.SignedSuccessResponse> getNocPresignedURL(@Path("company_id")  String companyId , @Query("uid") String  uid );
    ...
    @GET ("/service/platform/document/v2.0/company/{company_id}/bulk-shipment-status")
    Call<PlatformModels.SuccessResponseBulkStatus> getBulkShipmentStatus(@Path("company_id")  String companyId , @Query("batch_id") String  batchId );
