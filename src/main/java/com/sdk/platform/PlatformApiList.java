...
interface OrderApiList {
    ...
    @GET ("/service/platform/order/v1.0/company/{company_id}/shipment-details-by-affiliate-bag-id")
    ...
    @GET ("/service/platform/order/v1.0/company/{company_id}/shipment-details-by-affiliate-shipment-id")
    ...
    @GET ("/service/platform/order/v1.0/company/{company_id}/shipment-details-by-affiliate-order-id")
