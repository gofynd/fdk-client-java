...
interface ConfigurationApiList {
    ...
    Call<PlatformModels.DomainsResponse> getDomains(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Path("comapny_id") String  comapnyId , @Path("appication_id") String  appicationId );
