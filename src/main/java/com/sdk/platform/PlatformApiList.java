...
interface CommonApiList {
    ...
    Call<PlatformModels.ApplicationResponse> searchApplication( @Query("query") String  query );
...
interface LeadApiList {
    ...
    Call<PlatformModels.TicketList> getTickets(@Path("company_id")  String companyId , @Query("items") Boolean  items ,  @Query("filters") Boolean  filters ,  @Query("q") String  q ,  @Query("status") String  status ,  @Query("priority") PlatformModels.PriorityEnum  priority ,  @Query("category") String  category ,  @Query("page_no") Integer  pageNo ,  @Query("page_size") Integer  pageSize );
    ...
    Call<PlatformModels.TicketList> getTickets(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("items") Boolean  items ,  @Query("filters") Boolean  filters ,  @Query("q") String  q ,  @Query("status") String  status ,  @Query("priority") PlatformModels.PriorityEnum  priority ,  @Query("category") String  category );
    ...
    Call<PlatformModels.CloseVideoRoomResponse> getGeneralConfig(@Path("company_id")  String companyId );
...
interface UserApiList {
    ...
    Call<PlatformModels.CustomerListResponseSchema> getCustomers(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("q") Object  q ,  @Query("page_size") Integer  pageSize ,  @Query("page_no") Integer  pageNo );
    ...
    Call<PlatformModels.UserSearchResponseSchema> searchUsers(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("q") String  q );
    ...
    Call<PlatformModels.BlockUserSuccess> blockOrUnblockUsers(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.BlockUserRequestSchema payload);
    ...
    Call<PlatformModels.ArchiveUserSuccess> archiveUser(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.ArchiveUserRequestSchema payload);
    ...
    Call<PlatformModels.UnDeleteUserSuccess> unDeleteUser(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.UnDeleteUserRequestSchema payload);
    ...
    Call<PlatformModels.SessionListResponseSchema> getActiveSessions(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("id") String  id );
...
interface ContentApiList {
    ...
    Call<PlatformModels.DataLoadersSchema> getDataLoaders(@Path("company_id")  String companyId , @Path("application_id")  String applicationId );
    ...
    Call<PlatformModels.DataLoaderResetResponseSchema> resetDataLoader(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Path("service") String  service , @Path("operation_id") String  operationId );
    ...
    Call<PlatformModels.PathMappingSchema> addPathRedirectionRules(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.PathMappingSchema payload);
    ...
    Call<PlatformModels.PathMappingSchema> getPathRedirectionRules(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("page_size") Integer  pageSize ,  @Query("page_no") Integer  pageNo );
    ...
    Call<PlatformModels.PathMappingSchema> getPathRedirectionRule(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Path("path_id") String  pathId );
    ...
    Call<PlatformModels.PathMappingSchema> updatePathRedirectionRules(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Path("path_id") String  pathId ,@Body PlatformModels.PathMappingSchema payload);
...
interface BillingApiList {
    ...
    Call<PlatformModels.CheckValidityResponse> checkCouponValidity(@Path("company_id")  String companyId , @Query("plan") String  plan ,  @Query("coupon_code") String  couponCode );
...
interface CommunicationApiList {
    ...
    Call<PlatformModels.EngineResponse> sendCommunicationSynchronously(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.EngineRequest payload);
    ...
    Call<PlatformModels.EngineResponse> sendCommunicationAsynchronously(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.EngineRequest payload);
...
interface PaymentApiList {
    ...
    Call<PlatformModels.PaymentGatewayConfigResponse> getBrandPaymentGatewayConfig(@Path("company_id")  String companyId , @Path("application_id")  String applicationId );
    ...
    Call<PlatformModels.PaymentGatewayToBeReviewed> saveBrandPaymentGatewayConfig(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.PaymentGatewayConfigRequest payload);
    ...
    Call<PlatformModels.PaymentGatewayToBeReviewed> updateBrandPaymentGatewayConfig(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.PaymentGatewayConfigRequest payload);
    ...
    Call<PlatformModels.PaymentOptionsResponse> getPaymentModeRoutes(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("refresh") Boolean  refresh ,  @Query("request_type") String  requestType );
    ...
    Call<PlatformModels.PayoutsResponse> getAllPayouts(@Path("company_id")  String companyId , @Query("unique_external_id") String  uniqueExternalId );
    ...
    Call<PlatformModels.PayoutResponse> savePayout(@Path("company_id")  String companyId ,@Body PlatformModels.PayoutRequest payload);
    ...
    Call<PlatformModels.UpdatePayoutResponse> updatePayout(@Path("company_id")  String companyId , @Path("unique_transfer_no") String  uniqueTransferNo ,@Body PlatformModels.PayoutRequest payload);
    ...
    Call<PlatformModels.UpdatePayoutResponse> activateAndDectivatePayout(@Path("company_id")  String companyId , @Path("unique_transfer_no") String  uniqueTransferNo ,@Body PlatformModels.UpdatePayoutRequest payload);
    ...
    Call<PlatformModels.DeletePayoutResponse> deletePayout(@Path("company_id")  String companyId , @Path("unique_transfer_no") String  uniqueTransferNo );
    ...
    Call<PlatformModels.SubscriptionPaymentMethodResponse> getSubscriptionPaymentMethod(@Path("company_id")  String companyId , @Query("unique_external_id") String  uniqueExternalId );
    ...
    Call<PlatformModels.DeleteSubscriptionPaymentMethodResponse> deleteSubscriptionPaymentMethod(@Path("company_id")  String companyId , @Query("unique_external_id") String  uniqueExternalId ,  @Query("payment_method_id") String  paymentMethodId );
    ...
    Call<PlatformModels.SubscriptionConfigResponse> getSubscriptionConfig(@Path("company_id")  String companyId );
    ...
    Call<PlatformModels.SaveSubscriptionSetupIntentResponse> saveSubscriptionSetupIntent(@Path("company_id")  String companyId ,@Body PlatformModels.SaveSubscriptionSetupIntentRequest payload);
    ...
    Call<PlatformModels.RefundAccountResponse> getBankAccountDetailsOpenAPI(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("order_id") String  orderId ,  @Query("request_hash") String  requestHash );
    ...
    Call<PlatformModels.RefundAccountResponse> addRefundBankAccountUsingOTP(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.AddBeneficiaryDetailsOTPRequest payload);
    ...
    Call<PlatformModels.IfscCodeResponse> verifyIfscCode(@Path("company_id")  String companyId , @Query("ifsc_code") String  ifscCode );
    ...
    Call<PlatformModels.OrderBeneficiaryResponse> getUserOrderBeneficiaries(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("order_id") String  orderId );
    ...
    Call<PlatformModels.OrderBeneficiaryResponse> getUserBeneficiaries(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("order_id") String  orderId );
    ...
    Call<PlatformModels.PaymentConfirmationResponse> confirmPayment(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.PaymentConfirmationRequest payload);
    ...
    Call<PlatformModels.EdcDeviceStatsResponse> edcDeviceStats(@Path("company_id")  String companyId , @Path("application_id")  String applicationId );
    ...
    Call<PlatformModels.EdcDeviceAddResponse> updateEdcDevice(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Path("terminal_unique_identifier") String  terminalUniqueIdentifier ,@Body PlatformModels.EdcAddRequest payload);
    ...
    Call<PlatformModels.EdcDeviceDetailsResponse> getEdcDevice(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Path("terminal_unique_identifier") String  terminalUniqueIdentifier );
    ...
    Call<PlatformModels.EdcDeviceUpdateResponse> addEdcDevice(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Path("terminal_unique_identifier") String  terminalUniqueIdentifier ,@Body PlatformModels.EdcUpdateRequest payload);
    ...
    Call<PlatformModels.EdcDeviceListResponse> edcDeviceList(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("page_no") Integer  pageNo ,  @Query("page_size") Integer  pageSize ,  @Query("is_active") Boolean  isActive ,  @Query("store_id") Integer  storeId ,  @Query("device_tag") String  deviceTag );
    ...
    Call<PlatformModels.PaymentInitializationResponse> initialisePayment(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.PaymentInitializationRequest payload);
    ...
    Call<PlatformModels.PaymentStatusUpdateResponse> checkAndUpdatePaymentStatus(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.PaymentStatusUpdateRequest payload);
    ...
    Call<PlatformModels.ResendOrCancelPaymentResponse> resendOrCancelPayment(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.ResendOrCancelPaymentRequest payload);
...
interface OrderApiList {
    ...
    Call<PlatformModels.GeneratePosOrderReceiptResponse> generatePOSReceiptByOrderId(@Path("company_id")  String companyId , @Path("order_id") String  orderId , @Query("document_type") String  documentType );
...
interface CatalogApiList {
    ...
    Call<PlatformModels.GetProductBundleListingResponse> getProductBundle(@Path("company_id")  String companyId , @Query("q") String  q ,  @Query("slug") List<String>  slug );
    ...
    Call<PlatformModels.GetConfigResponse> getGroupConfigurations(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Path("config_type") String  configType , @Query("page_no") Integer  pageNo ,  @Query("page_size") Integer  pageSize ,  @Query("search") String  search ,  @Query("template_slug") String  templateSlug );
    ...
    Call<PlatformModels.ConfigSuccessResponse> deleteGroupConfiguration(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Path("config_type") String  configType , @Path("group_slug") String  groupSlug );
    ...
    Call<PlatformModels.GetConfigResponse> getListingConfigurations(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Path("config_type") String  configType , @Query("page_no") Integer  pageNo ,  @Query("page_size") Integer  pageSize ,  @Query("search") String  search );
    ...
    Call<PlatformModels.ConfigSuccessResponse> updateAllowSingle(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.AllowSingleRequest payload);
    ...
    Call<PlatformModels.ConfigSuccessResponse> updateDefaultSort(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.DefaultKeyRequest payload);
    ...
    Call<PlatformModels.UpdatedResponse> createMarketplaceOptin(@Path("company_id")  String companyId , @Path("marketplace") String  marketplace ,@Body PlatformModels.OptInPostRequest payload);
    ...
    Call<PlatformModels.GetOptInPlatform> getMarketplaceOptinDetail(@Path("company_id")  String companyId );
    ...
    Call<PlatformModels.OptinCompanyDetail> getCompanyDetail(@Path("company_id")  String companyId );
    ...
    Call<PlatformModels.OptinCompanyBrandDetailsView> getCompanyBrandDetail(@Path("company_id")  String companyId , @Query("is_active") Boolean  isActive ,  @Query("q") Boolean  q ,  @Query("page_no") Integer  pageNo ,  @Query("page_size") Integer  pageSize ,  @Query("marketplace") String  marketplace );
    ...
    Call<PlatformModels.OptinCompanyMetrics> getCompanyMetrics(@Path("company_id")  String companyId );
    ...
    Call<PlatformModels.OptinStoreDetails> getStoreDetail(@Path("company_id")  String companyId , @Query("q") String  q ,  @Query("page_no") Integer  pageNo ,  @Query("page_size") Integer  pageSize );
    ...
    Call<PlatformModels.GenderDetail> getGenderAttribute(@Path("company_id")  String companyId , @Path("attribute_slug") String  attributeSlug );
    ...
    Call<PlatformModels.SuccessResponse> createProduct(@Path("company_id")  String companyId ,@Body PlatformModels.ProductCreateUpdateSchemaV2 payload);
    ...
    Call<PlatformModels.SuccessResponse> editProduct(@Path("company_id")  String companyId , @Path("item_id") Integer  itemId ,@Body PlatformModels.ProductCreateUpdateSchemaV2 payload);
    ...
    Call<PlatformModels.SingleProductResponse> getProduct(@Path("company_id")  String companyId , @Path("item_id") Integer  itemId , @Query("brand_uid") Integer  brandUid ,  @Query("item_code") String  itemCode );
    ...
    Call<PlatformModels.ListALLSizes> allSizes(@Path("company_id")  String companyId , @Path("item_id") Integer  itemId );
    ...
    Call<PlatformModels.ProductListingResponse> getProductSize(@Path("company_id")  String companyId , @Path("item_id") Integer  itemId , @Query("item_code") String  itemCode ,  @Query("brand_uid") Integer  brandUid ,  @Query("uid") Integer  uid );
    ...
    Call<PlatformModels.ProductTagsViewResponse> getProductTags(@Path("company_id")  String companyId );
    ...
    Call<PlatformModels.InventorySellerIdentifierResponsePaginated> getInventoryBySizeIdentifier(@Path("company_id")  String companyId , @Path("item_id") String  itemId , @Path("size_identifier") String  sizeIdentifier , @Query("page_no") Integer  pageNo ,  @Query("page_size") Integer  pageSize ,  @Query("q") String  q ,  @Query("location_ids") List<Integer>  locationIds );
    ...
    Call<PlatformModels.SuccessResponse> deleteInventory(@Path("company_id")  String companyId , @Path("size") String  size , @Path("item_id") Integer  itemId , @Path("location_id") Double  locationId );
    ...
    Call<PlatformModels.InventoryUpdateResponse> updateInventories(@Path("company_id")  String companyId ,@Body PlatformModels.InventoryRequestSchemaV2 payload);
    ...
    Call<PlatformModels.HsnCodesListingResponseSchemaV2> getAllProductHsnCodes(@Path("company_id")  String companyId , @Query("page_no") Integer  pageNo ,  @Query("page_size") Integer  pageSize ,  @Query("q") String  q ,  @Query("type") String  type );
    ...
    Call<PlatformModels.HSNDataInsertV2> getSingleProductHSNCode(@Path("reporting_hsn") String  reportingHsn , @Path("company_id")  String companyId );
    ...
    Call<PlatformModels.BrandListingResponse> getApplicationBrands(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("department") String  department ,  @Query("page_no") Integer  pageNo ,  @Query("page_size") Integer  pageSize ,  @Query("q") String  q ,  @Query("brand_id") List<Integer>  brandId );
    ...
    Call<PlatformModels.LocationListSerializer> getAppLocations(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("store_type") String  storeType ,  @Query("uid") List<Integer>  uid ,  @Query("q") String  q ,  @Query("stage") String  stage ,  @Query("page_no") Integer  pageNo ,  @Query("page_size") Integer  pageSize );
    ...
    Call<PlatformModels.BrandListingResponse> getApplicationBrandListing(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("page_no") Integer  pageNo ,  @Query("page_size") Integer  pageSize ,  @Query("q") String  q );
    ...
    Call<PlatformModels.SuccessResponse1> updateAppBrand(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Path("brand_uid") String  brandUid ,@Body PlatformModels.ApplicationBrandJson payload);
    ...
    Call<PlatformModels.BrandListingResponse> getApplicationCategoryListing(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("department_id") Integer  departmentId ,  @Query("page_no") Integer  pageNo ,  @Query("page_size") Integer  pageSize ,  @Query("q") String  q );
    ...
    Call<PlatformModels.SuccessResponse1> updateAppCategory(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Path("category_uid") String  categoryUid ,@Body PlatformModels.ApplicationCategoryJson payload);
    ...
    Call<PlatformModels.ApplicationDepartmentListingResponse> getApplicationDepartmentListing(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("page_no") Integer  pageNo ,  @Query("page_size") Integer  pageSize ,  @Query("q") String  q );
    ...
    Call<PlatformModels.SuccessResponse1> updateAppDepartment(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Path("department_uid") String  departmentUid ,@Body PlatformModels.ApplicationDepartmentJson payload);
    ...
    Call<PlatformModels.SuccessResponse1> updateAppLocation(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Path("store_uid") String  storeUid ,@Body PlatformModels.ApplicationStoreJson payload);
...
interface CompanyProfileApiList {
    ...
    Call<PlatformModels.ProfileSuccessResponse> updateCompany(@Path("company_id")  String companyId ,@Body PlatformModels.UpdateCompany payload);
    ...
    Call<PlatformModels.ProfileSuccessResponse> editBrand(@Path("company_id")  String companyId , @Path("brand_id") String  brandId ,@Body PlatformModels.CreateUpdateBrandRequestSerializer payload);
    ...
    Call<PlatformModels.ProfileSuccessResponse> createBrand(@Path("company_id")  String companyId ,@Body PlatformModels.CreateUpdateBrandRequestSerializer payload);
    ...
    Call<PlatformModels.ProfileSuccessResponse> createCompanyBrandMapping(@Path("company_id")  String companyId ,@Body PlatformModels.CompanyBrandPostRequestSerializer payload);
    ...
    Call<PlatformModels.LocationListSerializer> getLocations(@Path("company_id")  String companyId , @Query("store_type") String  storeType ,  @Query("q") String  q ,  @Query("stage") String  stage ,  @Query("page_no") Integer  pageNo ,  @Query("page_size") Integer  pageSize ,  @Query("location_ids") List<Integer>  locationIds );
    ...
    Call<PlatformModels.ProfileSuccessResponse> createLocation(@Path("company_id")  String companyId ,@Body PlatformModels.LocationSerializer payload);
    ...
    Call<PlatformModels.ProfileSuccessResponse> updateLocation(@Path("company_id")  String companyId , @Path("location_id") String  locationId ,@Body PlatformModels.LocationSerializer payload);
    ...
    Call<PlatformModels.ProfileSuccessResponse> createLocationBulk(@Path("company_id")  String companyId ,@Body PlatformModels.BulkLocationSerializer payload);
...
interface FileStorageApiList {
    ...
    Call<PlatformModels.StartResponse> startUpload(@Path("namespace") String  namespace , @Path("company_id")  String companyId ,@Body PlatformModels.StartRequest payload);
    ...
    Call<PlatformModels.CompleteResponse> completeUpload(@Path("namespace") String  namespace , @Path("company_id")  String companyId ,@Body PlatformModels.StartResponse payload);
    ...
    Call<PlatformModels.StartResponse> appStartUpload(@Path("namespace") String  namespace , @Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.StartRequest payload);
    ...
    Call<PlatformModels.CompleteResponse> appCompleteUpload(@Path("namespace") String  namespace , @Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.StartResponse payload);
    ...
    Call<PlatformModels.SignUrlResponse> getSignUrls(@Path("company_id")  String companyId ,@Body PlatformModels.SignUrlRequest payload);
    ...
    Call<PlatformModels.BulkUploadResponse> copyFiles(@Path("company_id")  String companyId , @Query("sync") Boolean  sync ,@Body PlatformModels.BulkRequest payload);
    ...
    Call<PlatformModels.BulkUploadResponse> appCopyFiles(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("sync") Boolean  sync ,@Body PlatformModels.BulkRequest payload);
    ...
    Call<PlatformModels.BrowseResponse> browse(@Path("namespace") String  namespace , @Path("company_id")  String companyId , @Query("page_no") Integer  pageNo );
    ...
    Call<PlatformModels.BrowseResponse> browse(@Path("namespace") String  namespace , @Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("page_no") Integer  pageNo );
...
interface InventoryApiList {
    ...
    Call<PlatformModels.ResponseEnvelopeListSlingshotConfigurationDetail> getConfigByCompany(@Path("company_id")  String companyId );
    ...
    Call<PlatformModels.ResponseEnvelopeKafkaResponse> suppressStores(@Path("company_id")  String companyId ,@Body PlatformModels.SuppressStorePayload payload);
    ...
    Call<PlatformModels.ResponseEnvelopeListJobConfigRawDTO> getJobsByCompany(@Path("company_id")  String companyId , @Query("page_no") Integer  pageNo ,  @Query("page_size") Integer  pageSize );
    ...
    Call<PlatformModels.ResponseEnvelopeString> updateJob(@Path("company_id")  String companyId ,@Body PlatformModels.JobConfigDTO payload);
    ...
    Call<PlatformModels.ResponseEnvelopeString> createJob(@Path("company_id")  String companyId ,@Body PlatformModels.JobConfigDTO payload);
    ...
    Call<PlatformModels.ResponseEnvelopeListJobStepsDTO> getJobSteps(@Path("company_id")  String companyId , @Path("job_id") Integer  jobId );
    ...
    Call<PlatformModels.ResponseEnvelopeListJobConfigDTO> getJobByCompanyAndIntegration(@Path("company_id")  String companyId , @Path("integration_id") String  integrationId , @Query("page_no") Integer  pageNo ,  @Query("page_size") Integer  pageSize );
    ...
    Call<PlatformModels.ResponseEnvelopeString> disable(@Path("company_id")  String companyId , @Path("integration_id") String  integrationId );
    ...
    Call<PlatformModels.ResponseEnvelopeJobConfigDTO> getJobConfigDefaults(@Path("company_id")  String companyId );
    ...
    Call<PlatformModels.ResponseEnvelopeJobConfigDTO> getJobByCode(@Path("company_id")  String companyId , @Path("code") String  code );
    ...
    Call<PlatformModels.ResponseEnvelopeJobMetricsDto> getJobCodeMetrics(@Path("company_id")  String companyId , @Path("code") String  code , @Query("page_no") Integer  pageNo ,  @Query("page_size") Integer  pageSize ,  @Query("status") String  status ,  @Query("date") String  date );
...
interface ConfigurationApiList {
    ...
    Call<PlatformModels.CompaniesResponse> getAppCompanies(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("uid") Integer  uid ,  @Query("page_no") Integer  pageNo ,  @Query("page_size") Integer  pageSize );
...
interface CartApiList {
    ...
    Call<PlatformModels.PromotionAdd> createPromotion(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.PromotionAdd payload);
    ...
    Call<PlatformModels.PromotionUpdate> getPromotionById(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Path("id") String  id );
    ...
    Call<PlatformModels.PromotionUpdate> updatePromotion(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Path("id") String  id ,@Body PlatformModels.PromotionUpdate payload);
    ...
    Call<PlatformModels.SuccessMessage> updatePromotionPartially(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Path("id") String  id ,@Body PlatformModels.PromotionPartialUpdate payload);
    ...
    Call<PlatformModels.ActivePromosResponse> getPromosCouponConfig(@Path("company_id")  String companyId , @Path("application_id")  String applicationId );
    ...
    Call<PlatformModels.AddCartDetailResponse> addItems(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Path("cart_id") String  cartId , @Query("b") Boolean  b ,@Body PlatformModels.AddCartRequest payload);
    ...
    Call<PlatformModels.MultiCartResponse> getCartList(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("from_date") String  fromDate ,  @Query("to_date") String  toDate ,  @Query("filter_on") String  filterOn );
    ...
    Call<PlatformModels.AddCartDetailResponse> platformAddItems(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("i") Boolean  i ,  @Query("b") Boolean  b ,  @Query("buy_now") Boolean  buyNow ,  @Query("id") String  id ,@Body PlatformModels.AddCartRequest payload);
    ...
    Call<PlatformModels.UpdateCartDetailResponse> platformUpdateCart(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("id") String  id ,  @Query("i") Boolean  i ,  @Query("b") Boolean  b ,  @Query("buy_now") Boolean  buyNow ,@Body PlatformModels.UpdateCartRequest payload);
    ...
    Call<PlatformModels.DeleteCartDetailResponse> deleteCart(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("id") String  id ,@Body PlatformModels.DeleteCartRequest payload);
    ...
    Call<PlatformModels.GetCouponResponse> getAppCoupons(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("id") String  id ,  @Query("buy_now") Boolean  buyNow );
    ...
    Call<PlatformModels.CartDetailResponse> removeCoupon(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("uid") String  uid ,  @Query("buy_now") Boolean  buyNow );
    ...
    Call<PlatformModels.CartShipmentsResponse> updateShipments(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("i") Boolean  i ,  @Query("p") Boolean  p ,  @Query("id") String  id ,  @Query("address_id") String  addressId ,  @Query("order_type") String  orderType ,@Body PlatformModels.UpdateCartShipmentRequest payload);
    ...
    Call<PlatformModels.CartCheckoutResponse> platformCheckoutCart(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Query("id") String  id ,@Body PlatformModels.PlatformCartCheckoutDetailRequest payload);
...
interface AnalyticsApiList {
    ...
    Call<PlatformModels.SearchLogRes> searchLogs(@Path("company_id")  String companyId , @Path("log_type") String  logType , @Query("page_no") Integer  pageNo ,  @Query("page_size") Integer  pageSize ,@Body PlatformModels.SearchLogReq payload);
...
interface DiscountApiList {
    ...
    Call<PlatformModels.DiscountJob> createDiscount(@Path("company_id")  String companyId ,@Body PlatformModels.CreateUpdateDiscount payload);
    ...
    Call<PlatformModels.DiscountJob> getDiscount(@Path("company_id")  String companyId , @Path("id") String  id );
    ...
    Call<PlatformModels.DiscountJob> updateDiscount(@Path("company_id")  String companyId , @Path("id") String  id ,@Body PlatformModels.CreateUpdateDiscount payload);
    ...
    Call<Object> upsertDiscountItems(@Path("company_id")  String companyId , @Path("id") String  id ,@Body PlatformModels.BulkDiscount payload);
    ...
    Call<PlatformModels.FileJobResponse> validateDiscountFile(@Path("company_id")  String companyId , @Query("discount") String  discount ,@Body PlatformModels.DiscountJob payload);
    ...
    Call<PlatformModels.FileJobResponse> downloadDiscountFile(@Path("company_id")  String companyId , @Path("type") String  type ,@Body PlatformModels.DownloadFileJob payload);
    ...
    Call<PlatformModels.FileJobResponse> getValidationJob(@Path("company_id")  String companyId , @Path("id") String  id );
    ...
    Call<PlatformModels.CancelJobResponse> cancelValidationJob(@Path("company_id")  String companyId , @Path("id") String  id );
    ...
    Call<PlatformModels.FileJobResponse> getDownloadJob(@Path("company_id")  String companyId , @Path("id") String  id );
    ...
    Call<PlatformModels.CancelJobResponse> cancelDownloadJob(@Path("company_id")  String companyId , @Path("id") String  id );
...
interface WebhookApiList {
    ...
    Call<PlatformModels.SubscriberResponse> getSubscribersByCompany(@Path("company_id")  String companyId , @Query("page_no") Integer  pageNo ,  @Query("page_size") Integer  pageSize ,  @Query("extension_id") String  extensionId );
    ...
    Call<PlatformModels.SubscriberConfig> registerSubscriberToEvent(@Path("company_id")  String companyId ,@Body PlatformModels.SubscriberConfig payload);
    ...
    Call<PlatformModels.SubscriberConfig> updateSubscriberConfig(@Path("company_id")  String companyId ,@Body PlatformModels.SubscriberConfig payload);
    ...
    Call<PlatformModels.SubscriberConfigList> getSubscribersByExtensionId(@Path("company_id")  String companyId , @Path("extension_id") String  extensionId , @Query("page_no") Integer  pageNo ,  @Query("page_size") Integer  pageSize );
    ...
    Call<PlatformModels.SubscriberResponse> getSubscriberById(@Path("company_id")  String companyId , @Path("subscriber_id") Integer  subscriberId );
...
interface ServiceabilityApiList {
    ...
    Call<PlatformModels.CompanyStoreView_Response> getCompanyStoreView(@Path("company_id")  String companyId , @Query("page_number") Integer  pageNumber ,  @Query("page_size") Integer  pageSize );
    ...
    Call<PlatformModels.ZoneResponse> insertZoneControllerView(@Path("company_id")  String companyId ,@Body PlatformModels.ZoneRequest payload);
    ...
    Call<PlatformModels.GetZoneFromPincodeViewResponse> upsertZoneControllerView(@Path("company_id")  String companyId , @Path("application_id")  String applicationId ,@Body PlatformModels.GetZoneFromPincodeViewRequest payload);
    ...
    Call<PlatformModels.GetStoresViewResponse> getStore(@Path("company_id")  String companyId , @Path("store_uid") Integer  storeUid );
    ...
    Call<PlatformModels.GetStoresViewResponse> getAllStores(@Path("company_id")  String companyId );
