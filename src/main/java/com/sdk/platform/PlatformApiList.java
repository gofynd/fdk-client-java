...
interface OrderManageApiList {
    ...
    Call<PlatformModels.ManualStoreReassignResponse> manualStoreReassignment(@Path("company_id")  String companyId ,@Body PlatformModels.ManualStoreReassign payload);
