...
interface BillingApiList {
    ...
    @POST ("/service/platform/billing/v1.0/company/{company_id}/extension/{extension_id}/one_time")
    Call<PlatformModels.CreateSubscriptionResponse> createOneTimeSubscriptionCharge(@Path("company_id")  String companyId , @Path("extension_id") String  extensionId ,@Body PlatformModels.CreateOneTimeSubscriptionCharge payload);
