...
interface CatalogApiList {
    ...
    Call<PlatformModels.BulkResponse> createBulkProductUploadJob(@Path("company_id")  String companyId , @Query("department") String  department ,  @Query("product_type") String  productType ,@Body PlatformModels.BulkJob payload);
