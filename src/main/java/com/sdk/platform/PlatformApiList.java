...
interface PaymentApiList {
    ...
    Call<PlatformModels.EdcDeviceAddResponse> edcDevice(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Path("terminal_unique_identifier") String  terminalUniqueIdentifier ,@Body PlatformModels.EdcAddRequest payload);
    ...
    Call<PlatformModels.EdcDeviceDetailsResponse> edcDevice(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Path("terminal_unique_identifier") String  terminalUniqueIdentifier );
    ...
    Call<PlatformModels.EdcDeviceUpdateResponse> edcDevice(@Path("company_id")  String companyId , @Path("application_id")  String applicationId , @Path("terminal_unique_identifier") String  terminalUniqueIdentifier ,@Body PlatformModels.EdcUpdateRequest payload);
