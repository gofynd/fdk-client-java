...
public class DiscountPlatformService {
    ...
    public DiscountPlatformModels.ListOrCalender getDiscounts(String view , String q , Integer pageNo , Integer pageSize , Boolean archived , Integer month , Integer year , String type , List<String> appIds ) throws FDKException {
    ...
    public DiscountPlatformModels.DiscountJob createDiscount(DiscountPlatformModels.CreateUpdateDiscount body) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
    ...
    public DiscountPlatformModels.DiscountJob getDiscount(String id ) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<DiscountPlatformModels.DiscountJob> response = null;
            try {
    ...
    public DiscountPlatformModels.DiscountJob updateDiscount(String id ,DiscountPlatformModels.CreateUpdateDiscount body) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<DiscountPlatformModels.DiscountJob> response = null;
            try {
    ...
    public Object upsertDiscountItems(String id ,DiscountPlatformModels.BulkDiscount body) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
    ...
    public DiscountPlatformModels.FileJobResponse validateDiscountFile(String discount ,DiscountPlatformModels.FileJobRequest body) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
    ...
    public DiscountPlatformModels.FileJobResponse downloadDiscountFile(String type ,DiscountPlatformModels.DownloadFileJob body) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<DiscountPlatformModels.FileJobResponse> response = null;
            try {
    ...
    public DiscountPlatformModels.FileJobResponse getValidationJob(String id ) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<DiscountPlatformModels.FileJobResponse> response = null;
            try {
    ...
    public DiscountPlatformModels.CancelJobResponse cancelValidationJob(String id ) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
    ...
    public DiscountPlatformModels.FileJobResponse getDownloadJob(String id ) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<DiscountPlatformModels.FileJobResponse> response = null;
            try {
    ...
    public DiscountPlatformModels.CancelJobResponse cancelDownloadJob(String id ) throws FDKException {
        if (this.platformConfig.getPlatformOauthClient().isAccessTokenValid()) {
            Response<DiscountPlatformModels.CancelJobResponse> response = null;
            try {
