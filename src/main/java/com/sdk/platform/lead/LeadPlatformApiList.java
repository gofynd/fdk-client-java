...
interface LeadPlatformApiList {
    ...
    Call<LeadPlatformModels.Ticket> getNewTicket(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("id") String id, @HeaderMap Map<String, String> requestHeaders);

    @PUT ("/service/platform/lead/v1.0/company/{company_id}/application/{application_id}/ticket/{id}")
    Call<LeadPlatformModels.Ticket> editNewTicket(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("id") String id, @Body LeadPlatformModels.EditTicketPayload payload, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<LeadPlatformModels.TicketHistoryList> getNewTicketHistory(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("id") String id, @HeaderMap Map<String, String> requestHeaders);
