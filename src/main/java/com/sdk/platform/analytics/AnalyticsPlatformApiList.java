...
interface AnalyticsPlatformApiList {
    ...
    Call<HashMap<String,Object>> executeJobForProvidedParametersV2(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Body AnalyticsPlatformModels.JobExecute payload, @HeaderMap Map<String, String> requestHeaders);
    ...
    Call<HashMap<String,Object>> checkJobStatusByNameV2(@Path("company_id") String companyId, @Path("application_id") String applicationId, @Path("file_name") String fileName, @HeaderMap Map<String, String> requestHeaders);
}