...
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonInclude(JsonInclude.Include.NON_NULL)
public static class CollectionItemSEO{
...
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonInclude(JsonInclude.Include.NON_NULL)
public static class ProductSellersPriceResponseV3{
...
public static class ProductSizeSellersResponseV4{
    ...
    @JsonProperty("items")
    private List<ProductSellersPriceResponseV3> items;
...
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonInclude(JsonInclude.Include.NON_NULL)
public static class ProductBundleItems{
...
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonInclude(JsonInclude.Include.NON_NULL)
public static class ProductBundleItemsWithSlug{
...
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonInclude(JsonInclude.Include.NON_NULL)
public static class CurrenciesSchema{
...
public static class CountryCurrencyMapping{
    ...
    private List<CurrenciesSchema> currencies;
...
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonInclude(JsonInclude.Include.NON_NULL)
public static class AvailableCountrySchema{
    ...
    @JsonProperty("items")
    private List<CountryCurrencyMapping> items;
