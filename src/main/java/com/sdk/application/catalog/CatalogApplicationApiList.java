...
interface CatalogApplicationApiList {
    ...
    @GET 
    Call<CatalogApplicationModels.ProductSizePriceResponseV3> getProductPriceBySlug(@Url String url1, @Query("store_id") Integer storeId, @Query("pincode") String pincode, @Query("moq") Integer moq, @HeaderMap Map<String, String> requestHeaders);

    @GET 
    Call<CatalogApplicationModels.ProductSizeSellersResponseV3> getProductSellersBySlug(@Url String url1, @Query("pincode") String pincode, @Query("strategy") String strategy, @Query("page_no") Integer pageNo, @Query("page_size") Integer pageSize, @HeaderMap Map<String, String> requestHeaders);
}