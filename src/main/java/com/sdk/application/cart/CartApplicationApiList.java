...
interface CartApplicationApiList {
    ...
    @POST 
    Call<CartApplicationModels.CartDetailResult> applyCoupon(@Url String url1, @Header("x-ordering-source") String xOrderingSource, @Header("x-ordering-source-type") String xOrderingSourceType, @Query("i") Boolean i, @Query("b") Boolean b, @Query("p") Boolean p, @Query("id") String id, @Query("buy_now") Boolean buyNow, @Query("cart_type") String cartType, @Body CartApplicationModels.ApplyCoupon payload, @HeaderMap Map<String, String> requestHeaders);

    @DELETE 
    Call<CartApplicationModels.CartDetailResult> removeCoupon(@Url String url1, @Header("x-ordering-source") String xOrderingSource, @Header("x-ordering-source-type") String xOrderingSourceType, @Query("id") String id, @Query("buy_now") Boolean buyNow, @HeaderMap Map<String, String> requestHeaders);
    ...
    @POST 
    Call<CartApplicationModels.CartCheckoutResult> checkoutCart(@Url String url1, @Header("x-ordering-source") String xOrderingSource, @Header("x-ordering-source-type") String xOrderingSourceType, @Query("buy_now") Boolean buyNow, @Query("cart_type") String cartType, @Body CartApplicationModels.CartCheckoutDetailCreation payload, @HeaderMap Map<String, String> requestHeaders);
    ...
    @POST 
    Call<CartApplicationModels.CartCheckoutResult> checkoutCartV2(@Url String url1, @Header("x-ordering-source") String xOrderingSource, @Header("x-ordering-source-type") String xOrderingSourceType, @Header("x-location-detail") String xLocationDetail, @Header("x-currency-code") String xCurrencyCode, @Query("buy_now") Boolean buyNow, @Query("cart_type") String cartType, @Body CartApplicationModels.CartCheckoutDetailV2Creation payload, @HeaderMap Map<String, String> requestHeaders);
