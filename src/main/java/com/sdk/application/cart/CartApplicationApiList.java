...
interface CartApplicationApiList {
    ...
    @GET 
    Call<CartApplicationModels.PromotionOffersResponse> getPromotionOffers(@Url String url1, @Query("slug") String slug, @Query("page_size") Integer pageSize, @Query("promotion_group") String promotionGroup, @Query("store_id") Integer storeId, @Query("cart_type") String cartType, @HeaderMap Map<String, String> requestHeaders);
    ...
    @GET 
    Call<CartApplicationModels.PromotionPaymentOffersResponse> getPromotionPaymentOffers(@Url String url1, @Query("id") String id, @Query("uid") Integer uid, @HeaderMap Map<String, String> requestHeaders);
