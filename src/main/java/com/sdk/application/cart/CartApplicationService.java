...
@Getter
 public class CartApplicationService { 
    ...
    public CartApplicationModels.CartDetailResponse getCart(String id , Boolean i , Boolean b , Integer assignCardId , String areaCode ) throws IOException {
     
      String fullUrl = relativeUrls.get("getCart");
        

        Response<CartApplicationModels.CartDetailResponse> response = cartApplicationApiList.getCart(fullUrl  ,id, i, b, assignCardId, areaCode).execute();
    ...
    public CartApplicationModels.AddCartDetailResponse addItems(Boolean i , Boolean b , String areaCode ,CartApplicationModels.AddCartRequest body) throws IOException {
     
      String fullUrl = relativeUrls.get("addItems");
        

        Response<CartApplicationModels.AddCartDetailResponse> response = cartApplicationApiList.addItems(fullUrl  ,i, b, areaCode, body).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public CartApplicationModels.UpdateCartDetailResponse updateCart(String id , Boolean i , Boolean b , String areaCode ,CartApplicationModels.UpdateCartRequest body) throws IOException {
     
      String fullUrl = relativeUrls.get("updateCart");
        

        Response<CartApplicationModels.UpdateCartDetailResponse> response = cartApplicationApiList.updateCart(fullUrl  ,id, i, b, areaCode, body).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public CartApplicationModels.CartItemCountResponse getItemCount(String id ) throws IOException {
     
      String fullUrl = relativeUrls.get("getItemCount");
        

        Response<CartApplicationModels.CartItemCountResponse> response = cartApplicationApiList.getItemCount(fullUrl  ,id).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public CartApplicationModels.GetCouponResponse getCoupons(String id ) throws IOException {
     
      String fullUrl = relativeUrls.get("getCoupons");
        

        Response<CartApplicationModels.GetCouponResponse> response = cartApplicationApiList.getCoupons(fullUrl  ,id).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public CartApplicationModels.CartDetailResponse applyCoupon(Boolean i , Boolean b , Boolean p , String id ,CartApplicationModels.ApplyCouponRequest body) throws IOException {
     
      String fullUrl = relativeUrls.get("applyCoupon");
        

        Response<CartApplicationModels.CartDetailResponse> response = cartApplicationApiList.applyCoupon(fullUrl  ,i, b, p, id, body).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public CartApplicationModels.CartDetailResponse removeCoupon(String id ) throws IOException {
     
      String fullUrl = relativeUrls.get("removeCoupon");
        

        Response<CartApplicationModels.CartDetailResponse> response = cartApplicationApiList.removeCoupon(fullUrl  ,id).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public CartApplicationModels.CartDetailResponse applyRewardPoints(String id , Boolean i , Boolean b ,CartApplicationModels.RewardPointRequest body) throws IOException {
     
      String fullUrl = relativeUrls.get("applyRewardPoints");
        

        Response<CartApplicationModels.CartDetailResponse> response = cartApplicationApiList.applyRewardPoints(fullUrl  ,id, i, b, body).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public CartApplicationModels.GetAddressesResponse getAddresses(String cartId , String mobileNo , String checkoutMode , String tags , Boolean isDefault ) throws IOException {
     
      String fullUrl = relativeUrls.get("getAddresses");
        

        Response<CartApplicationModels.GetAddressesResponse> response = cartApplicationApiList.getAddresses(fullUrl  ,cartId, mobileNo, checkoutMode, tags, isDefault).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public CartApplicationModels.Address getAddressById(String id , String cartId , String mobileNo , String checkoutMode , String tags , Boolean isDefault ) throws IOException {
      ...
      String fullUrl = relativeUrls.get("getAddressById");
        ...
        Response<CartApplicationModels.Address> response = cartApplicationApiList.getAddressById(fullUrl  ,cartId, mobileNo, checkoutMode, tags, isDefault).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public CartApplicationModels.CartDetailResponse selectAddress(String cartId , Boolean i , Boolean b ,CartApplicationModels.SelectCartAddressRequest body) throws IOException {
     
      String fullUrl = relativeUrls.get("selectAddress");
        

        Response<CartApplicationModels.CartDetailResponse> response = cartApplicationApiList.selectAddress(fullUrl  ,cartId, i, b, body).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public CartApplicationModels.CartDetailResponse selectPaymentMode(String id ,CartApplicationModels.UpdateCartPaymentRequest body) throws IOException {
     
      String fullUrl = relativeUrls.get("selectPaymentMode");
        

        Response<CartApplicationModels.CartDetailResponse> response = cartApplicationApiList.selectPaymentMode(fullUrl  ,id, body).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public CartApplicationModels.PaymentCouponValidate validateCouponForPayment(String id , String addressId , String paymentMode , String paymentIdentifier , String aggregatorName , String merchantCode ) throws IOException {
     
      String fullUrl = relativeUrls.get("validateCouponForPayment");
        

        Response<CartApplicationModels.PaymentCouponValidate> response = cartApplicationApiList.validateCouponForPayment(fullUrl  ,id, addressId, paymentMode, paymentIdentifier, aggregatorName, merchantCode).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public CartApplicationModels.CartShipmentsResponse getShipments(Boolean p , String id , String addressId , String areaCode , String orderType ) throws IOException {
     
      String fullUrl = relativeUrls.get("getShipments");
        

        Response<CartApplicationModels.CartShipmentsResponse> response = cartApplicationApiList.getShipments(fullUrl  ,p, id, addressId, areaCode, orderType).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public CartApplicationModels.CartCheckoutResponse checkoutCart(CartApplicationModels.CartCheckoutDetailRequest body) throws IOException {
     
      String fullUrl = relativeUrls.get("checkoutCart");
        

        Response<CartApplicationModels.CartCheckoutResponse> response = cartApplicationApiList.checkoutCart(fullUrl , body).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public CartApplicationModels.CartMetaResponse updateCartMeta(String id ,CartApplicationModels.CartMetaRequest body) throws IOException {
     
      String fullUrl = relativeUrls.get("updateCartMeta");
        

        Response<CartApplicationModels.CartMetaResponse> response = cartApplicationApiList.updateCartMeta(fullUrl  ,id, body).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
