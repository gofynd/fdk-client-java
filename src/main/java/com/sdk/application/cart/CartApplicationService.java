 ...
 public class CartApplicationService { 
    ...
    public CartApplicationModels.CartDetailResponse getCart(String id , Boolean i , Boolean b , Integer assignCardId , Boolean buyNow ) throws IOException {
      ...
      String fullUrl = relativeUrls.get("getCart");
        ...
        Response<CartApplicationModels.CartDetailResponse> response = cartApplicationApiList.getCart(fullUrl  ,id, i, b, assignCardId, buyNow).execute();
    ...
    public CartApplicationModels.AddCartDetailResponse addItems(Boolean i , Boolean b , Boolean buyNow ,CartApplicationModels.AddCartRequest body) throws IOException {
     
      String fullUrl = relativeUrls.get("addItems");
        

        Response<CartApplicationModels.AddCartDetailResponse> response = cartApplicationApiList.addItems(fullUrl  ,i, b, buyNow, body).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public CartApplicationModels.UpdateCartDetailResponse updateCart(String id , Boolean i , Boolean b , Boolean buyNow ,CartApplicationModels.UpdateCartRequest body) throws IOException {
     
      String fullUrl = relativeUrls.get("updateCart");
        

        Response<CartApplicationModels.UpdateCartDetailResponse> response = cartApplicationApiList.updateCart(fullUrl  ,id, i, b, buyNow, body).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
