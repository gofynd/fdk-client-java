...
interface ThemeApplicationApiList {
    ...
    @GET 
    Call<ThemeApplicationModels.AvailablePageSchema> getPage(@Url String url1, @Query("filters") String filters, @Query("section_preview_hash") String sectionPreviewHash, @Query("company") Integer company, @Query("preview_id") String previewId, @HeaderMap Map<String, String> requestHeaders);
