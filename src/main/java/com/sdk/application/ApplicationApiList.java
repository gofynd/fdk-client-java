...
interface CartApiList {
    ...
    @POST 
    Call<ApplicationModels.CartCheckoutResponse> checkoutCartV2(@Url String url1, @Query("buy_now") Boolean buyNow  , @Body ApplicationModels.CartCheckoutDetailV2Request payload );
}
