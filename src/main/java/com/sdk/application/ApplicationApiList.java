...
interface CartApiList {
    ...
    @POST 
    Call<ApplicationModels.AddCartDetailResponse> addItems(@Url String url1, @Query("i") Boolean i , @Query("b") Boolean b , @Query("area_code") String areaCode , @Query("id") String id , @Query("buy_now") Boolean buyNow  , @Body ApplicationModels.AddCartRequest payload );
