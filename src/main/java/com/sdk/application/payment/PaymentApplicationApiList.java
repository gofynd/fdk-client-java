...
interface PaymentApplicationApiList {
    ...
    @GET 
    Call<PaymentApplicationModels.PaymentOutageResponseData> getOutagesData(@Url String url1, @Query("aggregator") String aggregator, @Query("refresh") Boolean refresh, @Query("mopfilter") List<String> mopfilter, @HeaderMap Map<String, String> requestHeaders);
