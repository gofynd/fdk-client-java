...
interface PaymentApplicationApiList {
    ...
    @GET 
    Call<PaymentApplicationModels.GetRefundBeneficiary> getRefundBeneficiaries(@Url String url1, @Query("order_id") String orderId, @Query("shipment_id") String shipmentId, @HeaderMap Map<String, String> requestHeaders);
    ...
    @GET 
    Call<PaymentApplicationModels.GetRefundBeneficiary> getRefundBeneficiariesUsingOTPSession(@Url String url1, @Query("order_id") String orderId, @Query("shipment_id") String shipmentId, @Query("filter_by") String filterBy, @HeaderMap Map<String, String> requestHeaders);
    ...
    @GET 
    Call<PaymentApplicationModels.OrderTransactionList> getOrderTransactions(@Url String url1, @HeaderMap Map<String, String> requestHeaders);
}