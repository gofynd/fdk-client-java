...
interface PosCartApplicationApiList {
    ...
    @POST 
    Call<PosCartApplicationModels.AddCartDetailResponse> addItems(@Url String url1, @Query("i") Boolean i , @Query("b") Boolean b , @Query("area_code") String areaCode  , @Body PosCartApplicationModels.AddCartRequest payload );
