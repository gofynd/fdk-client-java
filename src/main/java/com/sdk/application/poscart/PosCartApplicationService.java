...
@Getter
 public class PosCartApplicationService { 
    ...
    public PosCartApplicationModels.CartDetailResponse getCart(String id , Boolean i , Boolean b , Boolean p , Integer assignCardId , String areaCode , Boolean buyNow ) throws IOException {
     
      String fullUrl = relativeUrls.get("getCart");
        

        Response<PosCartApplicationModels.CartDetailResponse> response = poscartApplicationApiList.getCart(fullUrl  ,id, i, b, p, assignCardId, areaCode, buyNow).execute();
    ...
    public PosCartApplicationModels.AddCartDetailResponse addItems(Boolean i , Boolean b , Boolean p , String areaCode , Boolean buyNow , String id ,PosCartApplicationModels.AddCartRequest body) throws IOException {
     
      String fullUrl = relativeUrls.get("addItems");
        

        Response<PosCartApplicationModels.AddCartDetailResponse> response = poscartApplicationApiList.addItems(fullUrl  ,i, b, p, areaCode, buyNow, id, body).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public PosCartApplicationModels.UpdateCartDetailResponse updateCart(String id , Boolean i , Boolean b , Boolean p , String areaCode , Boolean buyNow ,PosCartApplicationModels.UpdateCartRequest body) throws IOException {
     
      String fullUrl = relativeUrls.get("updateCart");
        

        Response<PosCartApplicationModels.UpdateCartDetailResponse> response = poscartApplicationApiList.updateCart(fullUrl  ,id, i, b, p, areaCode, buyNow, body).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public PosCartApplicationModels.PaymentCouponValidate validateCouponForPayment(String id , Boolean buyNow , String addressId , String paymentMode , String paymentIdentifier , String aggregatorName , String merchantCode , String iin , String network , String type , String cardId ) throws IOException {
      ...
      String fullUrl = relativeUrls.get("validateCouponForPayment");
        ...
        Response<PosCartApplicationModels.PaymentCouponValidate> response = poscartApplicationApiList.validateCouponForPayment(fullUrl  ,id, buyNow, addressId, paymentMode, paymentIdentifier, aggregatorName, merchantCode, iin, network, type, cardId).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
