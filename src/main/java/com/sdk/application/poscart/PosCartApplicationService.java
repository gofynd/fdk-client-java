...
@Getter
 public class PosCartApplicationService { 
    ...
    public PosCartApplicationModels.CartDetailResponse getCart(String id , Boolean i , Boolean b , Integer assignCardId , String areaCode ) throws IOException {
     
      String fullUrl = relativeUrls.get("getCart");
        

        Response<PosCartApplicationModels.CartDetailResponse> response = poscartApplicationApiList.getCart(fullUrl  ,id, i, b, assignCardId, areaCode).execute();
    ...
    public PosCartApplicationModels.AddCartDetailResponse addItems(Boolean i , Boolean b , String areaCode , String id ,PosCartApplicationModels.AddCartRequest body) throws IOException {
     
      String fullUrl = relativeUrls.get("addItems");
        

        Response<PosCartApplicationModels.AddCartDetailResponse> response = poscartApplicationApiList.addItems(fullUrl  ,i, b, areaCode, id, body).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public PosCartApplicationModels.UpdateCartDetailResponse updateCart(String id , Boolean i , Boolean b , String areaCode ,PosCartApplicationModels.UpdateCartRequest body) throws IOException {
     
      String fullUrl = relativeUrls.get("updateCart");
        

        Response<PosCartApplicationModels.UpdateCartDetailResponse> response = poscartApplicationApiList.updateCart(fullUrl  ,id, i, b, areaCode, body).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public PosCartApplicationModels.CartItemCountResponse getItemCount(String id ) throws IOException {
     
      String fullUrl = relativeUrls.get("getItemCount");
        

        Response<PosCartApplicationModels.CartItemCountResponse> response = poscartApplicationApiList.getItemCount(fullUrl  ,id).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public PosCartApplicationModels.GetCouponResponse getCoupons(String id ) throws IOException {
     
      String fullUrl = relativeUrls.get("getCoupons");
        

        Response<PosCartApplicationModels.GetCouponResponse> response = poscartApplicationApiList.getCoupons(fullUrl  ,id).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public PosCartApplicationModels.CartDetailResponse applyCoupon(Boolean i , Boolean b , Boolean p , String id ,PosCartApplicationModels.ApplyCouponRequest body) throws IOException {
     
      String fullUrl = relativeUrls.get("applyCoupon");
        

        Response<PosCartApplicationModels.CartDetailResponse> response = poscartApplicationApiList.applyCoupon(fullUrl  ,i, b, p, id, body).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public PosCartApplicationModels.CartDetailResponse removeCoupon(String id ) throws IOException {
     
      String fullUrl = relativeUrls.get("removeCoupon");
        

        Response<PosCartApplicationModels.CartDetailResponse> response = poscartApplicationApiList.removeCoupon(fullUrl  ,id).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public PosCartApplicationModels.CartDetailResponse applyRewardPoints(String id , Boolean i , Boolean b ,PosCartApplicationModels.RewardPointRequest body) throws IOException {
     
      String fullUrl = relativeUrls.get("applyRewardPoints");
        

        Response<PosCartApplicationModels.CartDetailResponse> response = poscartApplicationApiList.applyRewardPoints(fullUrl  ,id, i, b, body).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public PosCartApplicationModels.GetAddressesResponse getAddresses(String cartId , String mobileNo , String checkoutMode , String tags , Boolean isDefault ) throws IOException {
     
      String fullUrl = relativeUrls.get("getAddresses");
        

        Response<PosCartApplicationModels.GetAddressesResponse> response = poscartApplicationApiList.getAddresses(fullUrl  ,cartId, mobileNo, checkoutMode, tags, isDefault).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public PosCartApplicationModels.Address getAddressById(String id , String cartId , String mobileNo , String checkoutMode , String tags , Boolean isDefault ) throws IOException {
      ...
      String fullUrl = relativeUrls.get("getAddressById");
        ...
        Response<PosCartApplicationModels.Address> response = poscartApplicationApiList.getAddressById(fullUrl  ,cartId, mobileNo, checkoutMode, tags, isDefault).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public PosCartApplicationModels.CartDetailResponse selectAddress(String cartId , Boolean i , Boolean b ,PosCartApplicationModels.SelectCartAddressRequest body) throws IOException {
     
      String fullUrl = relativeUrls.get("selectAddress");
        

        Response<PosCartApplicationModels.CartDetailResponse> response = poscartApplicationApiList.selectAddress(fullUrl  ,cartId, i, b, body).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public PosCartApplicationModels.CartDetailResponse selectPaymentMode(String id ,PosCartApplicationModels.UpdateCartPaymentRequest body) throws IOException {
     
      String fullUrl = relativeUrls.get("selectPaymentMode");
        

        Response<PosCartApplicationModels.CartDetailResponse> response = poscartApplicationApiList.selectPaymentMode(fullUrl  ,id, body).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public PosCartApplicationModels.PaymentCouponValidate validateCouponForPayment(String id , String addressId , String paymentMode , String paymentIdentifier , String aggregatorName , String merchantCode ) throws IOException {
     
      String fullUrl = relativeUrls.get("validateCouponForPayment");
        

        Response<PosCartApplicationModels.PaymentCouponValidate> response = poscartApplicationApiList.validateCouponForPayment(fullUrl  ,id, addressId, paymentMode, paymentIdentifier, aggregatorName, merchantCode).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public PosCartApplicationModels.CartMetaResponse updateCartMeta(String id ,PosCartApplicationModels.CartMetaRequest body) throws IOException {
     
      String fullUrl = relativeUrls.get("updateCartMeta");
        

        Response<PosCartApplicationModels.CartMetaResponse> response = poscartApplicationApiList.updateCartMeta(fullUrl  ,id, body).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
