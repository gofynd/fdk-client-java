...
@Getter
 public class CartService { 
    ...
    public ApplicationModels.AddCartDetailResponse addItems(Boolean i , Boolean b , String areaCode , String id , Boolean buyNow ,ApplicationModels.AddCartRequest body) throws IOException {
     
      String fullUrl = relativeUrls.get("addItems");
        

        Response<ApplicationModels.AddCartDetailResponse> response = cartApiList.addItems(fullUrl  ,i, b, areaCode, id, buyNow, body).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
 ...
 public class PosCartService { 
    ...
    public ApplicationModels.AddCartDetailResponse addItems(Boolean i , Boolean b , String areaCode , String id , Boolean buyNow ,ApplicationModels.AddCartRequest body) throws IOException {
      ...
      String fullUrl = relativeUrls.get("addItems");
        ...
        Response<ApplicationModels.AddCartDetailResponse> response = poscartApiList.addItems(fullUrl  ,i, b, areaCode, id, buyNow, body).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
