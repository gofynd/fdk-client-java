...
@Getter
 public class CartService { 
    ...
    public ApplicationModels.CartDetailResponse getCart(String id , Boolean i , Boolean b , Integer assignCardId , String areaCode , Boolean buyNow ) throws IOException {
        ...
        Response<ApplicationModels.CartDetailResponse> response = cartApiList.getCart(id, i, b, assignCardId, areaCode, buyNow).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public ApplicationModels.AddCartDetailResponse addItems(Boolean i , Boolean b , String areaCode , Boolean buyNow ,ApplicationModels.AddCartRequest body) throws IOException {
        ...
        Response<ApplicationModels.AddCartDetailResponse> response = cartApiList.addItems(i, b, areaCode, buyNow, body).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public ApplicationModels.UpdateCartDetailResponse updateCart(String id , Boolean i , Boolean b , String areaCode , Boolean buyNow ,ApplicationModels.UpdateCartRequest body) throws IOException {
        ...
        Response<ApplicationModels.UpdateCartDetailResponse> response = cartApiList.updateCart(id, i, b, areaCode, buyNow, body).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public ApplicationModels.UpdateAddressResponse updateAddress(String id ,ApplicationModels.Address body) throws IOException {
        ...
        Response<ApplicationModels.UpdateAddressResponse> response = cartApiList.updateAddress(id, body).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public ApplicationModels.DeleteAddressResponse removeAddress(String id ) throws IOException {
        ...
        Response<ApplicationModels.DeleteAddressResponse> response = cartApiList.removeAddress(id).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
...
@Getter
 public class PaymentService { 
    ...
    public ApplicationModels.RedirectToAggregatorResponse redirectToAggregator(String source , String aggregator ) throws IOException {
        ...
        Response<ApplicationModels.RedirectToAggregatorResponse> response = paymentApiList.redirectToAggregator(source, aggregator).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
...
@Getter
 public class OrderService { 
    ...
    public ApplicationModels.OrderList getOrders(Integer status , Integer pageNo , Integer pageSize , String fromDate , String toDate , String customMeta ) throws IOException {
        ...
        Response<ApplicationModels.OrderList> response = orderApiList.getOrders(status, pageNo, pageSize, fromDate, toDate, customMeta).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public ApplicationModels.ShipmentBagReasons getShipmentBagReasons(String shipmentId , String bagId ) throws IOException {
        ...
        Response<ApplicationModels.ShipmentBagReasons> response = orderApiList.getShipmentBagReasons(shipmentId, bagId).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public ApplicationModels.ResponseGetInvoiceShipment1 getInvoiceByShipmentId1(String shipmentId , ApplicationModels.invoiceParameter parameters ) throws IOException {
        ...
        Response<ApplicationModels.ResponseGetInvoiceShipment1> response = orderApiList.getInvoiceByShipmentId1(shipmentId, parameters).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public ApplicationModels.ResponseGetInvoiceShipment1 getCreditNoteByShipmentId(String shipmentId , ApplicationModels.creditNoteParameter parameters ) throws IOException {
        ...
        Response<ApplicationModels.ResponseGetInvoiceShipment1> response = orderApiList.getCreditNoteByShipmentId(shipmentId, parameters).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
...
@Getter
 public class PosCartService { 
    ...
    public ApplicationModels.CartDetailResponse getCart(String id , Boolean i , Boolean b , Integer assignCardId , String areaCode , Boolean buyNow ) throws IOException {
        ...
        Response<ApplicationModels.CartDetailResponse> response = poscartApiList.getCart(id, i, b, assignCardId, areaCode, buyNow).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public ApplicationModels.AddCartDetailResponse addItems(Boolean i , Boolean b , String areaCode , Boolean buyNow ,ApplicationModels.AddCartRequest body) throws IOException {
        ...
        Response<ApplicationModels.AddCartDetailResponse> response = poscartApiList.addItems(i, b, areaCode, buyNow, body).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public ApplicationModels.UpdateCartDetailResponse updateCart(String id , Boolean i , Boolean b , String areaCode , Boolean buyNow ,ApplicationModels.UpdateCartRequest body) throws IOException {
        ...
        Response<ApplicationModels.UpdateCartDetailResponse> response = poscartApiList.updateCart(id, i, b, areaCode, buyNow, body).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public ApplicationModels.UpdateAddressResponse updateAddress(String id ,ApplicationModels.Address body) throws IOException {
        ...
        Response<ApplicationModels.UpdateAddressResponse> response = poscartApiList.updateAddress(id, body).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public ApplicationModels.DeleteAddressResponse removeAddress(String id ) throws IOException {
        ...
        Response<ApplicationModels.DeleteAddressResponse> response = poscartApiList.removeAddress(id).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public ApplicationModels.CartShipmentsResponse getShipments(Integer pickAtStoreUid , Integer orderingStoreId , Boolean p , String id , String addressId , String areaCode , String orderType ) throws IOException {
        ...
        Response<ApplicationModels.CartShipmentsResponse> response = poscartApiList.getShipments(pickAtStoreUid, orderingStoreId, p, id, addressId, areaCode, orderType).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public ApplicationModels.CartShipmentsResponse updateShipments(Boolean i , Boolean p , String id , String addressId , String orderType ,ApplicationModels.UpdateCartShipmentRequest body) throws IOException {
        ...
        Response<ApplicationModels.CartShipmentsResponse> response = poscartApiList.updateShipments(i, p, id, addressId, orderType, body).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public ApplicationModels.CartCheckoutResponse checkoutCart(String id ,ApplicationModels.CartPosCheckoutDetailRequest body) throws IOException {
        ...
        Response<ApplicationModels.CartCheckoutResponse> response = poscartApiList.checkoutCart(id, body).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public ApplicationModels.CartDeliveryModesResponse getAvailableDeliveryModes(String areaCode , String id ) throws IOException {
        ...
        Response<ApplicationModels.CartDeliveryModesResponse> response = poscartApiList.getAvailableDeliveryModes(areaCode, id).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
