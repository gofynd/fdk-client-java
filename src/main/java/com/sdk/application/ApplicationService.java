...
@Getter
 public class OrderService { 
    ...
    public ApplicationModels.ResponseGetInvoiceShipment getInvoiceByShipmentId(String shipmentId , String documentType ) throws IOException {
      ...
      String fullUrl = relativeUrls.get("getInvoiceByShipmentId");
        ...
        Response<ApplicationModels.ResponseGetInvoiceShipment> response = orderApiList.getInvoiceByShipmentId(fullUrl  ,documentType).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
