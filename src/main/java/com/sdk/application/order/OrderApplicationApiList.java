...
interface OrderApplicationApiList {
    ...
    @PUT 
    Call<OrderApplicationModels.ShipmentApplicationStatusResponse> updateShipmentStatus1(@Url String url1 , @Body OrderApplicationModels.UpdateShipmentStatusRequest payload );
}