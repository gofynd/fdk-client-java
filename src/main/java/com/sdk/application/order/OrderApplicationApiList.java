...
interface OrderApplicationApiList {
    ...
    @GET 
    Call<OrderApplicationModels.ShipmentRefundSummaryResponseSchema> getShipmentRefundSummary(@Url String url1, @HeaderMap Map<String, String> requestHeaders);

    @GET 
    Call<OrderApplicationModels.RefundOptionsSchemaResponseSchema> getRefundOptions(@Url String url1, @Query("bag_ids") String bagIds, @Query("state") String state, @Query("optin_app_id") String optinAppId, @Query("optin_company_id") Integer optinCompanyId, @Query("status") String status, @HeaderMap Map<String, String> requestHeaders);
