...
@Getter
 public class OrderApplicationService { 
    ...
    public OrderApplicationModels.ShipmentReasonsResponse getShipmentReasons(String shipmentId , String bagId ) throws IOException {
      ...
      String fullUrl = relativeUrls.get("getShipmentReasons");
        ...
        Response<OrderApplicationModels.ShipmentReasonsResponse> response = orderApplicationApiList.getShipmentReasons(fullUrl  ,bagId).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public OrderApplicationModels.VerifyOtpResponse verifyOtpShipmentCustomer(String orderId , Integer shipmentId ,OrderApplicationModels.VerifyOtp body) throws IOException {
    ...
    public OrderApplicationModels.OrderList getOrders(Integer status , Integer pageNo , Integer pageSize , String fromDate , String toDate ) throws IOException {
     
      String fullUrl = relativeUrls.get("getOrders");
        

        Response<OrderApplicationModels.OrderList> response = orderApplicationApiList.getOrders(fullUrl  ,status, pageNo, pageSize, fromDate, toDate).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public OrderApplicationModels.OrderList getOrderById(String orderId ) throws IOException {
      ...
      String fullUrl = relativeUrls.get("getOrderById");
        ...
        Response<OrderApplicationModels.OrderList> response = orderApplicationApiList.getOrderById(fullUrl ).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
    ...
    public OrderApplicationModels.TrackShipmentResponse trackShipment(String shipmentId ) throws IOException {
      ...
      String fullUrl = relativeUrls.get("trackShipment");
        ...
        Response<OrderApplicationModels.TrackShipmentResponse> response = orderApplicationApiList.trackShipment(fullUrl ).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
