...
@Getter
 public class OrderApplicationService { 
    ...
    public OrderApplicationModels.OrderList getOrders(Integer pageNo , Integer pageSize , String fromDate , String toDate , Integer status , String customMeta ) throws IOException {
     
      String fullUrl = relativeUrls.get("getOrders");
        

        Response<OrderApplicationModels.OrderList> response = orderApplicationApiList.getOrders(fullUrl  ,pageNo, pageSize, fromDate, toDate, status, customMeta).execute();
    ...
    public OrderApplicationModels.ResponseGetCreditNoteShipment getCreditNoteByShipmentId(String shipmentId ) throws IOException {
      ...
      String fullUrl = relativeUrls.get("getCreditNoteByShipmentId");
        ...
        Response<OrderApplicationModels.ResponseGetCreditNoteShipment> response = orderApplicationApiList.getCreditNoteByShipmentId(fullUrl ).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
