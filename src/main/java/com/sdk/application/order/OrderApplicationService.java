 ...
 public class OrderApplicationService { 
    ...
    public OrderApplicationService(ApplicationConfig applicationConfig) {
        ...
        this.orderApplicationApiList = generateOrderApplicationApiList(this.applicationConfig.getPersistentCookieStore());
                    ...
                    relativeUrls.put("getProducts","/service/application/orders/v1.0/products".substring(1));
    ...
    public OrderApplicationModels.ProductListResponse getProducts(Integer companyId , Integer status , Integer pageNo , Integer pageSize , String fromDate , String toDate , String customMeta , String searchType , String searchValue ) throws IOException {
      ...
      String fullUrl = relativeUrls.get("getProducts");
        ...
        Response<OrderApplicationModels.ProductListResponse> response = orderApplicationApiList.getProducts(fullUrl  ,status, pageNo, pageSize, fromDate, toDate, customMeta, searchType, searchValue).execute();
        if(!response.isSuccessful()) {
            throw new IOException(response.errorBody() != null
                    ? response.errorBody().string() : Fields.UNKNOWN_ERROR);
        }
