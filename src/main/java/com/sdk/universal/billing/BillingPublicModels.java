...
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonInclude(JsonInclude.Include.NON_NULL)
public static class TenureConfigData{
    ...
    @JsonProperty("tenure_config")
    private List<TenureConfig> tenureConfig;
...
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonInclude(JsonInclude.Include.NON_NULL)
public static class TenureConfigResponse{
...
public static class PlanTypes{
    ...
    @JsonProperty("month")
    private List<PlanDetails> month;
    
    
    
    
    @JsonProperty("quarter")
    private List<PlanDetails> quarter;
    
    
    
    
    @JsonProperty("half_year")
    private List<PlanDetails> halfYear;
    
    
    
    
    @JsonProperty("year")
    private List<PlanDetails> year;
...
public static class DetailList{
    ...
    @JsonProperty("plans")
    private PlanTypes plans;
    
    
    
    
    @JsonProperty("trial_plan")
    private TrialPlanDetails trialPlan;
...
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonInclude(JsonInclude.Include.NON_NULL)
public static class TrialPlanDetails{
