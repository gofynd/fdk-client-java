...
interface BillingPublicApiList {
    ...
    @GET ("/service/public/billing/v1.0/tenure-config/{country_code}")
    Call<BillingPublicModels.TenureConfigResponse> getTenureConfig(@Path("country_code") String countryCode, @HeaderMap Map<String, String> requestHeaders);
}