...
- ##### What's Deprecated
	...
	- [Deleted] properties `paymentOptions.paymentOption`, `paymentOptions.paymentFlows` in response with status code 200
...
- ##### What's Deprecated
	- [Breaking] [Deleted] property `page.itemCount` of schema `Page` in response with status code 200
...
- ##### What's Deprecated
	- [Deleted] properties `page.current`, `page.size`, `page.type`, `page.itemCount`, `page.hasNext` in response with status code 200
...
- ##### What's New
	- [Added] property `data.page.itemTotal` of schema `Page` in response with status code 200

- ##### What's Deprecated
	- [Breaking] [Deleted] property `data.page.itemCount` of schema `Page` in response with status code 200
...
- ##### What's New
	- [Added] property `articleDetails.dimension` of schema `ArticleDetails` in response with status code 200
	- [Added] property `articleDetails.category` of schema `ArticleDetails` in response with status code 200
	- [Added] property `articleDetails.weight` of schema `ArticleDetails` in response with status code 200
	- [Added] property `articleDetails.attributes` of schema `ArticleDetails` in response with status code 200
	- [Added] property `articleDetails.quantity` of schema `ArticleDetails` in response with status code 200
	- [Added] property `articleDetails.id` of schema `ArticleDetails` in response with status code 200
	- [Added] property `articleDetails.brandId` of schema `ArticleDetails` in response with status code 200
	- [Breaking] [Added] Required status to properties `articleDetails._id`, `articleDetails.attributes`, `articleDetails.brand_id`, `articleDetails.category`, `articleDetails.dimension`, `articleDetails.quantity`, `articleDetails.weight` in response with status code 200
	- [Breaking] [Added] Required status to property `message` in response with status code 4XX
	- [Breaking] [Added] Required status to property `message` in response with status code 5XX

- ##### What's Deprecated
	- [Breaking] [Deleted] property `article.tags` of schema `Article` in response with status code 200
	- [Breaking] [Deleted] property `prices.amountToBeCollected` of schema `Prices` in response with status code 200
	- [Breaking] [Deleted] property `financialBreakup[].amountToBeCollected` of schema `FinancialBreakup` in response with status code 200
	- [Breaking] [Deleted] property `bagStatus[].createdTs` of schema `BagStatusHistory` in response with status code 200
	- [Breaking] [Deleted] property `bagStatus[].updatedTs` of schema `BagStatusHistory` in response with status code 200
	- [Breaking] [Deleted] property `currentOperationalStatus.createdTs` of schema `BagStatusHistory` in response with status code 200
	- [Breaking] [Deleted] property `currentOperationalStatus.updatedTs` of schema `BagStatusHistory` in response with status code 200
	- [Breaking] [Deleted] property `bagStatusHistory.createdTs` of schema `BagStatusHistory` in response with status code 200
	- [Breaking] [Deleted] property `bagStatusHistory.updatedTs` of schema `BagStatusHistory` in response with status code 200
	- [Breaking] [Deleted] property `currentStatus.createdTs` of schema `BagStatusHistory` in response with status code 200
	- [Breaking] [Deleted] property `currentStatus.updatedTs` of schema `BagStatusHistory` in response with status code 200


#### getBags

- ##### What's New
	- [Added] property `items[].articleDetails.dimension` of schema `ArticleDetails` in response with status code 200
	- [Added] property `items[].articleDetails.category` of schema `ArticleDetails` in response with status code 200
	- [Added] property `items[].articleDetails.weight` of schema `ArticleDetails` in response with status code 200
	- [Added] property `items[].articleDetails.attributes` of schema `ArticleDetails` in response with status code 200
	- [Added] property `items[].articleDetails.quantity` of schema `ArticleDetails` in response with status code 200
	- [Added] property `items[].articleDetails.id` of schema `ArticleDetails` in response with status code 200
	- [Added] property `items[].articleDetails.brandId` of schema `ArticleDetails` in response with status code 200
	- [Breaking] [Added] Required status to properties `items[].articleDetails._id`, `items[].articleDetails.attributes`, `items[].articleDetails.brand_id`, `items[].articleDetails.category`, `items[].articleDetails.dimension`, `items[].articleDetails.quantity`, `items[].articleDetails.weight` in response with status code 200
	- [Breaking] [Added] Required status to property `message` in response with status code 4XX
	- [Breaking] [Added] Required status to property `message` in response with status code 5XX
...
- ##### What's Deprecated
	...
	- [Breaking] [Deleted] property `items[].prices.amountToBeCollected` of schema `Prices` in response with status code 200
	- [Breaking] [Deleted] property `items[].financialBreakup[].amountToBeCollected` of schema `FinancialBreakup` in response with status code 200
	- [Breaking] [Deleted] property `items[].bagStatus[].createdTs` of schema `BagStatusHistory` in response with status code 200
	- [Breaking] [Deleted] property `items[].bagStatus[].updatedTs` of schema `BagStatusHistory` in response with status code 200
	- [Breaking] [Deleted] property `items[].currentOperationalStatus.createdTs` of schema `BagStatusHistory` in response with status code 200
	- [Breaking] [Deleted] property `items[].currentOperationalStatus.updatedTs` of schema `BagStatusHistory` in response with status code 200
	- [Breaking] [Deleted] property `items[].bagStatusHistory.createdTs` of schema `BagStatusHistory` in response with status code 200
	- [Breaking] [Deleted] property `items[].bagStatusHistory.updatedTs` of schema `BagStatusHistory` in response with status code 200
	- [Breaking] [Deleted] property `items[].currentStatus.createdTs` of schema `BagStatusHistory` in response with status code 200
	- [Breaking] [Deleted] property `items[].currentStatus.updatedTs` of schema `BagStatusHistory` in response with status code 200
...
- ##### What's Deprecated
	...
	- [Deleted] properties `page.size`, `page.current`, `page.type`, `page.hasNext`, `page.itemTotal` in response with status code 200
...
- ##### What's Deprecated
	...
	- [Breaking] [Deleted] property `page.totalPage` of schema `Page` in response with status code 200
...
- ##### What's Deprecated
	...
	- [Deleted] Type from `object` from property `eventConfigs[]` of schema `EventConfigResponse` in response with status code 200
	- [Deleted] Possible nullable value from `true` from property `eventConfigs[].description` of schema `EventConfigResponse` in response with status code 200
	- [Breaking] [Deleted] property `eventConfigs[].eventSchema` of schema `EventConfigResponse` in response with status code 200
	- [Breaking] [Deleted] property `eventConfigs[].updatedOn` of schema `EventConfigResponse` in response with status code 200
...
- ##### What's Deprecated
	...
	- [Deleted] Type from `object` from property `eventConfigs[]` of schema `EventConfigs` in response with status code 200
	- [Breaking] [Deleted] property `eventConfigs[].eventSchema` of schema `EventConfigs` in response with status code 200
	- [Breaking] [Deleted] property `eventConfigs[].updatedOn` of schema `EventConfigs` in response with status code 200
	- [Breaking] [Deleted] property `eventConfigs[].subscriberEventMapping` of schema `EventConfigs` in response with status code 200
...
- ##### What's Deprecated
	...
	- [Deleted] Type from `object` from property `items[].eventConfigs[]` of schema `EventConfigs` in response with status code 200
	- [Breaking] [Deleted] property `items[].eventConfigs[].eventSchema` of schema `EventConfigs` in response with status code 200
	- [Breaking] [Deleted] property `items[].eventConfigs[].updatedOn` of schema `EventConfigs` in response with status code 200
	- [Breaking] [Deleted] property `items[].eventConfigs[].subscriberEventMapping` of schema `EventConfigs` in response with status code 200
	- [Breaking] [Deleted] property `page.totalPage` of schema `Page` in response with status code 200
