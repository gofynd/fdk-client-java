...
```java
applicationClient.theme.getAppliedThemeV2() {
  //use response
}
```
...
```java
applicationClient.theme.getThemeForPreviewV2( themeId) {
  //use response
}
```
...
---
 ...
 | companyId | Integer? |  yes  | The ID of the company that the theme belongs to. |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | min | Integer? |  yes  | Minimum catalog size |
 | max | Integer? |  yes  | Maximum catalog size |
...
---
 ...
 | countryCode | Integer? |  yes  | Country code for the phone number |
...
---
 ...
 | rejectionReasons | HashMap<String,HashMap<String,Object>> |  no  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | dynamicProperties | HashMap<String,HashMap<String,Object>>? |  yes  |  |
...
---
 ...
 | styles | HashMap<String,Object>? |  yes  | The styles associated with the theme |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | props | ArrayList<Object>? |  yes  |  |
 | blocks | ArrayList<Object>? |  yes  | Blocks |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | value | Integer? |  yes  | The value of the range property. |
 | type | String? |  yes  | The type of the property. |
