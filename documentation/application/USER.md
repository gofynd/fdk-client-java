...
```java
applicationClient.user.resetForgotPassword(body body) {
  //use response
}
```
...
```java
applicationClient.user.sendForgotOTPOnMobile( platform, body body) {
  //use response
}
```
...
```java
applicationClient.user.verifyMobileForgotOTP( platform, body body) {
  //use response
}
```
...
```java
applicationClient.user.sendForgotOTPOnEmail( platform, body body) {
  //use response
}
```
...
```java
applicationClient.user.verifyEmailForgotOTP( platform, body body) {
  //use response
}
```
