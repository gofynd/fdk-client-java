...
```java
catalog.getProductPriceBySlug( slug,  size,  storeId,  pincode,  depth,  strategy) {
  //use response
}
```
...
```java
catalog.getProductSellersBySlug( slug,  size,  pincode,  strategy,  pageNo,  pageSize,  depth) {
  //use response
}
```
