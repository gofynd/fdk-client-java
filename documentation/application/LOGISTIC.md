...
```java
applicationClient.logistic.getCountries() {
  //use response
}
```
...
```java
applicationClient.logistic.getCountry( uid) {
  //use response
}
```
...
```java
applicationClient.logistic.getLocalities( region) {
  //use response
}
```
...
```java
applicationClient.logistic.getLocality( region,  value) {
  //use response
}
```
