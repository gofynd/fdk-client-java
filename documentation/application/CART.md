...
```java
cart.getAddresses( cartId,  buyNow,  mobileNo,  checkoutMode,  tags,  isDefault,  userId) {
  //use response
}
```
...
```java
cart.selectAddress( cartId,  buyNow,  i,  b,  userId, body body) {
  //use response
}
```
