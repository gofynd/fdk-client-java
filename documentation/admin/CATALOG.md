...
```java
adminClient.catalog.createCategories(body body) {
  //use response
}
```
...
```java
adminClient.catalog.listCategories( level,  departments,  q,  pageNo,  pageSize) {
  //use response
}
```
...
```java
adminClient.catalog.updateCategory( uid, body body) {
  //use response
}
```
...
```java
adminClient.catalog.getCategoryData( uid) {
  //use response
}
```
...
```java
adminClient.catalog.updateDepartment( uid, body body) {
  //use response
}
```
...
```java
adminClient.catalog.getDepartment( uid) {
  //use response
}
```
...
```java
adminClient.catalog.createDepartment(body body) {
  //use response
}
```
...
```java
adminClient.catalog.listDepartments( pageNo,  pageSize,  name,  search,  isActive) {
  //use response
}
```
...
```java
adminClient.catalog.setFilterAttributesPriority(body body) {
  //use response
}
```
...
```java
adminClient.catalog.getFilterAttributesPriority() {
  //use response
}
```
...
```java
adminClient.catalog.setAttributeGroupsPriority( groupType, body body) {
  //use response
}
```
...
```java
adminClient.catalog.getAttributeGroupsPriority( groupType) {
  //use response
}
```
...
```java
adminClient.catalog.updateProductAttributeGroup( slug, body body) {
  //use response
}
```
...
```java
adminClient.catalog.getProductAttributeGroup( slug,  ca,  department,  variant,  sort,  sortOn,  q,  pageNo,  pageSize) {
  //use response
}
```
...
```java
adminClient.catalog.listProductAttributesGroups( ca,  department,  variant,  sort,  sortOn,  q,  pageNo,  pageSize) {
  //use response
}
```
...
```java
adminClient.catalog.createProductAttributeGroup(body body) {
  //use response
}
```
...
```java
adminClient.catalog.listProductAttributes( ca,  department,  variant,  sort,  sortOn,  q,  pageNo,  pageSize) {
  //use response
}
```
...
```java
adminClient.catalog.createProductAttribute(body body) {
  //use response
}
```
...
```java
adminClient.catalog.updateProductAttribute( slug, body body) {
  //use response
}
```
...
```java
adminClient.catalog.getProductAttribute( slug) {
  //use response
}
```
...
```java
adminClient.catalog.createVariant(body body) {
  //use response
}
```
...
```java
adminClient.catalog.listVariants() {
  //use response
}
```
...
```java
adminClient.catalog.updateVariant( uid, body body) {
  //use response
}
```
...
```java
adminClient.catalog.getVariantByUID( uid) {
  //use response
}
```
...
```java
adminClient.catalog.listProductTemplate( department) {
  //use response
}
```
...
```java
adminClient.catalog.createProductTemplate(body body) {
  //use response
}
```
...
```java
adminClient.catalog.updateProductTemplate( slug, body body) {
  //use response
}
```
...
```java
adminClient.catalog.deleteProductTemplate( slug) {
  //use response
}
```
...
```java
adminClient.catalog.getProductTemplate( slug) {
  //use response
}
```
...
```java
adminClient.catalog.downloadProductTemplateViews( slug) {
  //use response
}
```
...
| Argument  |  Type  | Required | Description |
| --------- | -----  | -------- | ----------- | 
| companyId | String | yes | A unique identifier of the company. |   
...
```java
adminClient.catalog.validateProductTemplate( slug) {
  //use response
}
```
...
| Argument  |  Type  | Required | Description |
| --------- | -----  | -------- | ----------- | 
| companyId | Integer | yes | A unique identifier of the company. |   
| slug | String | yes | A `slug` is a unique identifier for a particular template. |  
...
```java
adminClient.catalog.verifyCompany( q,  opted,  pageNo,  pageSize,  status,  brandIds) {
  //use response
}
```
...
```java
adminClient.catalog.listProductVerification( q,  opted,  pageNo,  pageSize,  status,  brandIds) {
  //use response
}
```
...
```java
adminClient.catalog.verifyProduct( itemId, body body) {
  //use response
}
```
...
```java
adminClient.catalog.getProductVerificationDetails( itemId) {
  //use response
}
```
...
```java
adminClient.catalog.createSizeGuide(body body) {
  //use response
}
```
...
```java
adminClient.catalog.getSizeGuides( active,  q,  tag,  pageNo,  pageSize) {
  //use response
}
```
...
```java
adminClient.catalog.updateSizeGuide( id, body body) {
  //use response
}
```
...
```java
adminClient.catalog.getSizeGuide( id) {
  //use response
}
```
...
```java
adminClient.catalog.getAppProducts( brandIds,  categoryIds,  departmentIds,  tags,  pageNo,  pageSize,  q) {
  //use response
}
```
...
| Argument  |  Type  | Required | Description |
| --------- | -----  | -------- | ----------- | 
| applicationId | String | yes | This is the unique identifier of the application |   
...
```java
adminClient.catalog.createBulkImportJob( jobType, body body) {
  //use response
}
```
...
```java
adminClient.catalog.listBulkImportJobs( jobType,  search,  stage,  startDate,  endDate,  pageNo,  pageSize,  total) {
  //use response
}
```
...
```java
adminClient.catalog.updateBulkImportJob( jobType,  jobId) {
  //use response
}
```
...
```java
adminClient.catalog.getBulkImportJob( jobType,  jobId) {
  //use response
}
```
...
```java
adminClient.catalog.createBulkExportJob( jobType, body body) {
  //use response
}
```
...
```java
adminClient.catalog.listBulkExportJobs( jobType,  search,  stage,  startDate,  endDate,  pageNo,  pageSize,  total) {
  //use response
}
```
...
```java
adminClient.catalog.updateBulkExportJob( jobType,  jobId) {
  //use response
}
```
...
```java
adminClient.catalog.getBulkExportJob( jobType,  jobId) {
  //use response
}
```
...
```java
adminClient.catalog.getImportValidationSchema( jobType) {
  //use response
}
```
...
```java
adminClient.catalog.downloadImportFile( jobType) {
  //use response
}
```
...
```java
adminClient.catalog.createHsnCodev2(body body) {
  //use response
}
```
...
```java
adminClient.catalog.getAllHsnCodes( pageNo,  pageSize,  q,  type) {
  //use response
}
```
...
```java
adminClient.catalog.updateHsnCode( reportingHsn, body body) {
  //use response
}
```
...
```java
adminClient.catalog.getSingleHSNCode( reportingHsn) {
  //use response
}
```
...
---
 ...
 | priority | Integer? |  yes  | Priority of the attribute group for sorting |
...
---
 ...
 | priority | Integer? |  yes  | Priority of the comparison attribute group for sorting |
...
---
 ...
 | modifiedOn | String |  no  | Timestamp of the last modification of the document |
 | uid | Integer |  no  | Unique ID of the attribute group |
 | createdOn | String |  no  | Timestamp of the creation of the document |
 | id | Object? |  yes  |  |
 | verifiedOn | String? |  yes  | Timestamp of when the document was verified, if applicable |
 | verifiedBy | [UserDetail](#UserDetail)? |  yes  | User details of the verifier of the document, if applicable |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | min | Integer? |  yes  | The minimum value of the attribute range |
 | max | Integer? |  yes  | The maximum value of the attribute range |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | priority | Integer? |  yes  | The priority of the attribute for filtering |
...
---
 ...
 | synonyms | HashMap<String,Object>? |  yes  | Dictionary of synonyms for the attribute |
 | createdOn | String |  no  | Timestamp of the creation of the document |
 | verifiedOn | String? |  yes  | Timestamp of when the document was verified, if applicable |
...
---
 ...
 | maxHeight | Integer? |  yes  | Maximum height of the image |
 | minWidth | Integer? |  yes  | Minimum width of the image |
 | minHeight | Integer? |  yes  | Minimum height of the image |
 | maxSize | Integer? |  yes  | Maximum size of the image in bytes |
 | maxWidth | Integer? |  yes  | Maximum width of the image |
...
---
 ...
 | priority | Integer? |  yes  | Priority of the variant attribute |
 | uid | Integer? |  yes  | Unique ID of the variant attribute |
...
---
 ...
 | modifiedOn | String |  no  | Timestamp of the last modification of the document |
 | product | HashMap<String,Object>? |  yes  | The product information being verified |
 | itemId | Integer |  no  | The unique identifier of the item being verified |
 | rejectedFields | HashMap<String,Object>? |  yes  | A dictionary of any rejected fields and their corresponding values |
 | createdOn | String |  no  | Timestamp of the creation of the document |
 | id | Object? |  yes  |  |
 | verifiedOn | String? |  yes  | Timestamp of when the document was verified, if applicable |
 | verifiedBy | [UserDetail](#UserDetail)? |  yes  | User details of the verifier of the document, if applicable |
 ...
 | createdBy | [UserDetail](#UserDetail)? |  yes  | User details of the creator of the document |
 | brandUid | Integer |  no  | The unique identifier of the brand |
 ...
 | companyIds | ArrayList<Integer> |  no  | The list of company IDs associated with the product |
