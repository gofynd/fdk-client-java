...
```java
partnerClient.theme.getAllPages( themeId,  organizationId) {
  //use response
}
```
...
```java
partnerClient.theme.createPage( themeId,  organizationId, body body) {
  //use response
}
```
...
```java
partnerClient.theme.updateMultiplePages( themeId,  organizationId, body body) {
  //use response
}
```
...
```java
partnerClient.theme.getPage( themeId,  pageValue,  organizationId) {
  //use response
}
```
...
```java
partnerClient.theme.updatePage( themeId,  pageValue,  organizationId, body body) {
  //use response
}
```
...
```java
partnerClient.theme.deletePage( themeId,  pageValue,  organizationId) {
  //use response
}
```
...
```java
partnerClient.theme.getApplicationThemes( organizationId) {
  //use response
}
```
...
[List<ThemesSchema>](#List<ThemesSchema>)
...
```java
partnerClient.theme.getThemeById( themeId,  organizationId) {
  //use response
}
```
...
```java
partnerClient.theme.updateTheme( themeId,  organizationId, body body) {
  //use response
}
```
...
```java
partnerClient.theme.deleteTheme( themeId,  organizationId) {
  //use response
}
```
...
```java
partnerClient.theme.getOrganizationThemes( organizationId,  status,  pageSize,  pageNo) {
  //use response
}
```
...
```java
partnerClient.theme.getOrganizationThemeDetails( organizationId,  themeId) {
  //use response
}
```
...
```java
partnerClient.theme.updateDraftTheme( organizationId,  themeId, body body) {
  //use response
}
```
...
```java
partnerClient.theme.submitOrganizationTheme( organizationId,  themeId, body body) {
  //use response
}
```
...
```java
partnerClient.theme.deleteOrganizationTheme( organizationId,  themeId) {
  //use response
}
```
...
```java
partnerClient.theme.getLatestVersionOfThemeBySlug( organizationId,  slugName) {
  //use response
}
```
...
[List<MarketplaceTheme>](#List<MarketplaceTheme>)
...
```java
partnerClient.theme.createNewThemeInOrganization( organizationId,  slug, body body) {
  //use response
}
```
...
```java
partnerClient.theme.getThemeRejectionReasons( organizationId,  themeId) {
  //use response
}
```
...
```java
partnerClient.theme.getThemeVersions( organizationId,  themeSlug,  pageSize,  pageNo) {
  //use response
}
```
...
| pageNo | Integer? | no | The page number to return. |  
