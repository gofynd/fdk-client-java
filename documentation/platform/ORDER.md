...
```java
client.order.getShipmentDetailsById( shipmentId) {
  //use response
}
```
...
```java
client.order.getShipmentsByShipmentIds( shipmentIds,  pageNo,  pageSize) {
  //use response
}
```
...
```java
client.order.getOrderById( fyndOrderId,  pageNo,  pageSize) {
  //use response
}
```
...
```java
client.order.getShipmentByAffiliateBagId( affiliateBagId,  affiliateId,  pageNo,  pageSize) {
  //use response
}
```
...
```java
client.order.getShipmentByAffiliateShipmentId( affiliateShipmentId,  affiliateId) {
  //use response
}
```
...
```java
client.order.getShipmentsByAffiliateOrderId( affiliateId,  affiliateOrderId,  pageNo,  pageSize) {
  //use response
}
```
