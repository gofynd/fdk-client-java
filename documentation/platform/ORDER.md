...
```java
platformClient.order.getOrders( lane,  searchType,  bagStatus,  timeToDispatch,  paymentMethods,  tags,  searchValue,  fromDate,  toDate,  dpIds,  pageNo,  pageSize,  isPrioritySort,  customMeta) {
  //use response
}
```
