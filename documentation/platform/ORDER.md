...
```java
client.application("<APPLICATION_ID>").order.getOrderDetails1( orderId,  next,  previous) {
  //use response
}
```
...
```java
client.order.getReasonCodes( category,  pageSize,  pageNo) {
  //use response
}
```
...
```java
client.order.getShipmentById( shipmentId,  channelOrderId,  channelShipmentId,  channelBagId,  channelId) {
  //use response
}
```
...
```java
client.order.getShipments( bagIds,  shipmentIds,  orderIds,  channelBagIds,  channelShipmentIds,  channelOrderIds,  channelId,  pageNo,  pageSize) {
  //use response
}
```
...
```java
client.order.getOrderById( fyndOrderId,  channelOrderId,  channelShipmentId,  channelBagId,  channelId,  pageNo,  pageSize) {
  //use response
}
```
...
```java
client.order.getOrders( bagIds,  shipmentIds,  orderIds,  channelBagIds,  channelShipmentIds,  channelOrderIds,  channelId,  pageNo,  pageSize) {
  //use response
}
```
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | entityId | HashMap<String,Object>? |  yes  |  |
...
---
 ...
 | bId | Integer |  no  |  |
 | bType | String? |  yes  |  |
 | dates | HashMap<String,Object>? |  yes  |  |
 | item | [Item](#Item) |  no  |  |
 ...
 | paymentMethods | HashMap<String,Object> |  no  |  |
 | bagId | Integer |  no  |  |
...
---
 ...
 | ewbn | Object? |  yes  |  |
 | awbType | String |  no  |  |
 | excludeDps | ArrayList<Integer>? |  yes  |  |
 | rdpcId | Integer |  no  |  |
...
---
 ...
 | dueDate | String? |  yes  |  |
 | timestamp | HashMap<String,Object>? |  yes  |  |
 | forwardAffiliateOrderId | String? |  yes  |  |
 | formatted | HashMap<String,Object>? |  yes  |  |
...
---
 ...
 | headers | HashMap<String,Object> |  no  |  |
 | paymentMethods | HashMap<String,Object> |  no  |  |
 | couponValue | Double |  no  |  |
 | createdTime | Integer |  no  |  |
 | userId | Integer |  no  |  |
 | cashbackApplied | Double |  no  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | businessDetails | HashMap<String,Object>? |  yes  |  |
 | notificationEmails | ArrayList<String> |  no  |  |
 | documents | [Documents1](#Documents1) |  no  |  |
 | contactDetails | HashMap<String,Object> |  no  |  |
...
---
 ...
 | agreementStartDate | Integer? |  yes  |  |
...
---
 ...
 | searchKey | HashMap<String,Object> |  no  |  |
 ...
 | articleDetails | HashMap<String,Object> |  no  |  |
 ...
 | originalBagList | ArrayList<Integer> |  no  |  |
