...
```java
platformClient.order.getStateTransitionFlags( pageNo,  pageSize) {
  //use response
}
```
...
| --------- | -----  | -------- | ----------- | 
| companyId | Integer | yes |  |   
| pageNo | Integer? | no | The page number for pagination. |   
| pageSize | Integer? | no | The number of items to be returned per page for pagination. |  
...
```java
platformClient.order.getStateTransitionFlagsById( flagId) {
  //use response
}
```
...
```java
platformClient.order.getStateTransitionFilters( pageNo,  pageSize) {
  //use response
}
```
...
```java
platformClient.order.getStateTransitionFiltersById( filterId) {
  //use response
}
```
...
```java
platformClient.order.getStateManagerTasks( pageNo,  pageSize) {
  //use response
}
```
...
```java
platformClient.order.getStateManagerTaskById( taskId) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").order.getStateManagerStates( pageNo,  pageSize) {
  //use response
}
```
