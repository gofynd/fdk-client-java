...
```java
platformClient.application("<APPLICATION_ID>").payment.getPaymentModeRoutes( refresh,  requestType,  orderId,  shipmentId) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.getPosPaymentModeRoutes( amount,  cartId,  pincode,  checkoutMode,  refresh,  orderId,  cardReference,  orderType,  userDetails,  displaySplit,  advancePayment,  shipmentId) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.initialisePayment(body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.checkAndUpdatePaymentStatus(body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.resendOrCancelPayment(body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.repaymentDetails(body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.merchantOnBoarding(body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.verifyCustomerForPayment(body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.getPaymentLink( paymentLinkId) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.createPaymentLink(body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.pollingPaymentLink( paymentLinkId) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.resendPaymentLink(body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.cancelPaymentLink(body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.getPaymentModeControlRoutes( mode) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.setMerchantModeControlRoutes( mode, body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.getPaymentModeCustomConfig( mode) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.setPaymentModeCustomConfig( mode, body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.getPaymentCodeOption() {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.getPaymentSession( gid,  lineItem) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.updatePaymentSession( gid, body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.updateRefundSession( gid,  requestId, body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.getMerchantPaymentOption( paymentOptionType) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.patchMerchantPaymentOption(body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.getMerchantAggregatorPaymentModeDetails( aggregatorId,  businessUnit,  device) {
  //use response
}
```
...
| companyId | Integer | yes | Company Id |   
| applicationId | String | yes | Application id |   
| aggregatorId | Integer | yes | Aggregators Id |   
...
```java
platformClient.application("<APPLICATION_ID>").payment.patchMerchantAggregatorPaymentModeDetails( aggregatorId, body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.getPGConfigAggregators() {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.getMerchantRefundPriority( configType) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.createMerchantRefundPriority( configType, body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.updateMerchantRefundPriority( configType, body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.createPaymentOrder(body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.getMerchantAggregatorAppVersion( aggregatorId,  businessUnit,  device,  paymentModeId,  subPaymentMode) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.patchMerchantPaymentOptionVersion( aggregatorId, body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.deleteBeneficiaryDetails( beneficiaryId) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.getRefundOptions( configuration,  productType,  amount) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.setRefundOptionforShipment(body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.getSelectedRefundOption( shipmentId,  orderId) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.getUserBeneficiariesDetailV2( orderId,  shipmentId,  mop) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.validateBeneficiaryAddress(body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.updateDefaultBeneficiary(body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.getPennyDropValidation() {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").payment.updatePennyDropValidation(body body) {
  //use response
}
```
...
---
 ...
 | success | Boolean |  no  | Response is successful or not |
 | paymentBreakup | HashMap<String,Object>? |  yes  | Payment Breakup for advance payment |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | aggregatorId | Integer? |  yes  | aggregator_id |
 | aggregatorFundId | Integer? |  yes  | aggregator_fund_id |
 | payoutDetailsId | Integer? |  yes  | payout_details_id |
...
---
 ...
 | aggregatorId | Integer |  no  | ID of aggregator |
...
---
 ...
 | ---------- | ---- | -------- | ----------- |
 | message | String? |  yes  | Message |
 | items | HashMap<String,Object>? |  yes  | List of all aggregator and payment mode details. |
 | success | Boolean |  no  | Response is successful or not. |
...
---
 ...
 | ---------- | ---- | -------- | ----------- |
 | message | String? |  yes  | Message |
 | items | ArrayList<HashMap<String,Object>>? |  yes  | List of all aggregator and payment mode details. |
 | success | Boolean |  no  | Response is successful or not. |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | offline | HashMap<String,Object>? |  yes  | Details to be updated for online payment configuration. |
 | online | HashMap<String,Object>? |  yes  | Details to be updated for offline payment configuration. |
...
---
 ...
 | amount | Integer |  no  | amount paid. |
 | status | String |  no  | order status created by payment gateway aggregator. |
 | currency | String |  no  | currency of the payment. |
 | aggregatorOrderDetails | HashMap<String,Object> |  no  | aggregator order details generated by the payment gateway. |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | googleMapPoint | HashMap<String,Object>? |  yes  | google map point of location |
 ...
 | geoLocation | HashMap<String,Object>? |  yes  | location latitude and logitude |
 ...
 | tags | ArrayList<HashMap<String,Object>>? |  yes  | optional address tag |
...
---
 ...
 | amountCaptured | Integer |  no  | amount which is captured or credited to merchant account |
 | amountRefunded | Integer? |  yes  |  |
 ...
 | paymentMethods | ArrayList<HashMap<String,Object>> |  no  | method of payment |
 ...
 | meta | HashMap<String,Object>? |  yes  | Metadata |
...
---
 ...
 | totalAmount | Integer |  no  | amount paid. |
...
---
 ...
 | ---------- | ---- | -------- | ----------- |
 | gid | String |  no  | Global identifier of the entity (e.g. order, cart etc.) against which payment_session was initiated. This is generated by Fynd payments platform and is unique. |
 | platformTransactionDetails | ArrayList<HashMap<String,Object>> |  no  | platform transaction details. |
 | status | String |  no  | status of the payment. |
 | currency | String |  no  | currency of the payment. |
 | totalAmount | Integer |  no  | amount paid. |
...
---
 ...
 | amount | Integer |  no  | amount refunded. |
...
---
 ...
 | totalAmount | Integer |  no  | The total amount refunded. |
...
---
 ...
 | status | String |  no  | The status of the refund. |
 | currency | String |  no  | The currency of the payment. |
 | platformRefundDetails | ArrayList<HashMap<String,Object>> |  no  | details of the refund |
 | totalRefundAmount | Integer |  no  | The total amount refunded. |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | items | HashMap<String,Object> |  no  | Items that are added in cart |
 | articles | ArrayList<HashMap<String,Object>> |  no  | list of articles that are added in cart |
 | cartValue | Double |  no  | total cart value i.e. amount to be paid |
 | totalQuantity | Integer? |  yes  | total number of items in cart |
 | sellerCompanyId | Integer? |  yes  | seller company id |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | amount | Integer |  no  | refunded amount |
 | currency | String |  no  | The currency of the payment. |
 | requestId | String |  no  | refund request id, unique id generated by Fynd platform |
 | status | String |  no  | The status of the refund. |
 | created | String |  no  | timestamp in epoch. |
...
---
 ...
 | priority | Integer |  no  | priority of refund source, 0 being highest |
...
---
 ...
 | items | ArrayList<HashMap<String,Object>> |  no  | List of item details with respect to payment_mode |
 | device | HashMap<String,Object> |  no  | List of devices and its activation status |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | device | ArrayList<HashMap<String,Object>> |  no  | Device name to copy the config to |
 | businessUnit | String |  no  | Business unit name |
...
---
 ...
 | items | ArrayList<HashMap<String,Object>>? |  yes  | List of item details with respect to payment_mode |
...
---
 ...
 | groups | ArrayList<Integer>? |  yes  | Customer groups. |
...
---
 ...
 | id | Integer |  no  | Refund ID. It will be unique identifier |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | transferMode | HashMap<String,Object> |  no  | selected transfer mode for given shipment |
...
---
 ...
 | limit | HashMap<String,Object> |  no  | Max Limit for adding bank account, UPI and wallet |
...
---
 ...
 | success | Boolean |  no  | Successful or not. |
 | ifsc | HashMap<String,Object>? |  yes  | IFSC details response data |
