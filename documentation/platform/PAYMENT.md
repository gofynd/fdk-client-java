...
```java
client.application("<APPLICATION_ID>").payment.repaymentDetails(body body) {
  //use response
}
```
...
```java
client.application("<APPLICATION_ID>").payment.merchantOnBoarding(body body) {
  //use response
}
```
...
---
 ...
 | amount | Integer |  no  | Amount to paid back |
