...
```java
client.application("<APPLICATION_ID>").payment.edcDevice( terminalUniqueIdentifier, body body) {
  //use response
}
```
...
```java
client.application("<APPLICATION_ID>").payment.edcDevice( terminalUniqueIdentifier) {
  //use response
}
```
