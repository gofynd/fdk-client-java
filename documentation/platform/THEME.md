...
```java
platformClient.theme.getCompanyLevelThemes() {
  //use response
}
```
...
| Argument  |  Type  | Required | Description |
| --------- | -----  | -------- | ----------- | 
| companyId | Integer | yes | The ID of the company to retrieve the themes associated with it. |  
...
[List<ThemeSchema>](#List<ThemeSchema>)
...
```java
platformClient.theme.addMarketplaceThemeToCompany(body body) {
  //use response
}
```
...
| Argument  |  Type  | Required | Description |
| --------- | -----  | -------- | ----------- | 
| companyId | Integer | yes | The ID of the company to apply the theme to. |  
...
```java
platformClient.theme.deleteCompanyTheme( themeId) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").theme.getApplicationThemesV2() {
  //use response
}
```
...
[List<AllThemesApplicationResponseV2>](#List<AllThemesApplicationResponseV2>)
...
```java
platformClient.application("<APPLICATION_ID>").theme.getApplicationThemesCountV2() {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").theme.getApplicationThemeByIdV2( themeId) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").theme.updateThemeV2( themeId, body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").theme.applyThemeV2(body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").theme.updateThemeNameV2( themeId, body body) {
  //use response
}
```
