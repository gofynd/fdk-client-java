...
```java
client.application("<APPLICATION_ID>").cart.getCartList() {
  //use response
}
```
...
```java
client.application("<APPLICATION_ID>").cart.updateCartUser( id) {
  //use response
}
```
...
```java
client.application("<APPLICATION_ID>").cart.getCartLastModified( id) {
  //use response
}
```
...
```java
client.application("<APPLICATION_ID>").cart.addItems( i,  b,  areaCode,  buyNow, body body) {
  //use response
}
```
...
```java
client.application("<APPLICATION_ID>").cart.updateCart( id,  i,  b,  areaCode,  buyNow, body body) {
  //use response
}
```
...
```java
client.application("<APPLICATION_ID>").cart.getAddressById( id,  cartId,  buyNow,  mobileNo,  checkoutMode,  tags,  isDefault) {
  //use response
}
```
...
```java
client.application("<APPLICATION_ID>").cart.selectAddress( cartId,  buyNow,  i,  b,  userId, body body) {
  //use response
}
```
...
```java
client.application("<APPLICATION_ID>").cart.getShipments( pickAtStoreUid,  orderingStoreId,  p,  id,  addressId,  areaCode,  orderType) {
  //use response
}
```
...
```java
client.application("<APPLICATION_ID>").cart.updateShipments( i,  p,  id,  addressId,  orderType, body body) {
  //use response
}
```
...
```java
client.application("<APPLICATION_ID>").cart.checkoutCart( id, body body) {
  //use response
}
```
