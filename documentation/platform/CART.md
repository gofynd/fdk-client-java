...
```java
platformClient.application("<APPLICATION_ID>").cart.updateCartDynamicInjection( id, body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").cart.removeCartMetaConfig( id) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").cart.createCartDynamicInjection(body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").cart.getAbandonedCart( userId,  pageNo,  pageSize,  fromDate,  toDate,  anonymousCart,  lastId,  sortOn) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").cart.getAbandonedCartDetails( userId,  id,  i,  b) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").cart.addItems( cartId,  b,  userId, body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").cart.updateCart( cartId,  b,  userId, body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").cart.selectPaymentModeV2( id,  buyNow, body body) {
  //use response
}
```
...
---
 ...
 | type | String? |  yes  |  |
 | collection | HashMap<String,Object>? |  yes  |  |
