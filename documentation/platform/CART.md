...
```java
client.application("<APPLICATION_ID>").cart.updateCartWithSharedItems( token,  action) {
  //use response
}
```
...
```java
client.application("<APPLICATION_ID>").cart.addItems( i,  b,  buyNow, body body) {
  //use response
}
```
...
```java
client.application("<APPLICATION_ID>").cart.updateCart( id,  i,  b,  buyNow, body body) {
  //use response
}
```
...
```java
client.application("<APPLICATION_ID>").cart.getCoupons( id,  buyNow) {
  //use response
}
```
...
```java
client.application("<APPLICATION_ID>").cart.getShipments( p,  id,  buyNow,  addressId,  areaCode,  orderingStoreId,  orderType) {
  //use response
}
```
...
```java
client.application("<APPLICATION_ID>").cart.getShipmentDelivery( i,  p,  id,  addressId,  orderType) {
  //use response
}
```
...
```java
client.application("<APPLICATION_ID>").cart.checkoutCart( buyNow, body body) {
  //use response
}
```
