...
```java
platformClient.application("<APPLICATION_ID>").communication.getVoiceProviders( pageNo,  pageSize,  sort) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").communication.createVoiceProvider(body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").communication.getVoiceProviderById( id) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").communication.getVoiceTemplates( pageNo,  pageSize,  sort) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").communication.createVoiceTemplate(body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").communication.getVoiceTemplateById( id) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").communication.updateVoiceTemplateById( id, body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").communication.deleteVoiceTemplateById( id) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").communication.getSystemVoiceTemplates( pageNo,  pageSize,  sort) {
  //use response
}
```
