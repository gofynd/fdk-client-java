...
```java
platformClient.application("<APPLICATION_ID>").filestorage.getPdfTypes( countryCode,  storeOs) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").filestorage.deletePdfType( id) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").filestorage.updateHtmlTemplate( id, body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").filestorage.deletePdfConfigTemplate( id) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").filestorage.saveHtmlTemplate(body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").filestorage.generatePaymentReceipt(body body) {
  //use response
}
```
...
---
 ...
 | support | HashMap<String,Object>? |  yes  |  |
...
---
 ...
 | businessCountryCurrency | HashMap<String,Object>? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | value | ArrayList<HashMap<String,Object>>? |  yes  |  |
...
---
 ...
 | totalValueOfGoods | Double? |  yes  |  |
 | b2BBuyerDetails | HashMap<String,Object>? |  yes  |  |
 | isQwik | HashMap<String,Object>? |  yes  |  |
 ...
 | waybills | ArrayList<HashMap<String,Object>>? |  yes  |  |
 | totalItems | Double? |  yes  |  |
...
---
 ...
 | jobType | String? |  yes  |  |
 | action | String? |  yes  |  |
 | event | HashMap<String,Object>? |  yes  |  |
