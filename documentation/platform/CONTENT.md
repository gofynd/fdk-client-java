...
```java
platformClient.application("<APPLICATION_ID>").content.getDefaultSEOMarkupSchema( pageType) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").content.getSEOMarkupSchemas( title,  active,  pageNo,  pageSize) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").content.createSEOMarkupSchema(body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").content.getSEOMarkupSchema( id) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").content.editSEOMarkupSchema( id, body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").content.deleteSEOMarkupSchema( id) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").content.getBlogBySlug( slug) {
  //use response
}
```
...
```java
platformClient.content.getCustomFieldTypes() {
  //use response
}
```
...
```java
platformClient.content.getResources() {
  //use response
}
```
...
```java
platformClient.content.createCustomFieldDefinition(body body) {
  //use response
}
```
...
```java
platformClient.content.getCustomFieldDefinition( definitionId) {
  //use response
}
```
...
```java
platformClient.content.updateCustomFieldDefinition( definitionId, body body) {
  //use response
}
```
...
```java
platformClient.content.deleteCustomFieldDefinition( definitionId) {
  //use response
}
```
...
```java
platformClient.content.getCustomFields( resource) {
  //use response
}
```
...
```java
platformClient.content.getCustomFieldsByResourceId( resource,  resourceId) {
  //use response
}
```
...
```java
platformClient.content.createCustomFieldByResourceId( resource,  resourceId, body body) {
  //use response
}
```
...
```java
platformClient.content.createCustomObjectDefinition(body body) {
  //use response
}
```
...
```java
platformClient.content.getCustomObjectDefinitions( pageNo,  pageSize,  search) {
  //use response
}
```
...
```java
platformClient.content.getCustomObjectDefinition( definitionId) {
  //use response
}
```
...
```java
platformClient.content.updateCustomObjectDefinition( definitionId, body body) {
  //use response
}
```
...
```java
platformClient.content.deleteCustomObjectDefinition( definitionId) {
  //use response
}
```
...
```java
platformClient.content.createCustomObject(body body) {
  //use response
}
```
...
```java
platformClient.content.getCustomObject( metaobjectId) {
  //use response
}
```
...
```java
platformClient.content.deleteCustomObject( metaobjectId) {
  //use response
}
```
...
```java
platformClient.content.updateCustomObject( metaobjectId, body body) {
  //use response
}
```
...
```java
platformClient.content.getJobs( page,  pageSize,  actionType) {
  //use response
}
```
...
```java
platformClient.content.importCustomObjectEntries( definitionId, body body) {
  //use response
}
```
...
```java
platformClient.content.exportCustomObjectEntries( definitionId) {
  //use response
}
```
...
```java
platformClient.content.sampleCustomObjectBulkEntry( definitionId) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").content.getAppCustomFieldTypes() {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").content.getAppResources() {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").content.createAppCustomFieldDefinition(body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").content.getAppCustomFieldDefinition( definitionId) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").content.updateAppCustomFieldDefinition( definitionId, body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").content.deleteAppCustomFieldDefinition( definitionId) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").content.getAppCustomFields( resource) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").content.getAppCustomFieldsByResourceId( resource,  resourceId) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").content.createAppCustomFieldByResourceId( resource,  resourceId, body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").content.createAppCustomObjectDefinition(body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").content.getAppCustomObjectDefinitions( pageNo,  pageSize,  search) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").content.getAppCustomObjectDefinition( definitionId) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").content.updateAppCustomObjectDefinition( definitionId, body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").content.deleteAppCustomObjectDefinition( definitionId) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").content.createAppCustomObject(body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").content.getAppCustomObject( metaobjectId) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").content.deleteAppCustomObject( metaobjectId) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").content.updateAppCustomObject( metaobjectId, body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").content.getAppJobs( page,  pageSize,  actionType) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").content.importAppCustomObjectEntries( definitionId, body body) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").content.exportAppCustomObjectEntries( definitionId) {
  //use response
}
```
...
```java
platformClient.application("<APPLICATION_ID>").content.sampleAppCustomObjectBulkEntry( definitionId) {
  //use response
}
```
...
---
 ...
 | updatedAt | String? |  yes  |  |
 | typeName | String? |  yes  |  |
 | invalidFieldsCount | Integer? |  yes  |  |
...
---
 ...
 | isDeleted | Boolean? |  yes  |  |
 | id | String? |  yes  |  |
 | validations | ArrayList<Object>? |  yes  |  |
 | createdAt | String? |  yes  |  |
 | updatedAt | String? |  yes  |  |
...
---
 ...
 | Properties | Type | Nullable | Description |
 | ---------- | ---- | -------- | ----------- |
 | moTotalCount | Integer? |  yes  |  |
 | moSuccessCount | Integer? |  yes  |  |
 | moErrorCount | Integer? |  yes  |  |
...
---
 ...
 | entity | String? |  yes  |  |
 | errorUrl | String? |  yes  |  |
 | finishedCount | Integer? |  yes  |  |
 | errorCount | Integer? |  yes  |  |
 | successCount | Integer? |  yes  |  |
 | totalJobs | Integer? |  yes  |  |
...
---
 ...
 | type | String? |  yes  |  |
 | updatedAt | String? |  yes  |  |
 | entriesCount | Integer? |  yes  |  |
 | fieldsCount | Integer? |  yes  |  |
